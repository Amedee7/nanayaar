                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <h2 class="mb-1">Gestion d'un client</h2>
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bolder my-1 mr-5">
                            <span class="far fa-user primary-color icon-lg"></span>
                            Etat d'un client
                        </h5>
                    </div>
                                    ...
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="pt-8 pb-6">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                ...
                                                <span
                                                    class="text-muted">{{ date_format(new \DateTime($client->date_naiss), 'd-m-Y') }}</span>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                ...
                                                <span
                                                    class="text-muted">{{ date_format(new \DateTime($client->date_delivered), 'd-m-Y') }}</span>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <span class="font-weight-bold mr-2">Date d'expiration:</span>
                                                <span
                                                    class="text-muted">{{ date_format(new \DateTime($client->date_expired), 'd-m-Y') }}</span>
                                            </div>
                                        </div>
                                        <!--end::Contact-->
                                        ...
                                        <div>
                                            ...
                                            <div class="font-weight-bold mr-2">Adresse du client</div>
                                            <!--begin::Description-->
                                            <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5">
                                                {{ $client->adresse }}.
                                            </div>
                                            ...
                                            @if ($client->status_updated_or_not == 0)
                                                <div class="btn-group mt-5" role="group">
                                                    <button id="btnGroupDrop1" type="button"
                                                        class="btn-sm btn btn-dark font-weight-bold dropdown-toggle"
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        @if ($client->status == 'Rejeté')
                                                            <a class="dropdown-item btn"
                                                                ...
                                                                title="Accepté"><span class="flaticon2-accept mr-2"></span>
                                                                Accepté</a>
                                                        @endif
                                                        ...
                                                        @if ($client->status == 'Accepté')
                                                            <a class="dropdown-item btn"
                                                                ...
                                                                title="Rejeté"><span class="flaticon2-delete mr-2"></span>
                                                                Rejeté</a>
                                                        @endif
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card pt-6 mb-3 mb-xl-9">
                                            <h3 class="ml-10">Etat du versement en cours</h3>
                                                            ...
                                                            <div class=" text-center">
                                                                ...
                                                                <div class="text-center">
                                                                    <span
                                                                        ...
                                                                        <em class="font-size-h6 opacity-50">Fcfa</em>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card card-custom gutter-b">
                                    ...
                                    <div class="card-header border-0 py-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label font-weight-bolder text-dark">Historique des versements 
                                                effectués par le client</span>
                                        </h3>
