...
class ClientController extends Controller
{
    ...
    {
        $user = User::all()->pluck('id', 'firstname', 'lastname')->toArray();
        return view('clients.create', ['lastClient' => NumbService::generateNumb(), 'users']);
    }
    ...
    public function store(Request $request)
    {
        ...
        $client = new Client();
        $client->numb_cli       = NumbService::generateNumb();
