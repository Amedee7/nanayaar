        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        var statuss = {
							'Attente': {'name': 'Non engagé', 'class': ' label-light-primary'},
							Accepté: {'name': 'Engagé', 'class': ' label-light-success'},
						};
						return '<span class="label label-lg font-weight-bold ' + statuss[full.status].class + ' label-inline">' + statuss[full.status].name + '</span>';
                    }
                },
                {
                    data: 'status_updated_or_not',
                    name: 'status_updated_or_not',
                    render: function render(data, type, full, meta) {
                        var status = {
							0: {'name': 'Non engagé', 'class': ' label-light-primary'},
							1: {'name': 'Engagé', 'class': ' label-light-success'},
						};
						return '<span class="label label-lg font-weight-bold ' + status[full.status_updated_or_not].class + ' label-inline">' + status[full.status_updated_or_not].name + '</span>';
                    }
                },
                {
                    data: 'action',
