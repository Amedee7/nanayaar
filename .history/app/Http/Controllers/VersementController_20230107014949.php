...
class VersementController extends Controller
{
    public function datatables()
    {
        ...
        ->addColumn('penalite', function($verse) {
            if (Carbon::parse($verse->date1) > Carbon::parse($verse->date2)) {
                $penalite = calculPenalite($result->montant, Carbon::parse($verse->date1)->diffInDays(Carbon::parse($verse->date2)));
                return $penalite;
            } else {
                return 0;
            }
