...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::post('/clients/montant/update', [ClientController::class, 'myMontantStore'])->name('clients.montant.update');
        ...
        Route::get('/clients/{id}/rejete', [ClientController::class, 'statusAccepte'])->name('clients.rejete');
        Route::get('/clients/{id}/attete', [ClientController::class, 'statusAccepte'])->name('clients.attete');
