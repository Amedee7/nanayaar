            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        output = '<div class="d-flex align-items-center">' +
                            ...
                            '<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 fs-6">' + data +
                            '</a>' +
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        status = status + ' ' + '<span class="label fs-7 ' + label + ' ">' + value +
                            '</span>' +
                            '<span class="text-muted font-weight-bolder text-muted d-block fs-9">Date: ' + full
                            .created_at + '</span>';
...

                {
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class=" badge badge-light-success font-weight-bolder fs-6">' + data
...

                {
                    ...
                    name: 'somme_verse',
                    render: function render(data, type, full, meta) {
                        return '<span class=" badge badge-light-warning font-weight-bolder fs-6">' + data
                            .toLocaleString('fr') + '</span>'
                    }
                },

                {
                    ...
                    name: 'reste_apaye',
                    render: function render(data, type, full, meta) {
                        return '<span class=" badge badge-light-danger font-weight-bolder fs-6">' + data
                            .toLocaleString('fr') + '</span>'
                    }
                },
