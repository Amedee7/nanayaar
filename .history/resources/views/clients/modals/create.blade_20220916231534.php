        ...
        <div class="modal-content border-0 shadow radius-1">
                            ...
                            <div class="card card-custom" style="border: solid; border-color: black">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input name="numb_cli" type="text" class="form-control "
                                            id="id-form-field-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="first_phone" type="text" class="form-control "
                                            id="id-form-field-1">
                                        <span class="name_err error text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for=""><strong>TELEPHONE 2</strong></label>
                                        <input name="second_phone" type="text" class="form-control "
                                            id="id-form-field-1">
                                        <span class="name_err error text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="">DATE DE NAISSANCE</label>
                                        <input name="date_naiss" type="date" class="form-control "
                                            id="id-form-field-1">
                                        <span class="display_name_err error text-danger"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="">NUMERO CNIB</label>
                                        <input name="numb_cnib" type="text" class="form-control "
                                            id="id-form-field-1">
                                        <span class="display_name_err error text-danger"></span>
                                    </div>
            ...
            <div class="modal-footer bgc-default-l5">
                <button type="button" id="sender" class="btn btn-primary" onclick="storeRecord();">
                    <span id="btn-load" class="spinner-border d-none spinner-border-sm" client="status"
