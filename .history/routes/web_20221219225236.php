...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/rule', [VersementController::class, 'versementAmountRule'])->middleware('permission:versement-r')->middleware('permission:versement-modifier')->name('versements.rule');
