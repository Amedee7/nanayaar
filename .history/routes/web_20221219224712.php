...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier/ajouter', [VersementController::class, 'modifyVersementModifierMontant'])->middleware('permission:versement-supprimer')->name('versements.modify.add');
