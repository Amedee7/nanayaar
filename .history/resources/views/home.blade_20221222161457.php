...
<div class="row">
    ...
    <div class="col-lg-6 col-xxl-4">
        ...
        <div class=" col-xl-4">
            <div class="card ">
                <div class="card-body d-flex flex-column m">
                    <div class="d-flex align-items-center flex-wrap ">
                        <span class="svg-icon svg-icon-primary svg-icon-3x ms-n1 me-2">
                        ...
                        <a class="fs-4 fw-bold text-hover-primary text-gray-600">CONSIGNATIONS</a>
                    </div>
                    <div class="fs-2tx fw-bolder ">{{$objects_trans}}</div>
                </div>
            </div>
        </div>
            ...
            <div class="card ">
                <div class="card-body d-flex flex-column m">
                    <div class="d-flex align-items-center flex-wrap ">
                        ...
                        <a class="fs-4 fw-bold text-hover-primary text-gray-600">CLIENTS</a>
                    </div>
                    <div class="fs-2tx fw-bolder ">{{$clientAttente}}</div>
                </div>
            </div>
        </div>
            ...
            <div class="card ">
                <div class="card-body d-flex flex-column m">
                    <div class="d-flex align-items-center flex-wrap ">
                        ...
                        <a class="fs-4 fw-bold text-hover-primary text-gray-600">PRODUITS</a>
                    </div>
                    <div class="fs-2tx fw-bolder ">{{$clientAccepté}}</div>
                </div>
            </div>
        </div>
