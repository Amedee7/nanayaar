                        ...
                        <div class="card card-custom bg-white gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <span
                                    class="svg-icon svg-icon-3x svg-menu"><!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group.svg--><svg
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom bg-white gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                <!--begin::Stats-->
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <span class="svg-icon svg-icon-infos svg-icon-3x">
                ...
                <div class="card card-custom bg-white gutter-b" style="height: 130px">
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            ...
                            <div class="text-inverse-white font-weight-bold">Montant octrayé</div>
                            <div class="text-inverse-white font-weight-bolder font-size-h3">
