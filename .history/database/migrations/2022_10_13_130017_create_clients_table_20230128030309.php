...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('clients', function (Blueprint $table) {
            ...
            $table->foreign('created_by')->references('id')->on('users')->on('cascade');
            $table->foreign('updated_by')->references('id')->on('users')->on('cascade');
            $table->foreign('deleted_by')->references('id')->on('users')->on('cascade');
