                ...
                success: function(data) {
                    ...
                    $('#records').DataTable({
                        ...
                        "footerCallback": function(row, data, start, end, display) {
                            ...
                            var pageTotalDb = api.column(columnMr, {
                                page: 'current'
                            }).data().reduce(function(a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);
