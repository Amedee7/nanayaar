...
class VersementController extends Controller
{
    ...
    public function modifyVersementModifierMontantStore(Request $request, $id){
        $versement = Versement::where('client_id', $request->montant_demande)->first();
        $validator = Validator::make($request->all(), [
        ...
        $montant_aoctroye = new Client();
        $montant_aoctroye->montant_aoctroye = $request->montant_demande;
        $montant_aoctroye->save();
