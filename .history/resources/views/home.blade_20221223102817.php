                        ...
                        <div class="card card-custom bg-white gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <span
                                    class="svg-icon svg-icon-success svg-icon-3x"><!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group.svg--><svg
                                    ...
                                    <a class="font-size-h3 font-weight-bold">CLIENTS
                                    </a>
                        ...
                        <div class="card card-custom bg-white gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    ...
                                    <a class="font-size-h3 font-weight-bold">COMMISSIONS RECU</a>
                                    <div class="text-inverse-white font-weight-bolder font-size-h2">
                                        {{ number_format($totalCommissions, 0, '.', ' ') }} Fcfa</div>
                                </div>
                                <!--end::Stats-->
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-white gutter-b" style="height: 130px">
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        <!--begin::Stats-->
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <span class="svg-icon svg-icon-primary svg-icon-3x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Money.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <div class="text-inverse-white font-weight-bolder font-size-h3">
                                {{ number_format($totalMontantOctroyé, 0, '.', ' ') }} Fcfa </div>
                        </div>
                        <!--end::Stats-->
