...
class VersementController extends Controller
{
    public function datatables()
    {
        $versements = DB::table('versements')
            ...
            ->select(
                ...
                DB::raw("DATE_FORMAT(versements.limit, '%d/%m/%Y') as date_limite"),
    ...
    public function index(Request $request)
    {
        ...
        $differenceInDays = DB::table('versements')->select(db::raw('DATEDIFF(DATE_FORMAT(debut),DATE_FORMAT(limit)) as dggggggg'))->get();
        dd($differenceInDays);
