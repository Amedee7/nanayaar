            ...
            columns: [{
                ...
                },
                {
					...
					template: function(row) {
						var status = {
							'Attente': {'title': 'Attente', 'class': ' label-light-primary'},
							'Rejeté': {'title': 'Rejeté', 'class': ' label-light-danger'},
							'Accepté': {'title': 'Accepté', 'class': ' label-light-success'},
						};
						return '<span class="label label-lg font-weight-bold ' + status[row.status].class + ' label-inline">' + status[row.status].status + '</span>';
					},
				}
