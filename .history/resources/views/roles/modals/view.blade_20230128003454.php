                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            ...
                                            <td>
                                                @if (array_key_exists($module.'-s',$permissions))
                                                    <div class="checkbox-inline">
                                                        <label class="checkbox checkbox-lg">
                                                            <input name="permissions[]" disabled type="checkbox" {{ ($role->hasPermission($module.'-s') ? 'checked' : '') }} name="permissions[]" value="{{ $module.'-s' }}">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                @endif
