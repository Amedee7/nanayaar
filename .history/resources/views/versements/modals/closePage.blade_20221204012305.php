            ...
            <div class="modal-body">
                    ...
                    <div class="card-body p-0">
                        <div class="px-9 pt-6 card-rounded h-225px w-100 bg-success">
                            <div class="d-flex text-center flex-column text-white pt-5">
                                ...
                                <span class="fw-bolder fs-2x pt-1">{{number_format($outStock->montant_octroye,0, '.',' ')}} Fcfa</span>
                            </div>
                        </div>
                        <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -100px">
                            <div class="d-flex align-items-center mb-1">
                                <div class="d-flex align-items-center flex-wrap w-120">
                                    <div class="mb-1 pe-3 flex-grow-1">
                                        <a class="fs-5 text-gray-800 text-hover-primary fw-bolder">Produits de la commande ({{$productsCount}})</a>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li data-jstree='{ "opened" : false }'>
                                                            {{$item->name}} - VL: {{$item->volume}} - TYPE: {{$item->bottles}} - P.U: {{$item->price}}
                                                            <ul>
                                                                <li data-jstree='{ "type" : "file" }'>
                                                                    P.U: {{$item->price}} - QTE: {{$item->objects}} - P.T: {{number_format($item->amount_total_product,0, '.',' ')}}
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        @endforeach
                ...
                <div class="d-flex align-items-center bg-light-info rounded p-5">
                    ...
                    <div class="flex-grow-1 me-2">
                        ...
                        <span class="text-muted fw-bold d-block">{{$customer->name}}</span>
                    </div>
                    <span class="fw-bolder text-info py-1">Téléphone: {{$customer->telephone}}</span>
                </div>
                <br>
