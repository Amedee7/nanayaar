                                        ...
                                        <div class="row">
                                            <div class="box-body col-md-8">
                                                ...
                                                <select class="form-control" name="numero_client" id="mySelect2">
                                                    @foreach ($clients as $client => $status = 'Accepter')
                                                        <option value="{{ $client->id }}"
                                                            @if ($loop->first) selected @endif>
                                                           No Client: {{ $client->numb_cli }} {{ '--- Commission: '.$client->montant_demande * 14 /100 .' FCFA'}} {{' sur => '. $client->montant_demande .' FCFA'}}</option>
                                                    @endforeach
                                                </select>
