<table
    class="table table-clients font-weight-bolder table-bordered table-head-custom table-head-bg table-vertical-center" dataTable no-footer" id="o2d-datatable">
    <thead>
        <tr>
            <th>Record ID</th>
            <th>Nom & Prenom</th>
