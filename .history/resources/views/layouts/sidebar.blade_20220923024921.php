        ...
        <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1"
            ...
            <ul class="menu-nav" style="padding: 0px !important;">
                    ...
                    <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="d-flex flex-column font-weight-bold">
                            <span
                                ...
                                <span
                                    class="label label-lg font-size-lg label-light-primary label-inline">{{ Auth::user()->roles[0]['display_name'] == 'Personnel' ? 'Employé' : Auth::user()->roles[0]['display_name'] }}</span>
                            </span>
                        </div>
                    </div>
                </li>
                ...
                <li class="menu-item  menu-item-submenu
                        ...
                        {{ Request::routeIs('clients/versements.versement') ? ' menu-item-open' : '' }}
                        {{ Request::routeIs('clients.index') ? ' menu-item-open' : '' }}
                        {{ Request::routeIs('clients.index') ? ' menu-item-open' : '' }}
                    ...
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text font-weight-bolder   ">Clients</span>
                    ...
                    <div class="menu-submenu ">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::routeIs('clients.versements.versement') ? ' menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{ route('clients.versements.versement') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text font-weight-bolder">Versements</span>
                                </a>
                            </li>
                            <li class="menu-item {{ Request::routeIs('config.index') ? ' menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{ route('home') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
