        ...
        <a href="#"
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-danger font-weight-bolder font-size-h5 mb-2 mt-5">
                    <span class="card-label fw-bolder fs-3 mb-1">Clients <span class="badge badge-success fw-bolder my-2">Acceptés</span> </span></div>
                    <div class="font-weight-bold text-inverse-danger font-size-sm">
                        <div class="symbol symbol-circle me-5">
                            <div class="symbol-label bg-transparent border border-secondary border-dashed">
                                <span class="font-weight-bold text-inverse-danger font-size-h2">{{$clientAccepté}}</span>
                                <span class="pulse-ring"></span>
                            </div>
                        </div>
                    </div>
