...
<div class="mb-3 container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    <div class="d-flex align-items-center">
        <div class="btn-group dropup">
            <div class="btn-group dropup">
                <a class="btn btn-primary" href="{{ route('clients.index') }}"><span
                        class="flaticon-up-arrow-1"></span> Retour à la liste des clients</a>
            </div>
        </div>
    </div>
</div>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true" style="">
                                            {{-- <form action="">
                                             ...
                                             <form action="{{ route('kamar_theresia.destroy', $tere->id) }}" method="POST">
                                                @csrf
                                                @method('delete')<div class="menu-item px-5">
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                <div class=" text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <input class="font-weight-boldest text-success form-control" value="{{$client->montant_demande}}" type="text" id="o-telephone" class="form-control" name="numero_1"
