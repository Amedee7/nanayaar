    ...
    <div class="mb-3 container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="card-toolbar">
                <h5 class="text-dark font-weight-bolder my-1 mr-5">
                    <a href="{{ route('clients.index') }}"><span class="flaticon-up-arrow-1"></span> Liste des clients</a>
                </h5>
            </div>
        </div>
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                                        <span class="font-weight-boldest text-success"><input readonly
                                                                type="text" class="form-control" name="numb_cli"
                                                                value="{{ $lastClient }}"></span>
                                                    </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="o-telephone" class="form-control"
                                                        name="numero_1" placeholder="Entrer le numero 1">
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="o-telephone2" class="form-control"
                                                        name="numero_2" placeholder="Entrer le numero 2">
