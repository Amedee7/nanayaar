                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            ...
                                            <td>
                                                @if (array_key_exists($module.'-status',$permissions))
                                                    <div class="checkbox-inline">
                                                        <label class="checkbox checkbox-lg">
                                                            <input name="permissions[]" disabled type="checkbox" {{ ($role->hasPermission($module.'-status') ? 'checked' : '') }} name="permissions[]" value="{{ $module.'-status' }}">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                @endif
