...
class HomeController extends Controller
{
    ...
    {
        $today = Carbon::today();
        $limit = DateLimitpaiement::generateLimitdate();
        ...
        $clientEnRetard = Versement::whereDate('limit', '=', $limit->diffInDays(2)->toDateTimeString())->count();
        $clientEnRetard = Subscription::where('payment_due_date', '=', DB::raw("DATE_ADD(payment_due_date, INTERVAL 2 DAY)"))
        ->get();
        dd($clientEnRetard);
