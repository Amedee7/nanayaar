...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    //USERS ROUTES
    Route::get('/users/datatable', [UserController::class, 'datatables'])->middleware('permission:utilisateur-creer')->name('users.datatables');
    Route::get('/users', [UserController::class, 'index'])->middleware('permission:utilisateur-creer')->name('users.index');
