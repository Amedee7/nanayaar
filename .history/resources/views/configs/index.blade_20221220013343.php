                    ...
                    <div class="card card-custom">
                        <div class="card-body pt-15">
                            <div class="text-center mb-3">
                                ...
                                <button onclick="showRecord('{{route('con.avatar')}}')" class="btn btn-sm btn-outline-primary pt-2 mt-4"><span class="flaticon2-image-file"></span> Modifier la photo</button>
