@extends('layouts.app')
@section('title', 'Administration - Liste des logs')
@section('content')
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <table id="o2d-datatable" class="table dt-responsive text-black table-bordered table-striped bgc-grey-l4 text-100 border-b-1" >
