        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        var status = {
							0: {'title': 'Non engagé', 'class': ' label-light-primary'},
							1: {'title': 'Engagé', 'class': ' label-light-success'},
						};
						return '<span class="label label-lg font-weight-bold ' + status[row.status_updated_or_not].class + ' label-inline">' + status[row.status_updated_or_not].title + '</span>';
