        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Détails du Versement
                    ...
                    Etat: <span class="label label-light-{{$versement->state=="En cours"?"warning":"success"}} label-inline">{{$versement->state}}</span>
                </h5>
            ...
            <div class="modal-body">
                <div class="mt-n1">
                    <div class="m-0">
                            ...
                            <div class="d-flex flex-wrap flex-center">
                                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                    <div class="fs-4 fw-bolder text-gray-700">
                                        <span class="w-75px text-success">{{number_format($versement->montant_octroye,0, '.',' ')}}</span> Fcfa
                        ...
                        <form action="{{route('versements.rule.store', $versement->id)}}" method="post" id="o2d-edit-record-form">
                            @csrf
                            @method('PATCH')
                            <div class="row g-5 mb-12">
            ...
            <div class="modal-footer bgc-default-l5">
                <button type="button" id="sender" class="btn btn-secondary" onclick="updateRecord();">
