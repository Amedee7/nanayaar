...
class ClientController extends Controller
{
    ...
    {
        $Encours = DB::table('clients')->where('state', 'En cours')->where('clients.deleted_at', null)->count();
        $Termine = DB::table('clients')->where('state', 'Terminé')->where('clients.deleted_at', null)->count();
        $Annule = DB::table('clients')->where('state', 'Annulé')->where('clients.deleted_at', null)->count();
