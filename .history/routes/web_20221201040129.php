...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/password', [App\Http\Controllers\UserController::class, 'myPassword'])->name('users.profile.password');
    Route::post('/clients/client/update', [ClientController::class, 'myPasswordStore'])->name('users.montant.update');
