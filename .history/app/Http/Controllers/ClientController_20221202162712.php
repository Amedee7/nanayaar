...
class ClientController extends Controller
{
    ...
    {
        $clientEncours = DB::table('clients')->where('status', 'En cours')->where('clients.deleted_at', null)->count();
        $clientTermine = DB::table('clients')->where('status', 'Terminé')->where('clients.deleted_at', null)->count();
        $clientAnnule = DB::table('clients')->where('status', 'Annulé')->where('clients.deleted_at', null)->count();
        return view('clients.index',[
            'clientEncours' =>$clientEncours,
            'clientTermine' =>$clientTermine,
            'clientAnnule' =>$clientAnnule
        ]);
