                ...
                <div class="row g-5 g-xl-8">
                        ...
                        <div class="card card-xl-stretch-90 mb-5 mb-xl-8">
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Clients <span class="badge badge-light-warning fw-bolder my-2">En attente</span> </span>
                                </h3>
                    ...
                    <div class="col-xl-4">
                        <div class="card card-xl-stretch-90 mb-5 mb-xl-8">
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Clients <span class="badge badge-light-success fw-bolder my-2">Terminées</span> </span>
                                </h3>
                                <div class="d-flex text-center flex-column pt-1" style="position: relative;">
                                    <div class="symbol symbol-circle me-5">
                    ...
                    <div class="col-xl-4">
                        <div class="card card-xl-stretch-90 mb-5 mb-xl-8">
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Clients <span class="badge badge-light-danger fw-bolder my-2">Annulées</span> </span>
                                </h3>
                                <div class="d-flex text-center flex-column pt-1" style="position: relative;">
                                    <div class="symbol symbol-circle me-5">
