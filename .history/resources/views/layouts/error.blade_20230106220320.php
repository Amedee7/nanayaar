  ...
  <div class="d-flex flex-column flex-root">
    ...
    <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center"
        ...
        <div class="d-flex flex-column flex-row-fluid text-center">
            <h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">Oops... pa</h1>
            <p class="display-4 font-weight-bold text-white">
                Page invalide.</br>
                Reconnectez-vouz à nouveau @if($homeLink ?? false)
                <a href="{{ url('/') }}" class="font-bold underline transition duration-300 hover:text-blue-600">Connexion</a>
        @endif
            </p>
        </div>
        <!--end::Content-->
