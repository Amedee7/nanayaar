...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('configs/configurations', [ConfigurationController::class, 'index'])->name('configurations.index')->middleware('permission:paramètres-voir');
    Route::patch('configs/configurations/{id}/update', [ConfigurationController::class, 'update'])->name('configurations.update')->middleware('permission:paramètres-voir');
});
