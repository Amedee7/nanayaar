            ...
            <div class="col-xl-5">
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom bg gutter-b" style="height: 130px">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    ...
                                    <div class="text-inverse font-weight-bold">CLIENTS
                                    </div>
                                    <div class="text-inverse font-weight-bolder font-size-h3">
                                        {{ $clientAccepté }} </div>
                                </div>
                                <!--end::Stats-->
