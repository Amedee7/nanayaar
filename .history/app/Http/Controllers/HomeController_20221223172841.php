...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dueDate = '2022-01-22'; // remplacez cette valeur par la date limite souhaitée
        ...
        $clientEnRetard = Versement::where('limit', '=', DB::raw("DATE_SUB('$dueDate', INTERVAL 2 DAY)"))->count();
        dd($clientEnRetard);
