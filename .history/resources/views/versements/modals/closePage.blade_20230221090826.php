            ...
            <div class="modal-body">
                    ...
                    <div class="card-body p-0">
                        <div class="px-9 pt-6 card-rounded h-225px w-100 bg-success">
                            <div class="d-flex text-center flex-column text-white pt-5">
                                ...
                                <span
                                    class="font-size-h3 font-weight-boldest pt-1">{{ number_format($versement->montant_octroye, 0, '.', ' ') }}
                                    Fcfa</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex align-items-center bg-light-info rounded p-5">
                    ...
                    <div class="flex-grow-1 me-2">
                        <a href="#" class="font-weight-bold text-gray-800 text-hover-primary fs-6">Client
                            concerné</a>
                ...
                <br>
                <form action="{{ route('versements.finish', $versement->id) }}" method="post"
