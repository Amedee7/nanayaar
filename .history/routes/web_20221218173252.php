...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/file-import', [CLientController::class, 'importView'])->name('import-view');
    Route::post('clients/import', [CLientController::class, 'import'])->name('import');
    Route::get('clients/export-users', [CLientController::class, 'exportUsers'])->name('export-users');
