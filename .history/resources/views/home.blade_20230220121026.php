                    ...
                    <div class="col-lg-12 col-xl-12 order-1 order-xxl-2">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0">
                                <h3 class="card-title font-weight-bolder text-dark">En attente de validation</h3>
                            </div>
                            <!--end::Header-->
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Bullet-->
                                    <span class="bullet bullet-bar bg-primary align-self-stretch m-0 mx-4"></span>
                                    <!--end::Bullet-->
                                    ...
                                    <div class="d-flex flex-column flex-grow-1">
                                        <a href="{{ route('clients.details', $client->uuid) }}" title="Détails"
                                            class="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-1">
                                            Client : {{ $client->name }} {{ $client->lastname }}
                                        </a>
                                        <span class="text-muted font-weight-bold">
                                            Creé le  {{ date_format(new \DateTime($client->created_at), 'd-m-Y à H:i') }}
                                        </span>
                                    </div>
                                    <!--end::Text-->
                                </div>
