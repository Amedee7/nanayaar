            ...
            <ul class="menu-nav ">
                <li class="menu-section">
                    <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="flex-grow-1 me-2">
                            ...
                            <!--end::Separator-->
                            <div class="d-flex align-items-center text-success fs-6 fw-lighter">
                                ...
                                <div class="dropdown dropdown-inline">
                                    <a href="#" class="btn btn-cleanbtn-sm btn-icon" data-toggle="dropdown"
                                        ...
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Lock-overturning.svg--><svg
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                                ...
                                                <!--begin::Separator-->
                                                <div class="separator separator-solid mt-2 mb-5"></div>
                                                <!--end::Separator-->
                ...
                @if ($user->status == 'Actif')
                    ...
                    @permission('client-lire')
                        ...
                        {{ Request::routeIs('clients.edit') ? ' menu-item-open' : '' }}                        
                        {{ Request::routeIs('clients.ViewPages') ? ' menu-item-open' : '' }}                        
                        {{ Request::routeIs('clients.client-supprimer') ? ' menu-item-open' : '' }}                        
                        {{ Request::routeIs('clients.details') ? ' menu-item-open' : '' }} menu-item-submenu"
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Gestion des Clients</span><i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu "><i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    {{-- @permission('client-supprimer')
                                        <li class="menu-item {{ Request::routeIs('clients.client-supprimer') ? ' menu-item-active' : '' }}"
                                            aria-haspopup="true">
                                            <a href="{{ route('clients.client-supprimer') }}" class="menu-link "><i
                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                    class="menu-text">Clients supprimés</span></a>
                                        </li>
                                    @endpermission --}}
                                </ul>
                            </div>
                    ...
                    @permission('versement-lire')
                        ...
                        {{ Request::routeIs('versements.clients-retard') ? 'menu-item-open' : '' }}
                        {{ Request::routeIs('versements.clients-renouvele') ? 'menu-item-open' : '' }}
                        {{ Request::routeIs('versements.historique-versements') ? 'menu-item-open' : '' }}
                        {{ Request::routeIs('versements.finish') ? 'menu-item-open' : '' }} menu-item-submenu"
                            ...
                            <div class="menu-submenu "><i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    @endpermission
                                    @permission('versement-lire')
                                        <li class="menu-item {{ Request::routeIs('versements.clients-renouvele') ? ' menu-item-active' : '' }}"
                                            aria-haspopup="true">
                                            <a href="{{ route('versements.clients-renouvele') }}" class="menu-link "><i
                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                    class="menu-text">Clients renouvelés</span></a>
                                        </li>
                                    @endpermission
                                    
                                    @permission('versement-lire')
                                        <li class="menu-item {{ Request::routeIs('versements.clients-retard') ? ' menu-item-active' : '' }}"
                                            aria-haspopup="true">
                                            <a href="{{ route('versements.clients-retard') }}" class="menu-link "><i
                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                    class="menu-text">Clients en retard</span></a>
                                        </li>
                                    @endpermission
                                    @permission('versement-lire')
                                        <li class="menu-item {{ Request::routeIs('versements.historique-versements') ? ' menu-item-active' : '' }}"
                                            aria-haspopup="true">
                                            <a href="{{ route('versements.historique-versements') }}" class="menu-link "><i
                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                    class="menu-text">Historique des versements</span></a>
                                        </li>
                                    @endpermission
                    ...
                    <li class="menu-item
                        ...
                        <div class="menu-submenu "><i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                ...
                                @endpermission
                                @permission('configuration-regler')
