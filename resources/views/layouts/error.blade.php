...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        style="background-image:url('{{ asset('error/bg6.jpg') }}')">
            <!--begin::Content-->
            <div class="d-flex flex-column flex-row-fluid text-center">
                @isset($title)
                    {{ $title }}
                @else
                <h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">NANA YAAR </h1>
                @endisset
                ...
                <p class="display-4 font-weight-bold">
                    ...
                    Reconnectez-vouz à nouveau @if ($homeLink ?? false)
                        <a href="{{ url('/') }}"
                            class="font-bold text-white underline transition duration-300 hover:text-blue-600">Connexion</a>
                    @endif
                </p>
            </div>
            <!--end::Content-->
