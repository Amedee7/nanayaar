...
class PretController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $pret = new Pret();
        $pret->end                              = $request->date_doctroi;
        $pret->limit                            = $request->date_remboursement;
        $pret->client_id                        = $request->numeroclient;
        ...
        activity("Création du pret")
            ...
            ->performedOn($pret)
            ->withProperties([
                'Nom du pret'  => $pret->end,
            ])
            ->log("Création du pret " . $pret->end);
