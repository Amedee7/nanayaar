                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true" style="">
                                            <div class="menu-item px-5">
                                                <select name="approve">
                                                    <option value="0" @if($cli->status==0)selected @endif>Pending</option>
                                                    <option value="1" @if($cli->status==1)selected @endif>Approve</option>
                                                    <option value="2" @if($cli->status==2)selected @endif>Reject</option>
                                                    <option value="3" @if($cli->status==3)selected @endif>Postponed</option> 
                                                  </select>
                                            </div>
                                            <div class="menu-item px-5">
