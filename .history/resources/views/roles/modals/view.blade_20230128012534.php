                        ...
                        <div class="card card-custom" style="border: solid; border-color: black">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-3">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input3" type="checkbox" {{ ($role->hasPermission('configuration-regler') ? 'checked' : '') }} name="permissions[]" value="configuration-regler" >
                                            <span></span>
                                ...
                                <div class="col-md-3">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input4" type="checkbox" {{ ($role->hasPermission('log-consulter') ? 'checked' : '') }} name="permissions[]" value="log-consulter" >
                                            <span></span>
                                            Voir les logs
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-3 mt-5">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled class="input-xlg bgc-blue" id="input5" type="checkbox" {{ ($role->hasPermission('client-status') ? 'checked' : '') }} name="permissions[]" value="client-status" >
                                            <span></span>
