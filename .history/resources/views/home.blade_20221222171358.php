                        ...
                        <div class="card card-custom bg-primary gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="text-inverse-primary font-weight-bold">Author Stats
                                    </div>
                                    <div
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom bg-success gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                <!--begin::Stats-->
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="text-inverse-success font-weight-bold">Commisions</div>
                                    <div class="text-inverse-success font-weight-bolder font-size-h3">
                                        $2,005</div>
                                </div>
                                <!--end::Stats-->
