					...
					render: function render(data, type, full, meta) {			
							return '<div class="d-flex align-items-center">\
								<div class="symbol symbol-40 symbol-light-'' flex-shrink-0">\
									<span class="symbol-label font-size-h4 font-weight-bold">' +name.substring(0, 1) + '</span>\
								</div>\
								<div class="ml-4">\
									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + name + '</div>\
									<a href="#" class="text-muted font-weight-bold text-hover-primary">' +lastname + '</a>\
								</div>\
							</div>';
						}
					},
