...
class ClientController extends Controller
{
    ...
    {
        $clientEncours = DB::table('clients')->where('state', 'En cours')->where('clients.deleted_at', null)->count();
        $clientTermine = DB::table('clients')->where('state', 'Terminé')->where('clients.deleted_at', null)->count();
        $clientAnnule = DB::table('clients')->where('state', 'Annulé')->where('clients.deleted_at', null)->count();
