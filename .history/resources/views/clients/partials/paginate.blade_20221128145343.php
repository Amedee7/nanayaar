                ...
                <td>
                    <span style="width: 250px;">
                        <div class="d-flex align-items-center">
                            <div class="ml-0">
                                <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                    {{ number_format($item->montant_demande, 2) }} FCFA</div>
                            </div>
                        </div>
                    </span>
                </td>
                ...
                <td>
                    <span style="width: 250px;">
                        <div class="d-flex align-items-center">
                            <div class="ml-0">
                                <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                    {{ Str::limit($client->user->firstname) }} {{ Str::limit($client->user->lastname) }}
                                </div>
                            </div>
                        </div>
                    </span>
                    ...
                    <span style="width: 250px;">
                        <div class="d-flex align-items-center">
                            <div class="ml-0">
                                <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                    {{ $item->created_at }}</div>
                                <a class="text-muted font-weight-bolder primary-color">PAR: <span
                                    class="font-weight-boldest">{{ Str::limit($item->full_name) }}</span></a>
                            </div>
                        </div>
                    </span>
                </td>
