...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/terminer', [VersementController::class, 'closeVersementPage'])->name('versements.termine')->middleware('permission:versements-modifier');
    Route::patch('/versements/{id}/finish', [VersementController::class, 'closeVersementPageStore'])->name('versements.finish')->middleware('permission:versements-modifier');
    Route::get('/versements/{id}/show', [VersementController::class, 'showVersement'])->name('versements.show')->middleware('permission:versements-lire');
    Route::get('/versements/{id}/cancel', [VersementController::class, 'VersementCancel'])->name('versements.cancel')->middleware('permission:versements-modifier');
    Route::get('/versements/{id}/rule', [VersementController::class, 'VersementAmountRule'])->name('versements.rule')->middleware('permission:versements-règlement');
    Route::patch('/versements/{id}/rule/store', [VersementController::class, 'VersementAmountRuleStore'])->name('versements.rule.store')->middleware('permission:versements-règlement');
    Route::delete('/versements/{id}/delete', [VersementController::class, 'VersementDelete'])->name('versements.delete')->middleware('permission:versements-supprimer');
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->name('versements.modify')->middleware('permission:versement-modifier');
