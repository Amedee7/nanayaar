    ...
    <div class="modal-dialog  modal-dialog-centered" style="width: 1000px!important;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Effectuer</h5>
            ...
            <div class="modal-body">
                ...
                <br>
                <form action="{{route('versements.finish', $versement->id)}}" method="post" id="evote-record-form-datatable">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-5">
