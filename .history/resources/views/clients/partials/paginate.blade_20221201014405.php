            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                            ...
                            <button onclick="deleteRecordConfirm('{{route('clients.destroy', $item->id)}}')" title="Supprimer"  class="btn btn-outline-danger btn-sm"><span class="flaticon2-trash"></span></button>
                        </form>
                    @endif
                </td>
            </tr>
