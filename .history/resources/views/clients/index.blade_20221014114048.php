                ...
                <tbody>
                    @foreach($clients as $key=>$client)
                     <tr>
                         ...
                         <td>
                           @if($client->status==1)
                           <a href="{{ url('clients.change-status/'.$client->id) }}" onclick="return confirm('Are you Sure?')" class="btn btn-sm btn-success">Active</a>
                           @else
                           <a href="{{ url('clients/change-status/'.$client->id) }}" onclick="return confirm('Are you Sure?')" class="btn btn-sm btn-danger">Inactive</a>
                           @endif
                         </td>
                         <td>
