        ...
        <div class="card card-xl-stretch mb-5 mt-3 mb-xl-8">
            ...
            <div class="card-body py-3">
                <div class="table-responsive">
                    <table id="o2d-datatable" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="02d-datatable">
                        <thead>
                            <tr class="fw-bolder text-muted">
                                <th class="min-w-140px">ID</th>
                                <th class="min-w-140px">CLIENT</th>
                                <th class="min-w-140px">ETAT</th>
                                <th class="min-w-120px">MONTANT DEBLOQUE</th>
                                <th class="min-w-120px">VERSEMENT</th>
        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
...

                {
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class=" label label-light-success label-inline font-weight-bolder fs-6">' +data.toLocaleString('fr') + '</span>'
                    }
                },
