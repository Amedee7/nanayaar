            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <button type="submit" class="btn btn-secondary btn-sm" name="exportPDF2">Export PDF 2</button>
                     ...
                     <div class="dropdown dropdown-inline mr-2">
                        ...
                        <button type="submit" class="btn btn-secondary btn-sm" name="exportPDF"><i class="la la-file-excel-o"></i>Export tous les clients</button>
                                    </a>
                                </li>
                                <li class="navi-item">
                                    <a href="#" class="navi-link">
                                        <button type="submit" class="btn btn-secondary btn-sm" name="exportPDF2"><i class="la la-file-excel-o"></i>Export clients en attente</button>
                                    </a>
                                </li>
                            </ul>
                            <!--end::Navigation-->
