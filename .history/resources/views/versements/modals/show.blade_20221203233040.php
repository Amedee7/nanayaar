                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="font-weight-bold text-muted  text-uppercase text-right">RESTE A PAY</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="font-weight-bolder">
                                            <td><span class="badge badge-light-success">{{number_format($outStock->amount_total,0, '.',' ')}}</td>
                                            <td><span class="badge badge-light-warning">{{number_format($outStock->amount_payed,0, '.',' ')}}</td>
                                            <td class="text-primary font-size-h3 font-weight-boldest text-right"><span class="badge badge-light-success">{{number_format($outStock->amount_total,0, '.',' ')}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
