...
class ClientController extends Controller
{
    ...
    {
        $outStocksEncours = DB::table('out_stocks')->where('state', 'En cours')->where('out_stocks.deleted_at', null)->count();
        $outStocksTermine = DB::table('out_stocks')->where('state', 'Terminé')->where('out_stocks.deleted_at', null)->count();
        $outStocksAnnule = DB::table('out_stocks')->where('state', 'Annulé')->where('out_stocks.deleted_at', null)->count();
        return view('outstock.index',[
            'outStocksEncours' =>$outStocksEncours,
            'outStocksTermine' =>$outStocksTermine,
            'outStocksAnnule' =>$outStocksAnnule
        ]);
