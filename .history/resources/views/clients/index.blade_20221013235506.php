                ...
                <tbody>
                    @foreach($clients as $client)
                       <tr>
                          ...
                          <td>
                             <input data-id="{{$client->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $user->status ? 'checked' : '' }}>
                          </td>
                       </tr>
                    @endforeach
                 </tbody>
    ...
    $(function() {
      $('.toggle-class').change(function() {
          ...
          $.ajax({
              ...
              dataType: "json",
              url: '/changeStatus',
              data: {'status': status, 'user_id': client_id},
