...
@section('content')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Ajouter un étudiant</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-3 container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bolder my-1 mr-5">
                    ...
                    Création d'un nouveau étudiant. <a href="{{ route('students.index') }}"><span
        ...
        <div class="d-flex align-items-center">
            <div class="btn-group dropup">
                <div class="btn-group dropup">
                    <button onclick="studentStoreRecord()" id="sender" type="button" class="btn btn-primary">
                        <strong>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
            <form action="{{ route('students.store') }}" method="POST" id="orange-create-record-form">
                ...
                <ul class="nav nav-tabs nav-tabs-line mb-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#kt_tab_pane_2">
                            <span class="nav-icon"><i class="flaticon2-pie-chart-4"></i></span>
                            <span class="nav-text">Dossiers medicals</span>
                        </a>
                    </li>
                </ul>
                                        ...
                                        <div class="row">
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label>Numéro matricule <span class="text-danger">*</span></label>
                                                    <input readonly type="text" class="form-control" name="ine"
                                                        value="{{ $lastClient }}">
                                                    <span class="ine_err error text-danger"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Catégorie <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control" name="catégorie" style="width: 100%">
                                                        <option value="">--Veuillez choisir--</option>
                                                        <option value="Internant">Internant</option>
                                                        <option value="Externant">Externant</option>
                                                        <option value="Mixte">Mixte</option>
                                                    </select>
                                                    <span class="catégorie_err error text-danger"></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body example-preview" id="kt_blockui_content">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label>Liste des pays <span class="text-danger">*</span></label>
                                                <select class="form-control" name="ville" id="mySelect2"
                                                    style="width: 100%">
                                                    <option value="">--Veuillez choisir--</option>
                                                ...
                                                <span class="ville_err error text-danger"></span>
                                            </div>
                                            <div class="form-group col-md-4">
