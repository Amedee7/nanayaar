    ...
    public function store(Request $request)
    {
        ...
        activity("Modification d'un compte")
                ...
                ->withProperties([
                    'previous' => $previous,
                    'new' => [
                        'Nom' => $versement->firstname,
                        'Prenom'  => $user->lastname,
                        'Adresse email'     => $versement->email,
                        'Telephone'    => $versement->telephone,
                        'Statut' => $versement->status
                    ]
                ])
                ->log("Modification de compte utilisateur " . $versement->firstname . ' ' . $versement->lastname);
