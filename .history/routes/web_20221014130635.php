...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/moderation_clients', [ClientController::class, 'moderation_clients'])->middleware('permission:moderation_clients')->name('clients.moderation_clients');
