                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="" data-bs-original-title="Modifier les informations du client">
                                        <a onclick="editRecord('{{route('clients.edit', $customer->id)}}')" class="btn btn-sm btn-light-primary">Modifier</a>
                                    </span>
                                </div>
                            ...
                            <li class="nav-item ms-auto">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true" style="">
                                    <div class="menu-item px-5">
                                        <a onclick="showRecord('{{route('clients.consignation', $customer->id)}}')" class="menu-link px-5">Consignations</a>
                                    </div>
                                    <div class="menu-item px-5">
                                        <a onclick="requestAccountStatusRefresh('{{route('clients.status', $customer->id)}}')" title="Changer de statut" class="menu-link px-5">{{$customer->status=='Actif'?'Désactiver':'Activer'}}</a>
                                    </div>
                                    <div class="menu-item px-5">
