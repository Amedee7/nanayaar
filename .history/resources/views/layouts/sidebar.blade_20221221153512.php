                ...
                <li class="menu-section">
                    <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="flex-grow-1 me-2">
                            <a href="#" class="text-white text-hover-primary font-size-5 fw-bold">
                                {{ Auth::user()->firstname }}</a>
                            <span class="text-gray-600 fw-bold d-block font-size-5 mb-1">{{ Auth::user()->lastname }}</span>
                            <div class="d-flex align-items-center text-success font-size-5">
                                <span class="bullet bullet-dot bg-success font-size-2 mr-1"></span>
