                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="font-weight-bolder">
                                            <td><span class="badge badge-light-success">{{number_format($versement->montant_octoye,0, '.',' ')}}</td>
                                            <td><span class="badge badge-light-warning">{{number_format($versement->amount_payed,0, '.',' ')}}</td>
                                            <td><span class="text-primary font-size-h3 font-weight-boldest text-right"><span class="badge badge-light-success">{{number_format($versement->amount_total,0, '.',' ')}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
