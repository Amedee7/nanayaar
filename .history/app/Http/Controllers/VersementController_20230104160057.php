    ...
    public function viewReport(Request $req)
    {
        ...
        if ($req->isMethod('post')) {
            ...
            if ($req->has('exportClientAcPDF')) {
                $PDFReport = Verse::where('status', 'Accepté')->whereBetween('created_at', [$startDate, $endDate])->get();
                $user = Auth::user();
                $configurations = Configuration::first();
            ...
            if ($req->has('exportClientAttPDF')) {
                $PDFReport = Verse::where('status', 'Attente')->whereBetween('created_at', [$startDate, $endDate])->get();
                $user = Auth::user();
                $configurations = Configuration::first();
            ...
            if ($req->has('exportClientRej')) {
                ...
                $PDFReport = Verse::where('status', 'Rejeté')->whereBetween('created_at', [$startDate, $endDate])->get();
                $user = Auth::user();
                $configurations = Configuration::first();
