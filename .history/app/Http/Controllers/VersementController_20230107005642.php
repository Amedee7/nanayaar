...
class VersementController extends Controller
{
    public function datatables()
    {
        ...
        ->addColumn('colonne1', function($result) {
            return $result->colonne1;
        })
        ->addColumn('penalite', function($result) {
            $date1 = Carbon::parse($result->date1);
            $date2 = Carbon::parse($result->date2);
            if ($date1 > $date2) {
