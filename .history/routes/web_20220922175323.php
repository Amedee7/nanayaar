...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/prets', [PrettController::class, 'index'])->middleware('permission:pret-lire')->name('prets.index');
    ...
    //PRETS ROUTE
    Route::get('/versements/datatable', [PretController::class, 'datatables'])->middleware('permission:versement-lire')->name('versements.datatables');
    Route::get('/versements', [PrettController::class, 'index'])->middleware('permission:versement-lire')->name('versements.index');
    Route::get('/versements/create', [PretController::class, 'create'])->middleware('permission:versement-creer')->name('versements.create');
    Route::post('/versements/store', [PretController::class, 'store'])->middleware('permission:versement-creer')->name('versements.store');
    Route::get('/versements/{id}/view', [PretController::class, 'show'])->middleware('permission:versement-lire')->name('versements.show');
    Route::get('/versements/{id}/edit', [PretController::class, 'edit'])->middleware('permission:versement-modifier')->name('versements.edit');
    Route::patch('/versements/{id}/update', [PretController::class, 'update'])->middleware('permission:versement-modifier')->name('versements.update');
    Route::delete('/versements/{id}/destroy', [PretController::class, 'destroy'])->middleware('permission:versement-supprimer')->name('versements.destroy');
});
