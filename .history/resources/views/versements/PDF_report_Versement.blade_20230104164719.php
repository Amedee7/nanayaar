    ...
    <table class="table">
        ...
        @foreach ($PDFReportVersement as $PDFReportVersements)
            <tr>
                ...
                <td>{{ $PDFReportVersements->client['name'] }} {{ $PDFReportVersements['lastname'] }}</td>
                <td> N CLient: {{ $PDFReportVersements->client['numb_cli'] }} <br> Tel1: {{ $PDFReportVersements['first_phone'] }} <br> Tel2:
                    {{ $PDFReportVersements['second_phone'] }}</td>
                ...
                <td>{{ $PDFReportVersements->numb_cnib }}</td>
            </tr>
        @endforeach
    </table>
