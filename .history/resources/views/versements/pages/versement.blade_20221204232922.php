                            ...
                            <div class="d-flex mb-8">
                                ...
                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                    ...
                                    <span class="text-muted font-weight-bold font-size-sm mb-3">
                                        Téléphone 1: <span
                                            class="text-dark-75 font-weight-bolder">{{ $versement->first_phone }}</span>
                                    </span>
                                    <span class="text-muted font-weight-bold font-size-lg">
                                        Téléphone 2: <span
                                            class="text-dark-75 font-weight-bolder">{{ $versement->second_phone }}</span>
                                    </span>
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card-body pt-2">
                            <div class="row">
                                <div class="fs-1x fw-bolder text-gray-700 text-nowrap">
                                    <span class="label fs-7 m-1 label-light-success label-inline">TOTAL</span>
                                </div>
                                <div class="col">
                                    <div class="card card-dashed flex-center  min-w-175px my-3 p-6">
                                        <span
                                            class="fs-lg-2x font-wight-bolder d-flex justify-content-center">{{ number_format($versement->montant_octroye, 0, '.', ' ') }}
                                            Fcfa</span>
                                    </div>
                                </div>
                            </div>
