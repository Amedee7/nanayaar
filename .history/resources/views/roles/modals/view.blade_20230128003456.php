                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            ...
                                            <td>
                                                @if (array_key_exists($module.'-statu',$permissions))
                                                    <div class="checkbox-inline">
                                                        <label class="checkbox checkbox-lg">
                                                            <input name="permissions[]" disabled type="checkbox" {{ ($role->hasPermission($module.'-statu') ? 'checked' : '') }} name="permissions[]" value="{{ $module.'-statu' }}">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                @endif
