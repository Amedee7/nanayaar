...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::patch('/stocks/sortie-stock/{id}/modifier/stock', [VersementController::class, 'modifyOutStockAddStore'])->name('versements.modify.versement')->middleware('permission:commande-modifier');
