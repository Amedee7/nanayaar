...
class VersementController extends Controller
{
    ...
    public function versementPageStore(Request $request, $id)
    {
     ...
     public function modifyVersementModifierMo($id){
        $products = Product::join('stocks', 'stocks.product_id', '=', 'products.id')
            ->select(
                'products.id','products.name','products.volume','products.bottles','products.price',
                'stocks.objects'
            )->get();
        return view('outstock.modals.addProduct', ['products'=>$products, 'id'=>$id]);
    }
