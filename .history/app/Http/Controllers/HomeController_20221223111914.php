...
class HomeController extends Controller
{
    ...
    {
        $today = Carbon::today();
        $diff = DateLimitpaiement::generateLimitdate() - strtotime($date1);
        ...
        $clientEnRetard = Versement::where('state', 'Terminé')->whereDate('limit', '>', DateLimitpaiement::generateLimitdate() - 2)->count('limit');
