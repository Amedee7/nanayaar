    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('versements.modify.versement', $id)}}" method="post" id="evote-edit-form-datatable">
                    @csrf
                    @method('PATCH')
                    <div class="row mb-5">
                            ...
                            <input type="number" name="montant_aoctroye" class="form-control" placeholder="Montant disponible">
                            <span class="montant_ao_err error text-danger"></span>
                        </div>
                    </div>
                </form>
            </div>
