                                            ...
                                            <table class="table align-middle table-row-dashed gy-5 dataTable no-footer" id="evote-datatable">
                                                ...
                                                <tbody class="fs-6 fw-bold text-gray-600">
                                                    @foreach($client as $item)
                                                        <tr class="odd">
                                                            <td>
                                                                <span class="badge badge-light-success">{{$item->numb_cli}}</span>
                                                            ...
                                                            <td class="text-success">{{number_format($item->montant_demande,0, '.',' ')}}</td>
                                                            <td class="text-danger">{{number_format($item->montant_demande,0, '.',' ')}}</td>
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a onclick="showRecord('{{route('s#')"  class="menu-link px-3">Régler</a>
                                                                </div>
                                                                @endif
                                                                <div class="menu-item px-3">
                                                                    <a onclick="showRecord('#')" class="menu-link px-3">Détails</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        </tr>
