                        ...
                        <div class="col-md-12 mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01">Sts Vrsmt</label>
                                        </div>
                                        <select class="custom-select" id="select_sts_ver">
                                            <option value="">Choose...</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <button id="reset_sts" class="btn btn-sm btn-outline-info">Reset Status</button>
                                <button id="reset_sts_ver" class="btn btn-sm btn-outline-info">Reset Result</button>
...
@section('js')
    ...
    <script>
        ...
        // Fetch Status versements
        function fetch_sts_ver() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#select_sts_ver").append(sts_verBody);
                }
            });
        }
        fetch_sts_ver();
        ...
        // Fetch records
        function fetch(start_date, end_date, sts, sts_ver) {
            $.ajax({
        ...
        $(document).on("click", "#filter_status", function(e) {
            ...
            var sts_ver = $("#select_sts_ver").val();
            if (sts !== "" && sts_ver !== "") {
        ...
        $(document).on("click", "#reset_status", function(e) {
            ...
            $("#select_sts_ver").html(`<option value="">Choose...</option>`);
            $('#records').DataTable().destroy();
            fetch();
            fetch_sts();
            fetch_sts_ver();
