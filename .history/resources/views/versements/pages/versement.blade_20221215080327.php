                                    ...
                                    <div class="flex-lg-row-fluid mb-4 mb-lg-0 me-lg-7 me-xl-10">
                                        <div class="card">
                                            <div class="card-body p-6">
                                                <div class="d-flex flex-column align-items-start justify-content-between flex-xxl-row">
                                                    <div class="d-flex align-items-center flex-equal fw-row me-4 order-2">
                                                        <div class="fs-6 fw-bolder text-gray-700 text-nowrap">Date de création: {{($versement->created_at)}}</div>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row">
                                                        <div class="fs-1x fw-bolder text-gray-700 text-nowrap">
                                                            <span class="label font-size-h5 m-1 label-light-success label-inline">Operation de versement</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table align-middle table-row-dashed fs-6 fw-bold gy-4 dataTable no-footer table-responsive" id="kt_subscription_products_table">
                                                        <thead>
                                                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                                                <th class="min-w-250px sorting_disabled" style="width: 200px;">N VERSEMENT</th>
                                                                <th class="min-w-100px sorting_disabled" >SOMME</th>
                                                                <th class="min-w-150px sorting_disabled" style="width: 150px;">M. TOTAL</th>
                                                        ...
                                                        <tbody class="text-gray-600">
                                                            @foreach($versements as $item)
                                                                <tr class="even">
                                                                    <td><a class="text-muted fw-bolder text-hover-primary mb-1 fs-6">{{$item->identifiant_versement}}</a></td>
                                                                    <td><span class=" badge badge-light-success fw-bolder fs-6">{{number_format($item->somme_verse,0, '.',' ')}} Fcfa</span></td>
                                                                    <td><span class=" badge badge-light-success fw-bolder fs-6">{{number_format($item->montant_octroye,0, '.',' ')}} Fcfa</span></td>
                                                                    <td class="text-end">
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        ...
                                                        <tfoot>
                                                            <tr><th colspan="5" class="text-end"><span class="fs-sm-3 fw-bolder"> Versement(s)</span></th></tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-footer p-6">
                                                @if($outStock->state=='En cours')
                                                <div class="card">
                                                    <div class="card-footer d-flex justify-content-end py-6">
                                                        <a onclick="cancelRecordConfirm('{{route('versements.cancel',$versements->id)}}')" class="btn btn-danger btn-active-light-danger me-2">Annuler</a>
                                                        <button id="senderX" onclick="versementClose('{{route('versements.termine',$versements->id)}}')" class="btn btn-primary">
                                                            <strong>
