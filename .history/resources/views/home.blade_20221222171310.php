...
@section('content')
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-3">
                <!--begin::Tiles Widget 5-->
                <div class="card card-custom bg-succ gutter-b" style="height: 130px">
                    <!--begin::Body-->
                    <div class="card-body d-flex flex-column p-0">
                        <!--begin::Stats-->
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-succ font-weight-bold">Commisions</div>
                            <div class="text-inverse-succ font-weight-bolder font-size-h3">
                                $2,005</div>
                        </div>
                        <!--end::Stats-->
