                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="font-weight-bolder">
                                            <td><span class="label label-light-success label">{{number_format($versement->reste_apaye,0, '.',' ')}}</td>
                                            <td><span class="label label-light-warning label">{{number_format($versement->somme_verse,0, '.',' ')}}</td>
                                            <td><span class="text-primary font-size-h3 font-weight-boldest text-right"><span class="label label-light-success label">{{number_format($versement->montant_octroye,0, '.',' ')}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
