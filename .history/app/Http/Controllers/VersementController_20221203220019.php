...
class VersementController extends Controller
{
    ...
    public function showVersement($id){
        $verse = DB::table('out_stocks')->where('id', $id)->first();
        if ($verse) {
            $customer = Client::where('id', $verse->customer_id)->first();
            $listProducts = Product_out_stock::where('enter_stock_id', $verse->id)
                ...
                ->get();
            $productsCount = Product_out_stock::where('enter_stock_id', $verse->id)->count();
            $user = User::where('id', $verse->created_by)->first();
            return view('outstock.modals.show', [
                'outStock' => $verse, 'customer' => $customer, 'user' => $user,
