                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <span class="utilisateur_orange_err error text-danger"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="o-telephone" class="form-control"
                                                name="numero_orange" placeholder="Entrer le numero 1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="o-telephone2" class="form-control"
                                                name="numero_orange" placeholder="Entrer le numero 2">
                                            <span class="numero_orange_err error text-danger"></span>
                                        </div>
                                    </div>
                                </div>
