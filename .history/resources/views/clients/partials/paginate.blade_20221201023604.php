            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('clients.details', $item->uuid) }}" title="Détails"
                        class="btn btn-primary btn-sm"><span class="flaticon2-flaticon-eye"></span></a>
                        <form method="POST" action="{{ route('clients.destroy', $item->id) }}">
                            @csrf
                            <input name="_method" type="hidden" value="DELETE">
                            <button type="submit" class="btn btn-danger delete" title='Delete'><span class="flaticon2-trash"></span></button>
                        </form>
                    @endif
                </td>
            </tr>
