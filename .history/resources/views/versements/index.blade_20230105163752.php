                    ...
                    <div class="card card-xl-stretch mb-5 mt-3 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5 d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="btn-group dropup">
                                    <div class="btn-group dropup">
                                        <button onclick="createRecord('{{ route('versements.create') }}')" id="sender" type="button" class="btn btn-primary">
                                            <strong>
                                                <b id="text-load" class="text-hide">Veuillez patienter...</b>
                                                <b id="text-fix"><span class="flaticon-file-1 mr-2"></span> Octroyé un pret</b>
                                            </strong>
                                        </button>
                                        ...
                                        <div class="dropdown-menu" style="">
                                            <a onclick="createRecord('{{ route('versements.renews') }}')" class="dropdown-item" href="#"><span class="flaticon-interface-4 mr-2"></span> Renouvelé un pret</a>
                                        </div>
                                    </div>
                                </div>
                                @endpermission
