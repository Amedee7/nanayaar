                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless" id="record_table" style="width:100%;">
                                            ...
                                            <tbody>
                                                @foreach ($clients as $PDFReports)
                                                    <tr>
                                                        <td>{{ $PDFReports->id }}</td>
                                                        <td>{{ $PDFReports['name'] }} {{ $PDFReports['lastname'] }}</td>
                                                        <td> N CLient: {{ $PDFReports['numb_cli'] }} <br> Tel1:
                                                            {{ $PDFReports['first_phone'] }} <br> Tel2:
                                                            {{ $PDFReports['second_phone'] }}</td>
                                                        <td>{{ number_format($PDFReports['montant_demande'], 0, '.', ' ') }}
                                                            Fcfa</td>
                                                        <td>{{ number_format($PDFReports['commission_averse'], 0, '.', ' ') }}
                                                            Fcfa</td>
                                                        <td>{{ $PDFReports->numb_cnib }}</td>
                                                        <td>{{ $PDFReports->montant_ }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
