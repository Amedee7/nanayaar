                                                    ...
                                                    @foreach ($client->versements as $versement)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="label label-lg label-light-danger label-inline">Rejeté</span>
                                                            @elseif ($versement->status === 'Accepté')
                                                                <span
                                                                    class="label label-lg label-light-success label-inline">Accepté</span>
                                                            @else
                                                                <span
                                                                    class="label label-lg label-light-primary label-inline">En
                                                                    attente</span>
                                                            @endif
                                                            <td>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                                                    {{ $versement->somme_versement }}
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                                                    {{ $versement->reste_apayed }}
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    @endforeach
