...
class ClientController extends Controller
{
    ...
    public function detailClient(Client $client, $id)
    {
        $client = Client::find($id);
        $versements = $client->versements;
        return view('clients.pages.details', ['client' => $client, 'versements' => $versements]);
    }
    ...
    public function versements($id)
    {
        ...
        return view('clients.pages.details', ['versements' => $versements]);
    }
