                ...
                <tbody>
                    @foreach($clients as $client)
                       <tr>
                          ...
                          <td>
                             <input data-id="{{$client->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="InActive" {{ $client->status ? 'checked' : '' }}>
                          </td>
                       </tr>
                    @endforeach
                 </tbody>
    ...
    $(function() {
      $('.toggle-class').change(function() {
          ...
          $.ajax({
              type: "GET",
              dataType: "json",
              url: 'clientschangeStatus',
              data: {'status': status, 'client_id': id},
