...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/stocks/sortie-stock/{id}/modifier/ajouter', [App\Http\Controllers\StockController::class, 'modifyOutStockAdd'])->name('stocks.outer.modify.add')->middleware('permission:commande-modifier');
