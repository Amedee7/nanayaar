        ...
        <div class="card">
            <div class="card-footer d-flex justify-content-end py-6">
                <a onclick="cancelRecordConfirm('{{ route('versements.cancel', $versement->id) }}')"
                    class="btn btn-danger btn-active-light-danger me-2">Annuler</a>
                <button id="senderX" onclick="versementClose('{{ route('versements.termine', $versement->id) }}')"
                    class="btn btn-primary">
                    <strong>
                        <b id="text-loadX" class="visually-hidden">Veuillez patienter... <span class="spinner-border"
                                role="status"></span></b>
                        <b id="text-fixX">Versé</b>
                    </strong>
                </button>
            </div>
        </div>
