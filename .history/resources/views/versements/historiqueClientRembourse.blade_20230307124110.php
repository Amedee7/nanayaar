                            ...
                            <td>
                                <span style="width: 250px;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="ml-4">
                                                <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">{{ $item->client-name }}
                                                    {{ $item->client-lastname }}</div>
                                                <a class="text-muted font-weight-bolder primary-color">N Client: <span
                                                        class="font-weight-boldest text-success">{{ $item->client-numb_cli }}</span></a>
                                            </div>
                                        </div>
                                </span>
                            </td>
