                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    ...
                                    <div class="text-inverse-white">
                                        <span class="text-inverse-white font-weight-bolder font-size-h1" >{{number_format($totalCommissions,0, '.',' ')}}</span> Fcfa</div>
                                </div>
                                <!--end::Stats-->
                ...
                <div class="card card-custom bg-white gutter-b" style="height: 130px">
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            ...
                            <div class="text-inverse-white">
                                <span class="text-inverse-white font-weight-bolder font-size-h1" >{{number_format($totalMontantOctroyé,0, '.',' ')}}</span> Fcfa</div>
                            <div class="text-inverse-white font-weight-bolder font-size-h1">
