...
class VersementController extends Controller
{
    public function datatables()
    {
        $versements = DB::table('versements')
            ...
            ->select(
                ...
                db::raw('Carbon::parse(debut) as date_debut'),
                db::raw('Carbon::parse(fin) as date_fin'),
    ...
    public function index(Request $request)
    {
        ...
        $joursApresDateLimite = DB::table('versements')->select(db::raw('Carbon::now()->diffInDays(fin) as joursApresDateLimite'))->get();
        ...
        $versements = DB::table('versements')
            ...
            ->select(
                ...
                db::raw('Carbon::parse(debut) as date_debut'),
                db::raw('Carbon::parse(fin) as date_fin'),
                db::raw('Carbon::now()->diffInDays(date_fin) as joursApresDateLimite '),
        ...
        // // Créez une instance de Carbon pour la date limite
        // $dateLimite = Carbon::parse('2022-12-31');

        // // Créez une instance de Carbon pour la date actuelle
        // $dateActuelle = Carbon::now();

        // // Utilisez la méthode diffInDays pour déterminer le nombre de jours entre les deux dates
        // $nombreDeJours = $dateActuelle->diffInDays($dateLimite);


        // $reste_apaye = 20000;


        // $penalite = $reste_apaye * 1 / 100 * $nombreDeJours;
        // dd($penalite);
