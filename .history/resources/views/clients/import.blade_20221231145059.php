                            ...
                            <form class="form" id="kt_form">
                                <div class="row justify-content-center">
                                    <div class="col-xl-9">
                                        ...
                                        <!--end::Wizard Step 1-->
                                        <form action="{{ route('clients.ViewPages') }}" class="form" id="kt_form" method="POST" enctype="multipart/form-data">
                                            @csrf
                                                <div class="row">
                                                    <label for="from" class="col-form-label">De</label>
                                                    <div class="col-md-2">
                                                        <input type="date" class="form-control form-control-solid form-control-lg" id="from" name="from">
                                                    </div>
                                                    <label for="from" class="col-form-label">A</label>
                                                    <div class="col-md-2">
                                                        <input type="date" class="form-control form-control-solid form-control-lg" id="to" name="to">
                                                    </div>
                                                    {{-- <div class="col-md-4">
