            ...
            <div class="col-xl-5">
                <div class="row">
                        ...
                        <div class="card card-custom bg-danger gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="text-inverse-danger font-weight-bold">Author Stats
                                    </div>
                                    <div
                                        class="text-inverse-danger font-weight-bolder font-size-h3">
                                        3,620</div>
                                </div>
                                <!--end::Stats-->
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom bg-su gutter-b" style="height: 130px">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column p-0">
                                <!--begin::Stats-->
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="text-inverse-su font-weight-bold">Commisions</div>
                                    <div class="text-inverse-su font-weight-bolder font-size-h3">
                                        $2,005</div>
                                </div>
                                <!--end::Stats-->
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-danger gutter-b" style="height: 130px">
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        <!--begin::Stats-->
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-danger font-weight-bold">Commisions</div>
