                                            ...
                                            <form action="{{ route('clients.destroy', $client->id) }}" method="POST"
                                                ...
                                                <div class="menu-item px-5">
                                                    <form method="POST" action="{{ route('clients.destroy', $item->id) }}">
                                                        ...
                                                        <button type="submit" class="btn btn-danger btn-sm delete" title='<form method="POST" action="{{ route('clients.destroy', $item->id) }}">
                                                            @csrf
                                                            <input name="_method" type="hidden" value="DELETE">
                                                            <button type="submit" class="btn btn-danger btn-sm delete" title='Supprimer'><span class="far fa-trash-alt"></span></button>
                                                        </form>'><span class="far fa-trash-alt"></span></button>
                                                    </form>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div
                                                ...
                                                <div class=" text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <input class="font-weight-boldest text-success form-control"
                                                            value="{{ $client->montant_demande }}" type="text"
                                                            id="o-telephone" class="form-control" name="numero_1"
