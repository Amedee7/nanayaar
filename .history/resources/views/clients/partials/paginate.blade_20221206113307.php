                    ...
                    <div class="mb-6">
                        <label class="flex flex-col block">
                            ...
                            <select class="block w-full mt-1" name="status">
                                <option value="Accepté" @selected($blog->status == 'published')>Accepté</option>
                                <option value="Rejeté" @selected($blog->status == 'draft')>Rejeté</option>
                                <option value="Attente" @selected($blog->status == 'archived')>Archived</option>
                            </select>
                        </label>
                    </div>
