                ...
                menu-item-submenu menu-item-open menu-item-here"
                    ...
                    <div class="menu-submenu "><i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            {{ Request::routeIs('clients.details') ? ' menu-item-open' : '' }}  menu-item-parent" aria-haspopup="true"><span
                                    class="menu-link"><span class="menu-text">Gestion des Clients</span></span>
                            </li>
                            <li class="menu-item  menu-item-submenu menu-item-open menu-item-here"
                                ...
                                <div class="menu-submenu "><i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ Request::routeIs('clients.create') ? ' menu-item-active' : '' }}" aria-haspopup="true"><a
                                            href="{{ route('clients.create') }}" class="menu-link "><i
