...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::post('/versements/store', [App\Http\Controllers\StockController::class, 'versementStore'])->name('versements.out.store')->middleware('permission:commande-modifier');
