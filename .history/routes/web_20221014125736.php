...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/moderation-clients', [ClientController::class, 'moderation-clients'])->middleware('permission:client-moderation-clients')->name('clients.moderation-clients');
