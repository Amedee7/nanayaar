...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/moderation-client', [ClientController::class, 'moderation-client'])->middleware('permission:client-moderation-clients')->name('clients.moderation-client');
