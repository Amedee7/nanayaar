...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-modifier')->name('versements.historique.versement');
