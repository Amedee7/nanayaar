...
@section('content')
    ...
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            @if(request()->has('trashed'))
                                <a href="{{ route('clients.restore', $post->id) }}" class="btn btn-success">Restore</a>
                            @else
                                <form method="POST" action="{{ route('clients.destroy', $post->id) }}">
                                    @csrf
        ...
        <div class="float-end">
            ...
            @else
                <a href="{{ route('clients.index', ['trashed' => 'post']) }}" class="btn btn-primary">View Deleted clients</a>
            @endif
        </div>
    </div>
