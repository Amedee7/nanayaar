...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/historique-versements', [VersementController::class, 'historiqueClientRembourse'])->middleware('permission:versement-lire')->name('versements.historiqueClientRembourse-versements');
