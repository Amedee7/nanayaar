        ...
        <div id="client">
            <div class="to" style="text-transform: uppercase;">
                @if (request()->has('exportClientAttPDF'))
                    ...
                    @elseif (request()->has('exportClientAcPDF'))
                        <h2 class="name">Rapport des Clients acceptés </h2>
                        @if (request()->has('exportClientRej'))
                            <h2 class="name">Rapport des Clients Rejetés </h2>
                            @if
                            <h2 class="name"> Rapport des Clients inscrits</h2>
                        @endif


            </div>
            <br>
            <div class="to" style="text-transform: uppercase;">Exec par: {{ $user->firstname }}
                {{ $user->lastname }}
            </div>
