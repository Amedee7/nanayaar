    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class=" container-xxl">
                <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-6" style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url('http://127.0.0.1:8000/assets/media/illustrations/sketchy-1/4.png')">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="text-muted fw-bolder">
                                    <a href="{{route('customers.index')}}">Retour à la liste</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-column flex-xl-row">
                            ...
                            <div class="card-body pt-15">
                                    ...
                                    <div class="d-flex flex-wrap flex-center">
                                        <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                            <div class="fs-4 fw-bolder text-gray-700">
                                                <span class="w-50px">Date de création: {{$customer->created_at}}</span>
                                            </div>
                                            <div class="fw-bold text-muted">Par: {{$customer->full_name}}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-stack fs-4 py-3">
                                    <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_customer_view_details" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">Détails
                                    ...
                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="" data-bs-original-title="Modifier les informations du client">
                                        <a onclick="editRecord('{{route('customers.edit', $customer->id)}}')" class="btn btn-sm btn-light-primary">Modifier</a>
                                    </span>
                                </div>
                                ...
                                <div id="kt_customer_view_details" class="collapse show">
                                    <div class="py-5 fs-6">
                                        ...
                                        <div class="text-gray-600"><span class="badge badge-light-{{$customer->status=='Actif'?'success':'danger'}}">{{$customer->status}}</span></div>

                                        <div class="fw-bolder mt-5">ID du client</div>
                                        <div class="text-gray-600">{{$customer->identifier}}</div>

                                        <div class="fw-bolder mt-5">Adresse email</div>
                                        ...
                                        <div class="text-gray-600">{{$customer->adress}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                            <!--begin:::Tab item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_customer_view_overview_tab">Aperçu</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_customer_view_overview_statements">Autres</a>
                            </li>

                            <li class="nav-item ms-auto">
                                <a href="#" class="btn btn-primary btn-sm ps-7" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">Actions
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true" style="">
                                    <div class="menu-item px-5">
                                        <a onclick="showRecord('{{route('customers.consignation', $customer->id)}}')" class="menu-link px-5">Consignations</a>
                                    </div>
                                    <div class="menu-item px-5">
                                        <a onclick="requestAccountStatusRefresh('{{route('customers.status', $customer->id)}}')" title="Changer de statut" class="menu-link px-5">{{$customer->status=='Actif'?'Désactiver':'Activer'}}</a>
                                    </div>
                                    <div class="menu-item px-5">
                                            ...
                                            <div class="d-flex h-70 align-items-center">
                                                <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                    <div class=" text-center">
                                                        ...
                                                        <div class="text-center">
                                                            <span class="fs-2x fw-bolder text-danger" >{{number_format($customer->amount_credit,0, '.',' ')}}</span>
                                            ...
                                            <div class="d-flex h-70 align-items-center">
                                                <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                    <div class=" text-center">
                                                        ...
                                                        <div class="text-center">
                                                            <span class="fs-2x fw-bolder text-warning">{{$objects_trans}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card pt-4 mb-6 mb-xl-9">
                                    <div class="card-header border-0">
                                        ...
                                        <div class="card-toolbar">
                                            <a href="{{route('stocks.outer.index')}}" class="btn btn-sm btn-flex btn-light-primary">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                ...
                                                <table class="table align-middle table-row-dashed gy-5 dataTable no-footer" id="evote-datatable">
                                                    ...
                                                    <tbody class="fs-6 fw-bold text-gray-600">
                                                        @foreach($outstock as $item)
                                                            <tr class="odd">
                                                                <td>
                                                                    <span class="badge badge-light-success">{{$item->identifier}}</span>
