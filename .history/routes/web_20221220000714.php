...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/configuration', [ConfiguraController::class, 'index'])->name('configuration.index')->middleware('permission:paramètres-voir');
    Route::patch('/configuration/{id}/update', [ConfiguraController::class, 'update'])->name('configuration.update')->middleware('permission:paramètres-voir');
});
