            ...
            <div class="card card-custom">
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="card-toolbar">
                            <a href="{{route('customers.state.report')}}" class="nav-link btn btn-sm btn-color-muted btn-active btn-active-dark active fw-bolder px-4 me-1">Générer un rapport</a>
                        </div>
                            <!--begin::Dropdown-->
