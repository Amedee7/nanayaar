                            ...
                            <div class="d-flex justify-content-end">
                                <div class="mw-300px">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-success label-inline">{{number_format($versement->montant_octroye,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">SOMME PAYEE:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-warning label-inline">{{number_format($versement->somme_verse,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">RESTE A PAYER:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-danger label-inline">{{number_format($versement->reste_apaye,0, '.',' ')}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
