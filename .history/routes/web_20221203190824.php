...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::post('/versements/sortie-stock/store', [App\Http\Controllers\StockController::class, 'outStockStore'])->name('stocks.out.store')->middleware('permission:commande-modifier');
