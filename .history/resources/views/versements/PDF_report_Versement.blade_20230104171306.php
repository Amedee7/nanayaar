    ...
    <table class="table">
        ...
        @foreach ($PDFReportVersement as $PDFReportVersements)
            <tr>
                ...
                <td>Dt D'OCTROI: {{ $PDFReportVersements['end'] }} <br> Dt Rbsmt:{{ $PDFReportVersements['limit'] | date('d/m/Y H:i:s', strtotime(Carbon\Carbon::now()->locale('fr_FR'))) }}</td>
