{{-- @if (request()->has('trashed'))
    <a href="{{ route('clients.restore', $clients->id) }}" class="btn btn-success"><span
        class="flaticon-restore"></span></a>
@else
    <a href="{{ route('clients.details', $clients->uuid) }}" title="Détails" class="btn btn-primary btn-sm"><span
...
<div class="d-flex justify-content-end flex-shrink-0">
    <a href="{{ route('clients.edit', $clients->id) }}" title="Modifier"
    ...
    <a href="{{ route('clients.details', $clients->uuid) }}" title="Détails"
        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
    ...
    <a onclick="deleteRecordConfirm('{{ route('clients.destroy', $clients->id) }}')" title="Supprimer"
        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
        <span class="svg-icon svg-icon-muted svg-icon-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
    ...
    @if (request()->has('trashed'))
        <a href="{{ route('clients.restore', $clients->id) }}" title="Restoré"
            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
            <span class="svg-icon svg-icon-3">
...
<br>
    ...
    <div class="btn-group " role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item btn" onclick="accepteRecordConfirm('{{route('clients.accepte',$clients->id)}}')" title="Accepté"><span class="flaticon-edit-1 mr-2"></span> Modifier</a>
            <a class="dropdown-item btn" onclick="rejeteRecordConfirm('{{route('clients.rejete',$clients->id)}}')" title="Rejeté" ><span class="flaticon-edit-1 mr-2"></span> Modifier</a>
            <a class="dropdown-item btn" onclick="attenteRecordConfirm('{{route('clients.rejete',$clients->id)}}')" title="En attende"><span class="flaticon-edit-1 mr-2"></span> Modifier</a>
            
        </div>
    </div>

    <a onclick="accepteRecordConfirm('{{route('clients.accepte',$clients->id)}}')" title="Accepté" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
        <span class="svg-icon svg-icon-muted svg-icon-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <a onclick="rejeteRecordConfirm('{{route('clients.rejete',$clients->id)}}')" title="Rejeté" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
            <span class="svg-icon svg-icon-muted svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <a onclick="attenteRecordConfirm('{{route('clients.rejete',$clients->id)}}')" title="En attende" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
            <span class="svg-icon svg-icon-muted svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="black"/>
                    <path opacity="0.5" d="M5 5C5 4.44772 5.44772 4 6 4H18C18.5523 4 19 4.44772 19 5V5C19 5.55228 18.5523 6 18 6H6C5.44772 6 5 5.55228 5 5V5Z" fill="black"/>
