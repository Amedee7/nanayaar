    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">@csrf<input
                            type="file" name="file" class="form-control"><br><button class="btn btn-success">
                            Import User Data
                        </button><a class="btn btn-warning" href="{{ route('export') }}">
                            Export User Data
                        </a>
                    </form>
                </div>
        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'created_at',
                    render: function render(data, type, full, meta) {
                        return '<span class="text-muted font-weight-bolder label-inline text-muted d-block fs-9">Date: ' +
                            full
                            .created_at + '</span>';
