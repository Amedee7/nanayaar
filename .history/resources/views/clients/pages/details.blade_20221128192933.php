                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <ul class="navi navi-hover py-5">
                                            <li class="navi-item">
                                                <a onclick="requestAccountStatusRefresh('{{route('clients.status', $client->id)}}')" title="Changer de statut" class="menu-link px-5">{{$client->status=='Attente'?'Désactiver':'Activer'}}
