...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-modifier')->name('versements.modify');
     ...
     //View Page
     Route::get('versements/ReportVersement', [ClientController::class, 'viewReportVersement'])->name('versements.ReportVersement');
     Route::post('versements/ReportVersement', [ClientController::class, 'viewReportVersement'])->name('versements.ReportVersement');
