...
class VersementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ->withProperties([
            'Montant de versement' => $versement->comment,
            'Numeron du client'  => $versement->empty_bottles_type_24,
            'Caisse vide 12'    => $versement->empty_bottles_type_14,
            'ID Fournisseur'  => $versement->supplier_id,
