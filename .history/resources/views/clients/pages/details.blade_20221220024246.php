                            ...
                            <div class="">
                                <a href="#">
                                    @if ($client->status == 'Rejeté')
                                        <span
                                            class="label label-primary label-shadow-hover label-inline font-weight-bolder w-100 py-3">Rejeté</span>
                                    @endif
                                    @if ($client->status === 'Accepté')
                                        <span
                                            class="label label-primary label-shadow-hover label-inline font-weight-bolder w-100 py-3">Accepté</span>
                                    @else
                                        <span
                                            class="label label-primary label-shadow-hover label-inline font-weight-bolder w-100 py-3">En attente</span>
                                    @endif
                                </a>
                            </div>
