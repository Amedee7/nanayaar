                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6"
                                            ...
                                            <div class="menu-item px-5">
                                                <a onclick="requestAccountStatusRefresh('{{ route('clients.status', $client->id) }}')"
                                                    title="Changer de statut"
                                                    class="menu-link px-5">{{ @if ($client->statut == "Accepté")
                                                    Accepté
                                                    @elseif ($client->statut == "Attente")
                                                    Attente
                                                    @else
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div
                                                ...
                                                <div class=" text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <span
                                                            class="fs-2x font-weight-bold font-size-h2 text-danger">{{ number_format($client->montant_demande, 0, '.', ' ') }}</span>
