@extends('layouts.app')
@section('title', 'Administration - Liste des permissions')
@section('content')
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Liste des permissions</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom">
                ...
                @permission('permission-creer')
                    ...
                    <div class="card-title">
                        <button onclick="createRecord('{{route('permissions.create')}}')" class="btn px-4 btn-dark mb-1">
...
@section('js')
    ...
    <script>
        $('#o2d-datatable').DataTable({
            ...
            ajax: '{!! route('permissions.datatables') !!}',
            columns: [
                {data: 'name', name: 'name'},
