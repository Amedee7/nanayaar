...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/{id}/load/clients', [StudentController::class, 'loadClients'])->name('clients.load.clients');
    Route::get('/students/{student:uuid}/details', [StudentController::class, 'detailStudent'])->name('students.details');
