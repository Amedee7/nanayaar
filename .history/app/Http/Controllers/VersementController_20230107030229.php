    ...
    public function datatables()
    {
        $versements = DB::table('versements')
            ...
            ->select(
                ...
                DB::raw('reste_apaye * 1/100 * DATEDIFF(now(), fin) as number_format(penality, 2, ',', ' ')'),
                DB::raw('reste_apaye > 0 as versements_ayant_reste_payer'),
                DB::raw('fin < now() as versements_date_limite_paiement_depassee'),
