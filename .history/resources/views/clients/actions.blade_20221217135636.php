...
>div class="d-flex justify-content-end flex-shrink-0">
        <a onclick="showRecord('{{route('versements.show', $versements->id)}}')" title="Détails" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
        ...
        <a onclick="showRecord('{{route('versements.rule', $versements->id)}}')" title="Regler la somme" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
        ...
        <a href="{{route('versements.modify', $versements->id)}}" title="Modifier" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
            <span class="svg-icon svg-icon-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        @if($versements->state == "En cours")
        <a onclick="cancelRecordConfirm('{{route('versements.cancel',$versements->id)}}')" title="Annuler" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
            <span class="svg-icon svg-icon-muted svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
