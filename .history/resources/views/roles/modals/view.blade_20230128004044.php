                        ...
                        <div class="card card-custom" style="border: solid; border-color: black">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-3">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled class="input-xlg bgc-blue" id="input1" type="checkbox" {{ ($role->hasPermission('client-status status') ? 'checked' : '') }} name="permissions[]" value="client-status statut" >
                                            <span></span>
