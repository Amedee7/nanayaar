                                                    ...
                                                    <table class="table align-middle table-row-dashed fs-6 fw-bold gy-4 dataTable no-footer table-responsive" id="kt_subscription_products_table">
                                                        ...
                                                        <tbody class="text-gray-600">
                                                            @foreach($versements as $item)
                                                                <tr class="even">
                                                                    <td><a class="text-muted fw-bolder text-hover-primary mb-1 fs-6">{{$item->identifier}}</a></td>
                                                        ...
                                                        <tfoot>
                                                            <tr><th colspan="5" class="text-end"><span class="fs-sm-3 fw-bolder">{{count($nombre_versement)}} Versement(s)</span></th></tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
                                            </div>
