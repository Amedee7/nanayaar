...
class PretController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $pret->date_naiss     = $request->date_naiss;
        $pret->montant_demande      = $request->montant_demande;
        $pret->date_naiss      = $request->date_naissance;
        $pret->genre          = $request->genre;
        // $pret->status         = $request->status;
        // $pret->photo = $request->photo;
