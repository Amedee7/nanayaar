                                            ...
                                            <div class="card-body p-6">
                                                <div class="d-flex flex-column align-items-start justify-content-between flex-xxl-row">
                                                    <div class="d-flex align-items-center flex-equal fw-row me-4 order-2">
                                                        <div class="fs-6 fw-bolder text-gray-700 text-nowrap">Date de création: {{\Illuminate\Support\Carbon::parse($versement->created_at)->toFormattedDateString('d/m/Y à H:i:s') }}</div>
                                                    </div>
