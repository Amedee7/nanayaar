                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6"
                                             ...
                                             --}}
                                                <form action="{{ route('kamar_theresia.destroy', $tere->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="menu-item px-5">
                                                        <a href="{{ route('clients.destroy', $client->id) }}"
                                                            title="Suprimer" class="btn btn-primary btn-sm">Supprimer</a>
                                                    </div>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label font-weight-bolder text-dark">Liste des versements
                                        effectués</span>
                                </h3>
