                                ...
                                <div class="font-weight-bold text-inverse-primary font-size-sm">
                                    <div class="symbol symbol-circle me-5">
                                        <div class="symbol-label bg-transparent border border-secondary border-dashed">
                                            <span
                                                class="font-weight-bold text-inverse-primary font-size-h2"></span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="font-weight-bold text-inverse-success font-size-sm">
                                    <div class="symbol symbol-circle me-5">
                                        <div class="symbol-label bg-transparent border border-secondary border-dashed">
                                            <span
                                                class="font-weight-bold text-inverse-success font-size-h2"></span>
                                            <span class="pulse-ring"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="font-weight-bold text-inverse-danger font-size-sm">
                                    <div class="symbol symbol-circle me-5">
                                        <div class="symbol-label bg-transparent border border-secondary border-dashed">
                                            <span
                                                class="font-weight-bold text-inverse-danger font-size-h2"></span>
                                            <span class="pulse-ring"></span>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="card card-xl-stretch mb-5 mt-3 mb-xl-8">
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    <a onclick="createRecord('{{route('versements.create')}}')" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder">Effectuer une versement</a>
                </div>
            </div>
    ...
    {data: 'name', name: 'name',
        render: function render(data, type, full, meta) {
            ...
            output = '<div class="d-flex align-items-center">'+
                ...
                '<span class="badge badge-light-primary fs-8 m-1">'+full.first_phone+'</span>'+
                '</div>'+
                '</span>'+
                '</div>'+
                '</div>';
