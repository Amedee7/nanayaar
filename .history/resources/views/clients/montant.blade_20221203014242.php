    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 1100px" role="document">
        <div class="modal-content border-0 shadow radius-1">
            <div class="modal-header">
                <h5 class="modal-title text-primary-d2" id="exampleModal2Label">Modifier le montant</h5>
            ...
            <div class="modal-body modal-scroll">
                <form action="{{route('clients.montant.update', $ecole->id)}}" method="POST" id="o2d-edit-record-form">
                    @method('PATCH')
                    @csrf
                    
                    <div class="form-group">
                        <label for="">Montant*</label>
                        <input type="text" name="new_montant" class="form-control" value="{{$client->montant_demande}}" id="id-form-field-1">
