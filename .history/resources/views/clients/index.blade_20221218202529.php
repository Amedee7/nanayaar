            ...
            columns: [{
                ...
                render: function render(data, type, full, meta) {
                        ...
                        output = '<div class="d-flex align-items-center">' +
                            ...
                            '<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 fs-6">' + full.name+
                            '</a>' +
                            '<a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 fs-6">' + full.lastname+
                            '</a>' +
                            ...
                            '</span>' +
                            '<div class="min-w-125px pe-2">Da: ' +
                            '<span class="label label-light-primary label-inline fs-8 m-1">' + full.created_at +
                            '</span>' +
                            '</div>' +
                            '</span>' +
                            '</div>' +
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class=" label label-light-success label-inline fw-bolder fs-6">' + data
                ...
                ,
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        status = status + ' ' + '<span class="label font-size-3 m-1 ' + label + ' label-inline">' + value +
                            '</span>';
                ...
                },
                {
                    ...
                    name: 'created_at',
                    render: function render(data, type, full, meta) {
                        return '<span class="text-muted font-weight-bolder label-inline text-muted d-block fs-9">Date: ' + full
                            .created_at + '</span>';
