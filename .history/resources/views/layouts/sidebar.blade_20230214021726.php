            ...
            <ul class="menu-nav ">
                ...
                @permission('client-lire')
                    <li class="menu-item {{ Request::routeIs('clients.index') ? ' menu-item-open' : '' }}
                        ...
                        {{ Request::routeIs('clients.pages.details') ? ' menu-item-open' : '' }} menu-item-submenu"
                        aria-haspopup="true" data-menu-toggle="hover">
                ...
                @endpermission
                {{-- @permission('profile-lire')
                    <li class="menu-item {{ Request::routeIs('statistics.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true"><a href="{{ route('statistics.index', now()->year) }}" class="menu-link ">
                            <span class="svg-icon menu-icon">
                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\User.svg--><svg
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
