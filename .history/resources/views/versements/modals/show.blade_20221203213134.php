    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 650px;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Détails de la versement
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="mw-300px">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-success">{{number_format($versement->amount_total,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">SOMME PAYEE:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-warning">{{number_format($versement->amount_payed,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">RESTE A PAYER:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-danger">{{number_format($versement->amount_rule,0, '.',' ')}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
