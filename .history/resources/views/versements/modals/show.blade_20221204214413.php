                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                ...
                                <div class="d-flex flex-column align-items-md-end px-0">
                                    ...
                                    <span class=" d-flex flex-column align-items-md-end opacity-70">
                                        Etat: <span
                                            class="label label-light-{{ $versement->state == 'En cours' ? 'warning' : 'success' }} label-inline">{{ $versement->state }}</span>
                                    </span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <div class="d-flex flex-column align-items-md-end px-0">
                                   Enrollé par le Com : <span class="label label-light-info label-inline">{{$versement->full_name_user}}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span class=" label label-light-primary label-inline opacity-70font-weight-bolder" >{{ $versement->full_name_client }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">DATE D'OCTROI</span>
                                    <span
                                        class="opacity-70">{{ \Illuminate\Support\Carbon::make($versement->created_at)->format('d/m/Y à H:i:s') }}</span>
                                </div>
