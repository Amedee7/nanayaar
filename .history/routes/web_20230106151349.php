...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('statistiques/{year}'name('statistics')->, 'StatisticsController');
    Route::get('/statistiques/{year}', [StatisticsController::class, 'index'])->name('statistics.index')->middleware('permission:log-consulter');
