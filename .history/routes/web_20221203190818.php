...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::delete('/    Route::post('/stocks/sortie-stock/store', [App\Http\Controllers\StockController::class, 'outStockStore'])->name('stocks.out.store')->middleware('permission:commande-modifier');
    /{id}/destroy', [VersementController::class, 'destroy'])->middleware('permission:versement-supprimer')->name('versements.destroy');
    Route::post('/stocks/sortie-stock/store', [App\Http\Controllers\StockController::class, 'outStockStore'])->name('stocks.out.store')->middleware('permission:commande-modifier');
