...
class ClientController extends Controller
{
    ...
    {
        $clientEncours = DB::table('clients')->where('sat', 'En cours')->where('clients.deleted_at', null)->count();
        $clientTermine = DB::table('clients')->where('sat', 'Terminé')->where('clients.deleted_at', null)->count();
        $clientAnnule = DB::table('clients')->where('sat', 'Annulé')->where('clients.deleted_at', null)->count();
