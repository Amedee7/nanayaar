                ...
                <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                    ...
                    <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                        <div class="d-flex align-items-center">
                            <span class="fs-7 text-gray-700 fw-bolder pe-3 d-none d-xxl-block">{{Auth::user()->laname}} {{Auth::user()->firstname}}</span>
                            <div class="d-flex">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="collapse show">
                                <form action="{{route('configuration.update', $config->id)}}" method="post" id="o2d-edit-form">
                                    @csrf
                                    @method('PATCH')
