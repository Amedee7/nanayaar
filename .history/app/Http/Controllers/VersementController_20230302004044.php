...
class VersementController extends Controller
{
    ...
    public function ClientEnRetard(Request $request)
    {
        ...
        $versements = Versement::::with('user', 'client')whereRaw('fin', '<', $today)->where('status', '=!', 'Remboursé')->get();

        // $versements = Client->latest();
        $user = Auth::user();
    ...
    public function modifyVersement($id)
    {
        ...
        // dd($versement);
        return view('versements.pages.versement', 
        [
            'user' => $user,
            'versement' => $versement, 
            'id' => $id, 
    ...
    public function viewReportVersement(Request $req)
    {
        ...
        if ($req->isMethod('post')) {
            ...
            return view('versements.importVersement', 
            [
                'ViewsPage' => $ViewsPage,
                'user' => $user,
                'configs'=>$configs
