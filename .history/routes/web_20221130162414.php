...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::delete('posts/{id}', [ClientController::class, 'destroy'])->name('posts.destroy');
    Route::get('posts/restore/{id}', [ClientController::class, 'restore'])->name('posts.restore');
    Route::get('posts/restore-all', [ClientController::class, 'restoreAll'])->name('posts.restoreAll');
