        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
...

                    {
                        data: 'penalite',
                        name: 'penalite',
                        render: function render(data, type, full, meta) {joursApresDateLimite
                            if (full.versements_ayant_reste_payer && full
                                ...
                                return '<span class=" label label-light-success label-inline fs-6">' +
                                    data +
                                    '</span>'+
                                    '<span class="label label-light-primary label-inline fs-8 m-1"> Nbres jrs' +
                                full
                                .joursApresDateLimite + '</span>';
                            }
