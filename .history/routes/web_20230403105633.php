...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::post('/user/profile/pwd/reset', [UserController::class, 'passwordReset'])->middleware('permission:profile-modifier')->name('pwd.reset');
    ...
    Route::get('/clients/client-supprimer', [ClientController::class, 'clientSupprimer'])->middleware('permission:client-supprimer')->name('clients.client-supprimer');
    ...
    //View Page
    Route::get('clients/ViewPages', [ClientController::class, 'viewReport'])->name('clients.ViewPages');
    Route::post('clients/ViewPages', [ClientController::class, 'viewReport'])->name('clients.ViewPages');
    Route::get('clients/records', [ClientController::class, 'records'])->name('clients.records');
    Route::get('clients/recordStatus', [ClientController::class, 'recordStatus'])->name('clients.recordstatus');
    Route::get('status', [ClientController::class, 'getStatus'])->name('status');
    Route::get('statusVersement', [ClientController::class, 'getStatusVersement'])->name('statusVersement');
    ...
    Route::post('/versements/storeRenews', [VersementController::class, 'renewsStore'])->middleware('permission:versement-creer')->name('versements.storeRenews');
    ...
    Route::get('/versements/{id}/rule', [VersementController::class, 'versementAmountRule'])->middleware('permission:versement-modifier')->middleware('permission:versement-modifier')->name('versements.rule');
    Route::patch('/versements/{id}/rule/store', [VersementController::class, 'versementAmountRuleStore'])->middleware('permission:versement-modifier')->name('versements.rule.store');
    ...
    Route::get('/versements/clients-retard', [VersementController::class, 'ClientEnRetard'])->middleware('permission:versement-lire')->name('versements.clients-retard');
    Route::get('/versements/historique-versements', [VersementController::class, 'historiqueClientRembourse'])->middleware('permission:versement-lire')->name('versements.historique-versements');
    Route::get('/versements/clients-renouvele', [VersementController::class, 'clientRenouvele'])->middleware('permission:versement-lire')->name('versements.clients-renouvele');
    Route::get('/user/profile/mes-clients', [VersementController::class, 'mesClient'])->middleware('permission:versement-lire')->name('profile.mes-clients');
    ...
    //LOGS ROUTES
    Route::get('/logs/datatable', [LogController::class, 'datatables'])->name('logs.datatables')->middleware('permission:log-consulter');
    ...
    Route::get('/configs', [ConfigurationController::class, 'index'])->name('configs.index')->middleware('permission:configuration-regler');
    Route::patch('/configs/{id}/update', [ConfigurationController::class, 'update'])->name('configs.update')->middleware('permission:configuration-modifier');

    //STATICS ROUTES
    Route::get('/statistiques/{year}', [StatisticsController::class, 'index'])->name('statistics.index')->middleware('permission:profile-lire');
});
