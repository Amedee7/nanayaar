                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="pt-8 pb-6">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <span class="text-muted">{{ date_format(new \DateTime($client->date_naiss), 'd-m-Y à H:i') }}</span>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <span class="text-muted">{{ date_format(new \DateTime($client->date_delivery), 'd-m-Y à H:i') }}</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-2">DATE D'EXPIRATION:</span>
                                    <span class="text-muted">{{ date_format(new \DateTime($client->date_expired), 'd-m-Y à H:i') }}</span>
                                </div>
                            </div>
                            <!--end::Contact-->
