...
<div class="card position-relative overflow-hidden mb-8">
	<div class="position-absolute bottom-0 left-0 right-0 d-none d-lg-flex flex-row-fluid">
		<span class="svg-icon svg-icon-full flex-row-fluid svg-icon-dark opacity-3"><!--begin::Svg Icon | path:assets/media/bg/home-2-bg.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 1200 172" style="enable-background:new 0 0 1200 172;" xml:space="preserve">
...
<path class="st0" d="M0,87c0,0,16-14,73-14s153,92,248,92S607,20,777,20s183,34,292,34s131-54,131-54v172H0V87z"/>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M11,16 C13.7614237,16 16,13.7614237 16,11 C16,8.23857625 13.7614237,6 11,6 C8.23857625,6 6,8.23857625 6,11 C6,13.7614237 8.23857625,16 11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18 11,18 Z" fill="#000000" fill-rule="nonzero"/>
						...
						<!--begin::Input-->
						<input type="text" class="form-control h-auto border-0 font-size-lg py-7 px-1" placeholder="Search FAQ 2" />
						<!--end::Input-->
					</div>
				</form>
				<!--end::Form-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">What platforms are compatible?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">How many people can it support?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">How long is the warranty?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">How do I create new members?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">What happens when I delete an admin?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">Are there any analytics for users?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">How do I customize a report?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">Is the data real-time?</div>
								</div>
							</div>
							<!--end::Header-->
...
</svg><!--end::Svg Icon--></span>									<div class="card-label text-dark pl-4">Can the report export to CSV?</div>
								</div>
							</div>
							<!--end::Header-->
