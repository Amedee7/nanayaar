...
@section('content')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Effectuez un versement</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bolder my-1 mr-5">
                    ...
                    Création d'un nouveau client. <a href="{{ route('clients/versements.create') }}"><span
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
            <form action="{{ route('clients.versements.store') }}" method="POST" id="orange-create-record-form">
