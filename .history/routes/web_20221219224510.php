...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::post('clients/export-clients', [ClientController::class, 'index'])->middleware('permission:client-status')->name('clients.export');
    Route::get('clients/export-clients', [ClientController::class, 'exportClients'])->middleware('permission:client-status')->name('clients.export-clients');
    Route::get('clients/export-clientspdf', [ClientController::class, 'exportClientsPdf'])->middleware('permission:client-status')->name('clients.export-clientspdf');
