...
class Confirm extends ModalComponent
{
    ...
    {
        $result = Client::whereRaw('client_id = ' . $this->calendarId . " and  (('" . $this->dateStart . "' >= start and '"
            . $this->dateStart  . "' < end) or ('" . $this->dateEnd . "' > start and '" . $this->dateEnd  . "' <= end) or (start >= '"
            . $this->dateStart . "' and start < '" . $this->dateEnd . "'))")->count();
