                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="ml-0">
                                                <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                                    ...
                                                    <a class="text-muted font-weight-bolder primary-color"><em class="font-size-h6 opacity-50">Fcfa</em></a>
                                                </div>
                                            </div>
                                        </div>
                                    </span>
                                    ...
                                    <span style="width: 250px;">
                                        <div class="d-flex align-items-center">
                                            <div class="ml-0">
                                                <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">
                                                    <span
                                                        class="font-weight-boldest text-success">{{ number_format($item->somme_) }}
                                                    </span>
                                                    <a class="text-muted font-weight-bolder primary-color"><em class="font-size-h6 opacity-50">Fcfa</em></a>
                                                </div>
                                            </div>
