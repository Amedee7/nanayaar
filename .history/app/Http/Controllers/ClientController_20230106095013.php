...
class ClientController extends Controller
{
    ...
    public function datatables(Request $request)
    {
        ...
        $clients = DB::table('clients')
            ...
            ->join('versements', 'versements.id', '=', 'versements.client_id')
            ->select(
                'id',
                'name',
                'lastname',
        ...
        return datatables()->of($clients, $versements)
            ->addColumn('action', function ($clients, $versements) {
                return view('clients.actions', ['clients' => $clients, 'versements' => $versements]);
            })->toJson();
    }
