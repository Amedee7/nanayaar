            ...
            <ul class="menu-nav ">
                ...
                {{ Request::routeIs('users.index') ? ' menu-item-open' : '' }}
                    ...
                    aria-haspopup="true" data-menu-toggle="hover"><a href="javascript:;"
                        ...
                        <span class="svg-icon svg-icon-primary svg-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Settings-1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
