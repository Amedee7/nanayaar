...
class ClientController extends Controller
{
    ...
    public function datatables()
    {
        ...
        return datatables()->of($clients)
            ->addColumn('action', function ($clients) {
                return view('versements.create', ['clients' => $clients]);
            })->toJson();
    }
    ...
    public function index()
    {
        ...
        return view('versements.create', compact('users', 'clients'));
    }

    public function create()
    {
        return view('versements.create', ['lastMat' => CLientService::generateNumbclient()]);
    }
