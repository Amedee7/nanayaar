...
class VersementController extends Controller
{
    ...
    {
        $ver = Stock::join('products', 'products.id', '=', 'ver.product_id')
            ->join('categories', 'categories.id', '=', 'products.category_id')
            ->where('products.deleted_at', null)
            ->select('products.id', 'products.volume', 'products.bottles', 'categories.name as category_name',
                'products.name', 'products.price', 'objects' );
        return datatables()->of($ver)
            ->addColumn('actions', function ($ver){
                return view('ver.actions', ['ver'=>$ver]);
            })->toJson();
    }
