...
use App\Services\NumbClientService;
...
class ClientController extends Controller
{
    ...
    {
        $users = User::all();
        // $users = User::select('firstname','lastname', 'id')->oldest('firstname')->get();

        return view('clients.create', ['lastClient' => NumbClientService::generateNumbClient()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $client = new Client();
        $client->numb_cli       = NumbClientService::generateNumbClient();
