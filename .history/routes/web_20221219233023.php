...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::delete('/users/{user}/destroy', [UserController::class, 'destroy'])->middleware('permission:user-supprimer')->name('users.destroy');
    ...
    //LOGS ROUTES
    Route::get('/admin/logs/datatable', [App\Http\Controllers\LogController::class, 'datatables'])->name('logs.datatable')->middleware('permission:log-consulter');
    Route::get('/admin/logs/', [App\Http\Controllers\LogController::class, 'index'])->name('logs.index')->middleware('permission:log-consulter');
    Route::get('/admin/logs/show/{id}/', [App\Http\Controllers\LogController::class, 'show'])->name('logs.show')->middleware('permission:log-consulter');

    //CONFIGURATIONS ROUTES
    Route::get('/admin/configuration', [App\Http\Controllers\ConfigurationController::class, 'index'])->name('configuration.index')->middleware('permission:paramètres-voir');
    Route::patch('/admin/configuration/{id}/update', [App\Http\Controllers\ConfigurationController::class, 'update'])->name('configuration.update')->middleware('permission:paramètres-voir');
});
