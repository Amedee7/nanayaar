                ...
                var _demo = function() {
                    var datatable = $('#kt_datatable').KTDatatable({
                        ...
                        data: {
                            ...
                            source: {
                                read: {
                                    url: HOST_URL + '{!! route('clients.index') !!}',
                                },
                            },
                        ...
                        columns: [{
                            ...
                            template: function(data) {
                                return '<span class="font-weight-bolder">' + data.RecordID +
                                    '</span>';
                            }
                        }, {
                            field: 'OrderID',
                            ...
                            template: function(data) {
                                ...
                                if (number > 8) {
                                    output = '<div class="d-flex align-items-center">\
                								...
                								<div class="ml-4">\
                									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + data.la + '</div>\
                									<a href="#" class="text-muted font-weight-bold text-hover-primary">' + data.name + '</a>\
                								</div>\
                							</div>';
                                } else {
                                    ...
                                    output = '<div class="d-flex align-items-center">\
                								<div class="symbol symbol-40 symbol-light-' + state + ' flex-shrink-0">\
                									<span class="symbol-label font-size-h4 font-weight-bold">' + data.lastname.substring(0, 1) + '</span>\
                								</div>\
                								<div class="ml-4">\
                									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + data.lastname + '</div>\
                									<a href="#" class="text-muted font-weight-bold text-hover-primary">' + data.name + '</a>\
                								</div>\
                							</div>';
                                }
                            ...
                            template: function(row) {
                                ...
                                output += '<div class="font-weight-bolder font-size-lg mb-0">' + row
                                    .name + '</div>';
                                output += '<div class="font-weight-bold text-muted">Code: ' + row
                                    .lastname + '</div>';
                            ...
                            template: function(row) {
                                ...
                                output += '<div class="font-weight-bold text-muted">' + row
                                    .CompanyName + '</div>';
