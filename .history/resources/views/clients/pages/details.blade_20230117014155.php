                            ...
                            <div class="">
                                <a href="#">
                                    ...
                                    @elseif ($client->status === 'Accepté')
                                        <span
                                        class="label label-light-success font-weight-bold py-3 px-6 mb-2 text-center label-block">Accepté</span>
                                    @else
                                        <span
                                            ...
                                            <table class="table align-middle table-row-dashed gy-5 dataTable no-footer"
                                                ...
                                                <tbody>
                                                    @foreach ($client->versements as $versement)
                                                        <tr>
                                                            <td>{{ $versement->id }}</td>
                                                            <td>{{ $versement->identifier }}</td>
                                                            <td>{{ $versement->status }}</td>
                                                            <td>{{ $versement->state }}</td>
                                                            <td>{{ $versement->montant_octroye }}</td>
                                                            <td>{{ $versement->commission_verse }}</td>
                                                            <td>{{ $versement->somme_verse }}</td>
                                                            <td>{{ $versement->reste_apaye }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
