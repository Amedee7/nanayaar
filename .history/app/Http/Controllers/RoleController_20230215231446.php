...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('roles.modals.create', ['permissions' => $permissions, 'modules' => $modules, 'user' => $user,]);
    }
    ...
    {
        $role = Role::find($id);        $user = Auth::user();
        $modules = ['utilisateur', 'numero', 'pointage', 'operation', 'role', 'permission', 'profile', 'client', 'pret', 'versement'];
        $permissions = Permission::all()->pluck('id', 'name')->toArray();
        return view('roles.modals.view', ['role' => $role, 'permissions' => $permissions, 'modules' => $modules,'user' => $user,]);
    }
    ...
    public function edit($id)
    {
        ...
        $modules = ['utilisateur', 'numero', 'pointage', 'operation', 'role', 'permission', 'profile', 'client', 'pret', 'versement'];
        $permissions = Permission::all()->pluck('id', 'name')->toArray();
        return view('roles.modals.update', ['role' => $role, 'permissions' => $permissions, 'modules' => $modules            'user' => $user,]);
    }
