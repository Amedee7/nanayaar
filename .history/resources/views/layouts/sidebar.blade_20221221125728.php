            ...
            <ul class="menu-nav ">
                ...
                <div class="menu-item {{ Request::routeIs('home') ? ' menu-item-active' : '' }} menu-item-submenu"
                    ...
                    <a href="{{ route('home') }}" class="menu-link menu-toggle">
                        <span class="svg-icon svg-icon-"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Home.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
