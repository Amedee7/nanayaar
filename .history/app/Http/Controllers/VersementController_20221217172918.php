...
class VersementController extends Controller
{
    ...
    //PAGE POUR TERMINER UN VERSEMENT
    public function closeOutStockPage($id)
    {
        $versement = Out_stock::find($id);
        $productsAdded = Product_out_stock::where('enter_stock_id', $versement->id);
        ...
        $customer = Customer::find($versement->customer_id);
        return view('outstock.modals.closePage', [
            'versement' => $versement,
