        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Détails du Versement
                    <span class="label label-light-success label">{{$versement->identifier}}</span> |
                    Etat: <span class="label label-light-{{$versement->state=="En cours"?"warning":"success"}} label">{{$versement->state}}</span>
                </h5>
