                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <!--begin::Desc-->
                            <p class="mb-7">
                                I distinguish three <a href="#" class="text-primary pr-1">#XRS-65PQ</a> objectives
                                First
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <!--begin::Desc-->
                            <p class="mb-7">
                                Lorem Ipsum is simply <a href="#" class="text-primary pr-1">#XRS-65PQ</a> dummy text
                                of
                                objectives and nice cooked rice
                            </p>
                            <!--end::Desc-->
                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="#"
                                        class="text-dark font-weight-bold text-hover-primary font-size-h4 mb-0">Nick
                                        Mana</a>
                                    <span class="text-muted font-weight-bold">Atr Direcrtor</span>
                                </div>
                                <!--end::Title-->
                            ...
                            <p class="mb-7">
                                Contrary to popular belief, Lorem Ipsum is not simply random text <a href="#"
                                    class="text-primary pr-1">#XRS-65PQ.</a>
                            </p>
                            <!--end::Desc-->
                            <!--begin::Info-->
                            <div class="mb-7">
