    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div id="kt_header" style="" class="header align-items-stretch">
            <div class="header-brand">
                <a href="{{route('home')}}">
                    <h3 style="color: white;" class="text-center">NANA Y</h3>
                </a>
                        ...
                        <div class="card mb-5 mb-xl-8">
                            <div class="card-body pt-15">
                                <div class="d-flex flex-center flex-column mb-5">
                                    ...
                                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">{{$client->name}}</a>
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="" data-bs-original-title="Modifier les informations du client">
                                        <a onclick="editRecord('{{route('clients.edit', $client->id)}}')" class="btn btn-sm btn-light-primary">Modifier</a>
                                    </span>
                                </div>
                                ...
                                <div id="kt_customer_view_details" class="collapse show">
                                    <div class="py-5 fs-6">
                                        ...
                                        <div class="text-gray-600"><span class="badge badge-light-{{$client->status=='Actif'?'success':'danger'}}">{{$client->status}}</span></div>

                                        <div class="fw-bolder mt-5">ID du client</div>
                                        <div class="text-gray-600">{{$client->identifier}}</div>
                            ...
                            <li class="nav-item ms-auto">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true" style="">
                                    <div class="menu-item px-5">
                                        <a onclick="showRecord('{{route('clients.consignation', $client->id)}}')" class="menu-link px-5">Consignations</a>
                                    </div>
                                    <div class="menu-item px-5">
                                        <a onclick="requestAccountStatusRefresh('{{route('clients.status', $client->id)}}')" title="Changer de statut" class="menu-link px-5">{{$client->status=='Actif'?'Désactiver':'Activer'}}</a>
                                    </div>
                                    <div class="menu-item px-5">
                                            ...
                                            <div class="d-flex h-70 align-items-center">
                                                <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                    <div class=" text-center">
                                                        ...
                                                        <div class="text-center">
                                                            <span class="fs-2x fw-bolder text-danger" >{{number_format($client->amount_credit,0, '.',' ')}}</span>
