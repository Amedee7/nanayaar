                        ...
                        <div class="card card-custom" style="border: solid; border-color: black">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-3">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled class="input-xlg bgc-blue" id="input1" type="checkbox" {{ ($role->hasPermission('clien-changer statut') ? 'checked' : '') }} name="permissions[]" value="clien-changer statut" >
                                            <span></span>
                                            Changer status clien
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input3" type="checkbox" {{ ($role->hasPermission('sous-operation-effectuer') ? 'checked' : '') }} name="permissions[]" value="sous-operation-effectuer" >
                                            <span></span>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input5" type="checkbox" {{ ($role->hasPermission('sauvegarde-creer') ? 'checked' : '') }} name="permissions[]" value="sauvegarde-creer" >
                                            <span></span>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input6" type="checkbox" {{ ($role->hasPermission('sauvegarde-lire') ? 'checked' : '') }} name="permissions[]" value="sauvegarde-lire" >
                                            <span></span>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input7" type="checkbox" {{ ($role->hasPermission('archive-lire') ? 'checked' : '') }} name="permissions[]" value="archive-lire" >
                                            <span></span>
                                            Voir les archives
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div class="checkbox-inline">
                                        <label class="checkbox checkbox-lg">
                                            <input disabled id="input8" type="checkbox" {{ ($role->hasPermission('log-lire') ? 'checked' : '') }} name="permissions[]" value="log-lire" >
                                            <span></span>
                                            Voir les logs
                                        </label>
                                    </div>
