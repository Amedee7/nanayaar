...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        $modules = ['utilisateur', 'ville', 'élève', 'numero', 'pointage', 'operation', 'role', 'permission', 'profile', 'classe'];
    ...
    {
        $role = Role::find($id);
        $modules = ['utilisateur', 'ville', 'élève', 'numero', 'pointage', 'operation', 'role', 'permission', 'profile'];
        $permissions = Permission::all()->pluck('id', 'name')->toArray();
