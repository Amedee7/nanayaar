                ...
                <td>
                    ...
                    @else
                        <form method="POST" action="{{ route('clients.destroy', $item->id) }}">
                            ...
                            <button onclick="deleteRecordConfirm('{{route('clients.destroy', $i->id)}}')" title="Supprimer"  class="btn btn-outline-danger btn-sm"><span class="flaticon2-trash"></span></button>
                        </form>
                    @endif
                </td>
            </tr>
