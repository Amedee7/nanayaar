                                        ...
                                        <div class="row">
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Montant à verser <span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" name="montant_versement"
                                                        placeholder="Entrer le montant de versement">
                                                    <span class="montant_versement_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="numero_client" id="mySelect2">
                                                        @foreach ($clients as $client)
                                                            <option value="{{ $client->id }}"
                                                                ...
                                                                {{ $client->numb_cli . ' - ' }}{{ $client->nom }}{{ ' ' . $client->prenom }}
                                                            </option>
                                                        @endforeach
                                                    </select>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    switch (type) {
                        ...
                        case 'success':
                            Swal.fire(
                                'Le Versement a été effectuer avec succès!',
                                '.',
                                'success'
                            ).then(function() {
                                window.location.href = "/administration/versements/create";
                            });
                            break;
                            // $.confirm({
                            //     icon: 'fa fa-check',
