    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 1100px" role="document">
        <div class="modal-content border-0 shadow radius-1">
            <div class="modal-header">
                <h5 class="modal-title text-primary-d2" id="exampleModal2Label">Ajouter une ville</h5>
            ...
            <div class="modal-body modal-scroll">
                <form action="{{route('cities.update', $city->id)}}" method="POST" id="o2d-edit-record-form">
                    @method('PATCH')
                    @csrf
                    <div class="form-group">
                        <label for="">NOM DE LA VILLE</label>
                        <input name="name" type="text" value="{{$city->name}}" class="form-control " id="id-form-field-1">
