...
class UserController extends Controller
{
    public function datatables()
    {
        ...
        $users = User::with('roles')->latest();$configs = Configuration::select(['id', 'entreprise_name'])->find(1);
        return datatables()->of($users, $configs)
    ...
    public function create()
    {
        ...
        return view('users.modals.create',  ['roles' => $roles, 'configs' => $configs]);
    }
    ...
    public function show($id)
    {
        ...
        if ($user) {
            $roles = Role::all();
            return view('users.modals.show', ['user' => $user, 'roles' => $roles, 'configs'=>$configs]);
        } else {
    ...
    public function edit($id)
    {
        ...
        if ($user) {
            $roles = Role::all();
            return view('users.modals.update', ['user' => $user, 'roles' => $roles, 'configs'=>$configs]);
        } else {
            return response()->json(['type' => 'error', 'message' => "Une erreur est survenue !"]);
        }
    }
    ...
    public function profile()
    {
        ...
        return view('users.profile.index', ['user' => $user, 'configs' => $configs]);
    }
