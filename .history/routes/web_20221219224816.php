...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/terminer', [VersementController::class, 'closeVersementPage'])->middleware('permission:versement-supprimer')->name('versements.termine');
    Route::patch('/versements/{id}/finish', [VersementController::class, 'closeVersementPageStore'])->middleware('permission:versement-supprimer')->name('versements.finish');
    Route::get('/versements/{id}/show', [VersementController::class, 'showVersement'])->middleware('permission:versement-supprimer')->name('versements.show');
    Route::get('/versements/{id}/cancel', [VersementController::class, 'versementCancel'])->middleware('permission:versement-supprimer')->name('versements.cancel');
    Route::get('/versements/{id}/rule', [VersementController::class, 'versementAmountRule'])->middleware('permission:versement-supprimer')->middleware('permission:versement-modifier')->name('versements.rule');
    Route::patch('/versements/{id}/rule/store', [VersementController::class, 'versementAmountRuleStore'])->middleware('permission:versement-supprimer')->name('versements.rule.store');
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-supprimer')->name('versements.modify');
});
