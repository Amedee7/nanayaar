...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Définition de la date maximale autorisée (10 ans avant la date actuelle)
        $maxDate = $currentDate->subYears(2);
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'date_delivre'          => 'required|date|before_or_equal:' . $maxDate->format('Y-m-d'),
                'date_expire'           => 'required|date|after_or_equal:' . $request->date_delivre,
                'date_delivre' => 'required|date_format:Y-m-d|before_or_equal:' . date('Y-m-d', strtotime('+10 years')),
        'date_expire' => 'required|date_format:Y-m-d|after_or_equal:date_delivre|before_or_equal:' . date('Y-m-d', strtotime('+10 years')),
                'adresse'               => 'required',
        ...
        $client->date_exprired      = $request->date_expire;
