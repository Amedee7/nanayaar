...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/{client:uuid}/details', [ClientController::class, 'updateStatus'])->name('clients.update.status');
    Route::get('/clients/status/update', 'ClientController@updateStatus')->name('clients.update.status');
