                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Delivrée le <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" value="{{ $client->date_delivered }}" class="form-control"
                                                        name="date_delivre">
                                                    <span class="date_delivre_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Expire le <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" value="{{ $client->date_expired }}" class="form-control"
                                                        name="date_expire">
                                                    <span class="date_expire_err error text-danger"></span>
                                                </div>
                                            </div>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="raison_du_pret" class="form-control"> {{ $client->raison_pret }}</textarea>
                                            <span class="raison_du_pret_err error text-danger"></span>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Activité  du client</label>
                                            <textarea name="activite_client_err" class="form-control"> {{ $client->activity_client }}</textarea>
                                            <span class="activite_client_err error text-danger"></span>
                                        </div>
                                        <div class="form-group">
