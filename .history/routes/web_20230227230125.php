...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/historique-versements', [VersementController::class, 'ClientRembourse'])->middleware('permission:versement-lire')->name('versements.clients-retard');
