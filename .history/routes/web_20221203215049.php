...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/terminer', [VersementController::class, 'closeVersementPage'])->name('stocks.termine')->middleware('permission:ver-modifier');
    Route::patch('/versements/{id}/finish', [VersementController::class, 'closeVersementPageStore'])->name('stocks.finish')->middleware('permission:ver-modifier');
    Route::get('/versements/{id}/show', [VersementController::class, 'showVersement'])->name('stocks.show')->middleware('permission:ver-lire');
    Route::get('/versements/{id}/cancel', [VersementController::class, 'VersementCancel'])->name('stocks.cancel')->middleware('permission:ver-modifier');
    Route::get('/versements/{id}/rule', [VersementController::class, 'VersementAmountRule'])->name('stocks.rule')->middleware('permission:ver-règlement');
    Route::patch('/versements/{id}/rule/store', [VersementController::class, 'VersementAmountRuleStore'])->name('stocks.rule.store')->middleware('permission:ver-règlement');
    Route::delete('/versements/{id}/delete', [VersementController::class, 'VersementDelete'])->name('stocks.delete')->middleware('permission:ver-supprimer');
