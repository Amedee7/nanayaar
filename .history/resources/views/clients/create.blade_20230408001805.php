    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
            <div class="card card-custom">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <h2 class="mb-1">Administration d'un client</h2>
                ...
                @if ($errors->has('numero_cnib'))
                    <div class="alert alert-danger">{{ $errors->first('numero_cnib') }}</div>
                @endif
                <div class="d-flex flex-column-fluid">
                    <div class="container col-md-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="raison_du_pret" class="form-control"></textarea>
                                                            <span class="raison_du_pret_err error text-danger"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <label for="exampleInputPassword1">Activitée du
                                                                client</label>
                                                            <textarea name="activite_client" class="form-control"></textarea>
