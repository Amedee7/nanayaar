...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/restore/{id}', [ClientController::class, 'restore'])->middleware('permission:client-lire')->name('clients.restore');
    Route::get('/clients/restore-all', [ClientController::class, 'restoreAll'])->middleware('permission:client-lire')->name('clients.restoreAll');
    ...
    //STATUS CHANGEMENT
    Route::get('/clients/{id}/accepte', [ClientController::class, 'statusAccepte'])->name('clients.accepte');
    Route::get('/clients/{id}/rejete', [ClientController::class, 'statusRejete'])->name('clients.rejete');
    // Route::get('/clients/{id}/attete', [ClientController::class, 'statusAttente'])->name('clients.attete');


    Route::post('clients/export-clients', [ClientController::class, 'index'])->name('clients.export');
    Route::get('clients/export-clients', [ClientController::class, 'exportClients'])->name('clients.export-clients');
    Route::get('clients/export-clientspdf', [ClientController::class, 'exportClientsPdf'])->name('clients.export-clientspdf');
    ...
    Route::get('/versements/{id}/modifier/ajouter', [VersementController::class, 'modifyVersementModifierMontant'])->name('versements.modify.add');
    Route::patch('/versements/{id}/modifier/versement', [VersementController::class, 'modifyVersementModifierMontantStore'])->name('versements.modify.versement');

    Route::get('/versements/{id}/terminer', [VersementController::class, 'closeVersementPage'])->name('versements.termine');
    Route::patch('/versements/{id}/finish', [VersementController::class, 'closeVersementPageStore'])->name('versements.finish');
    Route::get('/versements/{id}/show', [VersementController::class, 'showVersement'])->name('versements.show');
    Route::get('/versements/{id}/cancel', [VersementController::class, 'versementCancel'])->name('versements.cancel');
    Route::get('/versements/{id}/rule', [VersementController::class, 'versementAmountRule'])->middleware('permission:versement-modifier')->name('versements.rule');
    Route::patch('/versements/{id}/rule/store', [VersementController::class, 'versementAmountRuleStore'])->name('versements.rule.store');
    Route::delete('/versements/{id}/delete', [VersementController::class, 'versementDelete'])->name('versements.delete');
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->name('versements.modify');
});
