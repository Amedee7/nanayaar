...
class VersementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('versement.index', compact('users', 'clients'));
    }


    public function create()
    {
        return view('versements.create', ['lastClient' => ClientnumbService::generateNumbclient()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $eleve = new Versement();
        $eleve->numb_cli       = ClientnumbService::generateNumbclient();
