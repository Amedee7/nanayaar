...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    //View Page
    Route::get('clients/ViewPages', [ClientController::class, 'viewReport'])->name('clients.reportJour');
    Route::post('clients/ViewPages', [ClientController::class, 'viewReport'])->name('clients.reportJour');
