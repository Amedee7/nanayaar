...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/configs', [App\Http\Controllers\ConfigurationController::class, 'index'])->name('configs.index')->middleware('permission:configuration-regler');
    Route::patch('/configs/{id}/update', [App\Http\Controllers\ConfigurationController::class, 'update'])->name('configs.update')->middleware('permission:configuration-modifier');
