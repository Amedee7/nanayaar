                ...
                <div class="container my-10">
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <h3 class="mb-10 font-weight-bold text-dark">FILTRER ET EXPORTATER PAR LE STATUS OU </h3>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            class="table table-bordered table-hover table-checkable" style="margin-top: 13px !important"
                                            id="record_table">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <h3 class="mb-10 font-weight-bold text-dark">SELECTIONNER DEUX DATES POUR FILTRER ET EXPORTATER</h3>
