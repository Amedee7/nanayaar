            ...
            <div id="kt_content_container" class=" container-fluid">
                                        ...
                                        <tbody class="text-gray-600">
                                            @foreach($productAdded as $item)
                                                <tr class="even">
                                                    ...
                                                    <td class="text-end">
                                                        <a onclick="outStockProductDelete('{{route('versements.delete.versement', $item->id)}}')" class="btn btn-sm btn-flex btn-light-danger "><strong>Supprimer</strong></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="card">
                    <div class="card-footer d-flex justify-content-end py-6">
                        ...
                        <button id="senderX" onclick="outStockClose('{{route('versements.termine',$versement->id)}}')" class="btn btn-primary">
                            <strong>
