        ...
        <a href="#"
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-danger font-weight-bolder font-size-h5 mb-2 mt-5">
                    < class="card-label fw-bolder fs-3 mb-1">Clients <span class="badge badge-light-warning fw-bolder my-2">En attente de validation</span>
                </div>
                <div class="font-weight-bold text-inverse-danger font-size-sm">Lands,
        ...
        <a href="#"
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-primary font-weight-bolder font-size-h5 mb-2 mt-5">
                    Apartments</div>
                <div class="font-weight-bold text-inverse-primary font-size-sm">Flats,
                    Shared Rooms, Duplex</div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Stats Widget 14-->
