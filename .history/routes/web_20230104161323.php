...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-modifier')->name('versements.modify');
     ...
     //View Page
     Route::get('versements/ViewVersementReport', [ClientController::class, 'viewReportVersement'])->name('versements.ViewVersementReport');
     Route::post('versements/ViewVersementReport', [ClientController::class, 'viewReportVersement'])->name('versements.ViewVersementReport');
