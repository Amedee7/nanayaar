...
class ClientController extends Controller
{
    ...
    public function moderation_clients()
    {
        ...
        return view('clients.moderation_clients', compact('users', 'clients', 'trashClients'));
    }

    public function create()
    {
        return view('clients.create', ['commissionVerse' => CommissionAVerse::commission_verse(), 'lastClient' => NumberService::generateNumber(), 'users' => User::all()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $client->commission_averse           = CommissionAVerse::commission_verse();
