                        ...
                        <div class="wizard wizard-1" id="kt_contact_add" data-wizard-state="step-first"
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-7">
                                    ...
                                    <form action="{{ route('clients.ViewPages') }}" class="form" id="kt_contact_add_form" method="POST">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="input-group input-group-solid date" id="kt_datetimepicker_3" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-solid datetimepicker-input" placeholder="Select date & time" data-target="#kt_datetimepicker_3" id="form" name="form"/>
                                                ...
                                                <div class="col">
                                                    <div class="input-group input-group-solid date" id="kt_datetimepicker_4" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-solid datetimepicker-input" placeholder="Select date & time" data-target="#kt_datetimepicker_4" id="to" name="to"/>
