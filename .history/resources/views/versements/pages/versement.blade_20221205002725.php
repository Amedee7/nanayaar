                                                ...
                                                <div class="d-flex flex-column align-items-start flex-xxl-row">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row">
                                                        <div class="fs-1x fw-bolder text-gray-700 text-nowrap">
                                                            <span class="badge fs-7 m-1 badge-light-success ">Operation de versement</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <tbody class="text-gray-600">
                                                            @foreach($versements as $item)
                                                                <tr class="even">
                                                                    ...
                                                                    <td><span class=" badge badge-light-success fw-bolder fs-6">{{number_format($item->somme_verse,0, '.',' ')}} F</span></td>
                                                                    <td><span class=" badge badge-light-success fw-bolder fs-6">{{number_format($item->montant_octroye,0, '.',' ')}} F</span></td>
                                                                    <td class="text-end">
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex mb-8">
                                ...
                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                        <a href="#"
                                            class=" label label-success label-inline text-dark-75 font-weight-bolder text-hover-primary font-size-lg mb-2">
