...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'hisoriqueClientRembourse'])->middleware('permission:versement-lire')->name('versements.historique.versements');
