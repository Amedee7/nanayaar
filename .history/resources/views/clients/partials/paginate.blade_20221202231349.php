            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('clients.details', $item->uuid) }}" title="Détails"
                        class="btn btn-primary restore btn-sm"><span class="flaticon-eye"></span></a>
                        <form method="POST" action="{{ route('clients.destroy', $item->id) }}">
                            @csrf
                            <input name="_method" type="hidden" value="DELETE">
                            <button type="submit" class="btn btn-danger btn-sm delete mt-2" title='Supprimer'><span class="far fa-trash-alt"></span></button>
                        </form>
                    @endif
                </td>
            </tr>
