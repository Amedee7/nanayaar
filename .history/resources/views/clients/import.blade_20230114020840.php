                        ...
                        <div class="col-md-12 mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01">Status ver</label>
                                        </div>
...
////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        function fetch_vers() {
            $.ajax({
                url: "{{ route('status_versement') }}",
                type: "GET",
                dataType: "json",
                success: function(data) {
                    var versBody = "";
                    for (var key in data) {
                        versBody += `<option value="${data[key]['status_versement']}">${data[key]['status_versement']}</option>`;
                    }
        ...
        $(document).on("click", "#filter_status", function(e) {
            e.preventDefault();
            var std = $("#select_sts").val();
            var res = $("#select_vers").val();
            if (std !== "" && res !== "") {
        ...
        // Reset
        $(document).on("click", "#resetstat", function(e) {
            e.preventDefault();
            $("#select_sts").html(`<option value="">Choose...</option>`);
            $("#select_vers").html(`<option value="">Choose...</option>`);
            $('#record_table').DataTable().destroy();
