                                                ...
                                                <select class="form-control" name="numero_client" id="mySelect2">
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            ...
                                                            <label for="exampleInputPassword1">No Client:<span
                                                                class="text-danger">*</span></label> {{ $client->numb_cli }} {{ '--- Commission: '.$client->montant_demande * 14 /100 .' FCFA'}} {{' sur => '. $client->montant_demande .' FCFA'}}</option>
                                                    @endforeach
                                                </select>
