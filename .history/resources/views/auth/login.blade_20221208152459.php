                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        <div class="col-md-5 row">
                            <div class="card card-custom col-md-12 p-0">
                                <div style="background-color: #d79300;" class="card-header justify-content-center">
                                    <h1
                                        class="text-white font-weight-bolder mt-5 mb-2 h1 text-uppercase text-center primary-color">
                                        <u>NANA YAAR</u>
                                    </h1>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input id="password" type="password"
                                                    ...
                                                    placeholder="Mot de passe" name="password" required autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <a href="{{ route('password.request') }}"
                                                class="btn btn-link-danger font-weight-bold">Mot de passe oublié ?</a>
                                        </div>

                                        <div class="form-group mb-0">
                                            <button type="submit" class="btn btn-primary btn-block"><i
                                                    class="flaticon-logout"></i> Connexion</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="login-form">
                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" id="password" type="password"
                        class="form-control @error('password') is-invalid @enderror"
        ...
        <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
            <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="text-dark order-2 order-md-1">
                    <span class="text-muted font-weight-bolder mr-2">2022©</span>
                    <a href="#" target="_blank" class="text-dark-75 font-weight-bolder text-hover-primary">NANA
                        YAAR</a>
                </div>
                <div class="nav nav-dark order-1 order-md-2">
                    <a href="#" target="_blank" class="nav-link pr-3 pl-0 font-weight-bolder">A propos</a>
                </div>
            </div>
        </div>
    </div>
