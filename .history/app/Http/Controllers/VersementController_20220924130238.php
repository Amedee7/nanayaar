...
class VersementController extends Controller
{
    ...
    public function index()
    {
        ...
        $clie = Client::all()->pluck('id', 'firstname', 'lastname')->toArray();
        return view('versements.index', compact('clie', 'versements'));
    }
    ...
    {
        $versements = Versement::all();
        return view('versements.create', compact('versements'));
    }
