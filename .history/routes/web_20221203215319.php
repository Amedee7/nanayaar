...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [App\Http\Controllers\StockController::class, 'modifyVersement'])->name('stocks.outer.modify')->middleware('permission:commande-modifier');
