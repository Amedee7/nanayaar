...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // $totalCommissions = $versements->where('state', '=', ['En cours', 'Terminé'])->sum('commission_verse');
        ...
        $totalRenouvelement = Versement::whereIn('status_news_versement', ['Renouvelé'])->sum('montant_octroye');
        $totalcommissionRenouvelement = Versement::whereIn('status_news_versement', ['Renouvelé'])->sum('commission_verse');
        ...
        return view(
            ...
            [
                ...
                'totalRenouvelement'      => $totalRenouvelement,
                'totalcommissionRenouvelement'      => $totalcommissionRenouvelement,
