<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
    <div class="brand flex-column-auto " id="kt_brand">
        <a href="{{route('home')}}" class="brand-logo">
            <span class="text-uppercase text-white font-size-lg">Œil du dealer</span>
        </a>
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 167px; overflow: hidden;">
            <ul class="menu-nav" style="padding: 0px !important;">
                ...
                <li class="menu-item {{ Request::routeIs('homes') ? ' menu-item-active' : '' }} " aria-haspopup="true" >
                    <a  href="{{route('home')}}" class="menu-link ">
                        <span class="flaticon-user-add menu-icon icon-lg"></span>
                        <span class="menu-text font-weight-bolder">Inscriptions</span>
                    </a>
                </li>
                ...
                <li class="menu-item  menu-item-submenu
                        ...
                        {{ Request::routeIs('classes.index') ? ' menu-item-open' : '' }}
                    ...
                    <div class="menu-submenu ">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::routeIs('config.index') ? ' menu-item-active' : '' }}" aria-haspopup="true" >
                                <a  href="{{route('home')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text font-weight-bold">Configurations</span>
                                </a>
                            </li>
                            <li class="menu-item {{ Request::routeIs('cities.index') ? ' menu-item-active' : '' }}" aria-haspopup="true" >
                                <a  href="{{route('cities.index')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text font-weight-bold">Villes</span>
                                </a>
                            </li>
                            
                            <li class="menu-item {{ Request::routeIs('classes.index') ? ' menu-item-active' : '' }}" aria-haspopup="true" >
                                <a  href="{{route('classes.index')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                    <span class="menu-text font-weight-bold">Classes</span>
                                </a>
                            </li>
                            ...
                            <li class="menu-item {{ Request::routeIs('permissions.index') ? ' menu-item-active' : '' }}" aria-haspopup="true" >
