            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span style="width: 250px;">' +
                            '<div class="ml-4">' +
                            '<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + full.versement.uuid + '</div>' +
                            '<a class="text-muted font-weight-bold text-hover-primary">' + full.versement.id + '</a>' +
                            '</div>' +
                            '</div>' +
                            '</span>';
                    }
