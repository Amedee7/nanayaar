                                ...
                                <div class="mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$customer->name}}</a>
                                            <span class="text-muted fw-bold text-muted d-block fs-7">
                                                <div class="min-w-125px pe-2">Téléphone: <span class="badge badge-light-primary fs-8 m-1">{{$customer->telephone}}</span></div>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="card card-dashed flex-center  min-w-175px my-3 p-6">
                                            <span class="fs-lg-2x fw-bolder d-flex justify-content-center">{{number_format($outStock->amount_total,0, '.',' ')}} Fcfa</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
