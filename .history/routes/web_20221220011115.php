...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/configuration', [App\Http\Controllers\ConfagurationController::class, 'index'])->name('configuration.index')->middleware('permission:paramètres-voir');
    Route::patch('/configuration/{id}/update', [App\Http\Controllers\ConfagurationController::class, 'update'])->name('configuration.update')->middleware('permission:paramètres-voir');
});
