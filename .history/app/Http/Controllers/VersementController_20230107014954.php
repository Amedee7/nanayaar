...
class VersementController extends Controller
{
    public function datatables()
    {
        ...
        ->addColumn('penalite', function($versements) {
            if (Carbon::parse($versements->date1) > Carbon::parse($versements->date2)) {
                $penalite = calculPenalite($result->montant, Carbon::parse($versements->date1)->diffInDays(Carbon::parse($versements->date2)));
                return $penalite;
            } else {
                return 0;
            }
