...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/clients-renouvele', [VersementController::class, 'clientRenouvele'])->middleware('permission:versement-lire')->name('versements.client-renouvele');
