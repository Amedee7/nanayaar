...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/users/create', [UserController::class, 'create'])->middleware('permission:utilisateurs-creer')->name('users.create');
    Route::post('/users/store', [UserController::class, 'store'])->middleware('permission:utilisateurs-creer')->name('users.store');
    Route::get('/users/{user}/show', [UserController::class, 'show'])->middleware('permission:utilisateurs-lire')->name('users.show');
    Route::get('/users/{user}/edit', [UserController::class, 'edit'])->middleware('permission:utilisateurs-modifier')->name('users.edit');
    Route::patch('/users/{user}/update', [UserController::class, 'update'])->middleware('permission:utilisateurs-modifier')->name('users.update');
    Route::get('/users/{user}/status', [UserController::class, 'status'])->middleware('permission:utilisateurs-modifier')->name('users.status');
    Route::delete('/users/{user}/destroy', [UserController::class, 'destroy'])->middleware('permission:utilisateurs-supprimer')->name('users.destroy');

    Route::get('/users/profile', [UserController::class, 'profile'])->middleware('permission:utilisateurs-creer')->name('profile.index');
    Route::get('/user/profile/avatar', [UserController::class, 'avatar'])->middleware('permission:utilisateurs-creer')->name('profile.avatar');
    Route::get('/user/profile/pwd', [UserController::class, 'password'])->middleware('permission:utilisateurs-creer')->name('profile.password');
    Route::post('/user/profile/pwd/reset', [UserController::class, 'passwordReset'])->middleware('permission:utilisateurs-creer')->name('pwd.reset');
    ...
    Route::post('clients/export-clients', [ClientController::class, 'index'])->middleware('permission:client-lire')->name('clients.export');
    Route::get('clients/export-clients', [ClientController::class, 'exportClients'])->middleware('permission:client-lire')->name('clients.export-clients');
    Route::get('clients/export-clientspdf', [ClientController::class, 'exportClientsPdf'])->middleware('permission:client-lire')->name('clients.export-clientspdf');
    ...
    Route::patch('/versements/{id}/modifier/versement', [VersementController::class, 'modifyVersementModifierMontantStore'])->middleware('permission:versement-modifer')->name('versements.modify.versement');
