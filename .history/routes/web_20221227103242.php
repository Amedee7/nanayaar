...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/state/report', [App\Http\Controllers\ClientController::class, 'generateReport'])->name('customers.state.report')->middleware('permission:rapport-générer');
