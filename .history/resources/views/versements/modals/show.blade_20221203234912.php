                    ...
                    <div class="row justify-content-center py-5 px-5 py-md-10 px-md-0">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                ...
                                <br>
                                de <span class="label label-light-success ">{{ $versement->identifier }}</span>
                                <div class="d-flex flex-column align-items-md-end px-0">
                                    <!--begin::numero-->
                                    <span class="label label-light-success ">{{ $versement->identifier }}</span>
                                    <!--end::numero-->
                                    <span class=" d-flex flex-column align-items-md-end opacity-70">
                                        Etat: <span
                                            class="label label-light-{{ $versement->state == 'En cours' ? 'warning' : 'success' }} ">{{ $versement->state }}</span>
                                    </span>
                                </div>
                            </div>
