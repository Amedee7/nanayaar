                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <!-- Table -->
                                    <div class="card-body">
                                        <table class="table table-separate table-head-custom table-checkable" id="records">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>N Client</th>
                ...
                success: function(data) {
                    ...
                    $('#records').DataTable({
                        ...
                        "footerCallback": function(row, data, start, end, display) {
                            ...
                            var totalCs = api.column(column).data().reduce(function(a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);

                            // Total over all pages
                            var totalDb = api.column(column).data().reduce(function(a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);

                            // Total over this page
                            var pageTotalCs = api.column(column, {
                                page: 'current'
                            ...
                            // Total over this page
                            var pageTotalDb = api.column(column, {
                                page: 'current'
                            }).data().reduce(function(a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);
                            ...
                            $(api.column(columnCs).footer()).html(
                                KTUtil.numberString(pageTotal) + ' fcfa <br/> (total: ' + KTUtil
                                .numberString(total) + ' fcfa)',
                            );

                            // Update footer
                            $(api.column(columnDb).footer()).html(
                                KTUtil.numberString(pageTotalDb) + ' fcfa <br/> (total: ' + KTUtil
