            ...
            <div class="col-lg-12">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="p-4">
                                                            ...
                                                            <a href='#' class="btn btn-danger font-weight-bold px-6 py-3">Create
                                                                Report</a>
                                                        </div>
                                                    </div>
                                                    <!--end::Body-->
                        ...
                        <div class="card card-custom bg-primary gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="text-inverse-primary font-weight-bold">CLIENTS
                                    </div>
                                    <div
                                        class="text-inverse-primary font-weight-bolder font-size-h3">
                                        {{$clientAccepté}} </div>
                                </div>
                                <!--end::Stats-->

                                <!--begin::Chart-->
                                <div id="kt_tiles_widget_2_chart" class="card-rounded-bottom"
                                    style="height: 50px">
                                </div>
                                <!--end::Chart-->
                            </div>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom bg-primary gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                <!--begin::Stats-->
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="text-inverse-primary font-weight-bold">Commisions</div>
                                    <div class="text-inverse-primary font-weight-bolder font-size-h3">
                                        {{number_format($totalCommissions,0, '.',' ')}} Fcfa</div>
                                </div>
                                <!--end::Stats-->

                                <!--begin::Chart-->
                                <div id="kt_tiles_widget_5_chart" class="card-rounded-bottom"
            ...
            <div class="col-xl-3">
                ...
                <div class="card card-custom bg-primary gutter-b" style="height: 130px">
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        <!--begin::Stats-->
                        <div class="flex-grow-1 card-spacer-x pt-6">
                            <div class="text-inverse-primary font-weight-bold">Montant octrayé</div>
                            <div class="text-inverse-primary font-weight-bolder font-size-h3">
