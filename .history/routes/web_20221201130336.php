...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/montant', [ClientController::class, 'myMontant'])->name('clients.pages.montant');
    Route::post('/clients/montant/update', [ClientController::class, 'myMontantStore'])->name('clients.pages.montant.update');
