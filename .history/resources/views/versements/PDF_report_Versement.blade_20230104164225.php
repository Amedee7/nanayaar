...
<body>
    ...
    <table class="table">
        ...
        @foreach ($PDFReportVersement as $PDFReportVersement)
            <tr>
                <td>{{ $PDFReports->id }}</td>
                ...
                <td>{{ number_format($PDFReports['montant_octroye'], 0, '.', ' ') }} Fcfa</td>
                <td>{{ number_format($PDFReports['commission_verse'], 0, '.', ' ') }} Fcfa</td>
