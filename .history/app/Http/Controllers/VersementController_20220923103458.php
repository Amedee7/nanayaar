...
class VersementController extends Controller
{
    ...
    {
        $students = Versement::all();
        return datatables()->of($students)
            ->addColumn('action', function ($versements) {
                return view('versements.actions', ['students' => $versements]);
            })->toJson();
    }
    ...
    public function store(Request $request)
    {
        ...
        $eleve = new Versement();
        $eleve->matricule       = ClientService::generateNumbclient();
        ...
        $eleve->country_id = $request->country_id;
