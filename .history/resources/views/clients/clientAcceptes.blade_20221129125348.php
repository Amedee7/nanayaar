            ...
            columns: [{
                ...
                },
                {
					...
					template: function(row) {
						var status = {
							'Attente': {'name': 'Attente', 'class': ' label-light-primary'},
							'Rejeté': {'name': 'Rejeté', 'class': ' label-light-danger'},
							'Accepté': {'name': 'Accepté', 'class': ' label-light-success'},
						};
						return '<span class="label label-lg font-weight-bold ' + status[row.status].class + ' label-inline">' + status[row.status].name + '</span>';
					},
				},
