            ...
            <ul class="menu-nav" style="padding: 0px !important;">
                ...
                @permission('paramètres-voir')
                    <li class="menu-item  menu-item-submenu
                        ...
                        {{ Request::routeIs('configuration.index') ? ' menu-item-open' : '' }}
                        ...
                        <div class="menu-submenu ">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @endpermission
                                @permission('paramètres-voir')
                                    <li class="menu-item {{ Request::routeIs('confi.index') ? ' menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        <a href="{{ route('confi.index') }}" class="menu-link ">
                                            <i class="menu-bullet menu-bullet-dot"><span></span></i>
