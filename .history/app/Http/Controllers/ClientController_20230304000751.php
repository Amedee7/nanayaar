...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $client->activite_client             = $request->activity_client;
        $client->date_delivre              = $request->date_delivered;
        $client->activite_client              = $request->date_exprired;
