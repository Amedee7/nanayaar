                                                ...
                                                <select class="form-control" name="numero_client" id="mySelect2">
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            ...
                                                            < for="exampleInputPassword1"><span
                                                                class="text-danger">No Client:</span> {{ $client->numb_cli }} {{ '--- Commission: '.$client->montant_demande * 14 /100 .' FCFA'}} {{' sur => '. $client->montant_demande .' FCFA'}}</option>
                                                    @endforeach
                                                </select>
