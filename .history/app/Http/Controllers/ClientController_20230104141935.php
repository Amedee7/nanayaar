    ...
    public function viewReport(Request $req)
    {
        ...
        if ($req->isMethod('post')) {
            ...
            if ($req->has('records')) {
                ...
                return view('clients.import', ['ViewsPage' => $search, 'records' => $records, 'startDate' => $startDate, 'endDate' => $endDate]);
            }
            ...
            return view('clients.import', ['ViewsPage' => $ViewsPage], ['user' => $user,'startDate' => $startDate, 'endDate' => $endDate]);
        }
    }
}
