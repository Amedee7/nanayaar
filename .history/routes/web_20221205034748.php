...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/stocks/sortie-stock/{id}/modifier/ajouter', [VersementController::class, 'modifyModifierMontant'])->name('stocks.outer.modify.add')->middleware('permission:commande-modifier');
