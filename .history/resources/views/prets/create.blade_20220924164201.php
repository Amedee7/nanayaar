        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <h5 class="text-dark font-weight-bolder my-1 mr-5">
                    ...
                    Octoiement d'un pret. <a href="{{ route('prets.index') }}"><span
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" class="form-control" value="{{ now()->toDateTimeString() }}" name="date_demande_pret">
                                                    <span class="date_demande_pret_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Comission <span
                                                            class="text-danger">*</span></label>
                                                    <input readonly type="numbre" class="form-control"
                                                        name="date_remboursement_pret">
