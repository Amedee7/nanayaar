                                        ...
                                        <div class="row">
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="date" class="form-control" value="{{ new DateTime()date('Y-m-d H:i:s'); }}" name="date_demande_pret">
                                                    <span class="date_demande_pret_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Date de rembousement <span
                                                            class="text-danger">*</span></label>
