...
class VersementController extends Controller
{
    ...
    public function showOutStock($id){
        ...
        if ($outStock) {
            ...
            $listProducts = Product_out_stock::where('enter_stock_id', $outStock->id)
                ...
                ->select('products.name', 'products.bottles', 'product_out_stocks.product_id', 'products.price',
                    'products.volume', 'product_out_stocks.amount_total_product', 'objects'
                )
                ->get();
            $productsCount = Product_out_stock::where('enter_stock_id', $outStock->id)->count();
            $user = User::where('id', $outStock->created_by)->first();
            return view('outstock.modals.show', [
