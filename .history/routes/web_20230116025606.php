...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/{id}/versements', 'ClientController@versements');
    Route::get('/clients/{id}/versements', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-modifier')->name('versements.modify');
    ...
    Route::get('status', [VersementController::class, 'getStatus'])->name('status');
    Route::get('statusVersement', [VersementController::class, 'getStatusVersement'])->name('statusVersement');
