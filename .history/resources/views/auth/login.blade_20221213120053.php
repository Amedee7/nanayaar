...
<body id="kt_body"
    ...
    <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
        <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom mt-20" style="background-image: url(custom/illustrations/login-visual-4.svg);">
            <!--begin::Aside title-->
