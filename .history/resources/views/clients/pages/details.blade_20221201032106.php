                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6"
                                            ...
                                            <div class="menu-item px-5">
                                                <a href="{{route('clients.update', $client->id)}}" class="btn btn-primary btn-sm"> <span class="far fa-edit"></span>Modifier</a>
                                            ...
                                            <div
                                                ...
                                                <div class=" text-center">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <span
                                                            class="fs-2x font-weight-bold font-size-h2 text-warning">{{ number_format($client->montant_demande, 0, '.', ' ') }}</span>
                                                        <span class="fs-7 fw-bold opacity-50">Fcfa</span>
                                                    </div>
                                                </div>
                                            </div>
