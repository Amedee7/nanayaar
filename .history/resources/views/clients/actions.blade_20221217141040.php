...
@endif --}}<a href="{{ route('clients.edit', $client->id) }}"
...
<div class="d-flex justify-content-end flex-shrink-0">
    <a onclick="editRecord('{{route('suppliers.edit', $suppliers->id)}}')" title="Modifier" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
        ...
        <a onclick="deleteRecordConfirm('{{ route('clients.destroy', $clients->id) }}')" title="Supprimer définitivement" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
            <span class="svg-icon svg-icon-muted svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        @if(request()->has('trashed'))
        <a href="{{ route('clients.restore', $clients->id) }}" title="Restoré" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mr-1">
            <span class="svg-icon svg-icon-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
