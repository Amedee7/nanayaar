...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/users/password', [App\Http\Controllers\UserController::class, 'myPassword'])->name('users.profile.password');
    Route::post('/users/password/update', [App\Http\Controllers\UserController::class, 'myPasswordStore'])->name('users.profile.password.update');
