            ...
            <ul class="menu-nav ">
                ...
                <div class="menu-item {{ Request::routeIs('home') ? ' menu-item-active' : '' }} menu-item-submenu"
                    ...
                    <a href="{{ route('home') }}" class="menu-link menu-toggle"><span class="svg-icon menu-icon">
                            ...
                            <!--end::Svg Icon-->
                        </span><span class="menu-text">Tableau de bord</span></a>
                </div>
                ...
                {{ Request::routeIs('clients.details') ? ' menu-item-open' : '' }} menu-item-submenu"
                        aria-haspopup="true" data-menu-toggle="hover"><a href="javascript:;"
                            class="menu-link menu-toggle"><span class="svg-icon svg-icon svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Group.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <polygon points="0 0 24 0 24 24 0 24"/>
        ...
        <path d="M17.6011961,15.0006174 C21.0077043,15.0378534 23.7891749,16.7601418 23.9984937,20.4 C24.0069246,20.5466056 23.9984937,21 23.4559499,21 L19.6,21 C19.6,18.7490654 18.8562935,16.6718327 17.6011961,15.0006174 Z M0.00065168429,20.1992055 C0.388258525,15.4265159 4.26191235,13 8.98334134,13 C13.7712164,13 17.7048837,15.2931929 17.9979143,20.2 C18.0095879,20.3954741 17.9979143,21 17.2466999,21 C13.541124,21 8.03472472,21 0.727502227,21 C0.476712155,21 -0.0204617505,20.45918 0.00065168429,20.1992055 Z" fill="#000000" fill-rule="nonzero"/>
...
</svg><!--end::Svg Icon--></span><span class="menu-text">Gestion des Clients</span><i class="menu-arrow"></i></a>
                ...
                {{ Request::routeIs('users.index') ? ' menu-item-open' : '' }}
                    ...
                    aria-haspopup="true" data-menu-toggle="hover"><a href="javascript:;"
                        class="menu-link menu-toggle"><span class="svg-icon menu-icon">
                            ...
                            <!--end::Svg Icon-->
                        </span><span class="menu-text">Paramètres</span><i class="menu-arrow"></i></a>
                    <div class="menu-submenu "><i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            <li class="menu-item  menu-item-parent" aria-haspopup="true"><span
                ...
                @permission('profile-lire')
                    <li class="menu-item {{ Request::routeIs('profile.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true"><a href="{{ route('profile.index') }}" class="menu-link "><span
                                class="svg-icon menu-icon">
                                ...
                                <!--end::Svg Icon-->
                            </span><span class="menu-text">Mon profil</span></a>
                    </li>
                @endpermission
