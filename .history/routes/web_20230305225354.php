...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/historique-versements', [VersementController::class, 'client'])->middleware('permission:versement-lire')->name('versements.historique-versements');
