...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dueDate = '2022-01-23'; // remplacez cette valeur par la date limite souhaitée
        ...
        $clientEnRetard = Versement::where('limit', '=', DB::raw("DATE_SUB('$dueDate', INTERVAL 12 DAY)"))->count();
        dd($clientEnRetard);
