...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clients/status/update', [ClientController::class, 'updateStatus'])->name('clients.update.status');

    Route::delete('/clients/{id}', [ClientController::class, 'destroy'])->middleware('permission:client-modifier')->name('clients.destroy');
