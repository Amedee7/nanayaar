                        ...
                        <div
                            ...
                            <div class="d-flex flex-column mr-2">
                                <a href="#"
                                    ...
                                    Sales</a>
                                <span class="text-muted font-weight-bold mt-2">Your Weekly Sales
                                    Chart</span>
                            </div>
                            <span class="symbol symbol-light-success symbol-45">
                                <span
                                    class="symbol-label font-weight-bolder font-size-h6">+57</span>
                            </span>
                        </div>
                        <div id="kt_stats_widget_7_chart" class="card-rounded-bottom"
                        ...
                        <div class="d-flex align-items-center justify-content-between card-spacer">
                            <div class="d-flex flex-column mr-2">
                                <a href="#"
                                    ...
                                    Progress</a>
                                <span class="text-muted font-weight-bold mt-2">Marketplace Authors
                                    Chart</span>
                            </div>
                            <span class="symbol symbol-light-danger symbol-45">
                                <span
                                    class="symbol-label font-weight-bolder font-size-h6">+94</span>
                            </span>
                        </div>
                        <div id="kt_stats_widget_8_chart" class="card-rounded-bottom"
                            style="height: 150px"></div>
                    </div>
                    <!--end::Body-->
                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between card-spacer">
                            <div class="d-flex flex-column mr-2">
                                <a href="#"
                                    ...
                                    Progress</a>
                                <span class="text-muted font-weight-bold mt-2">Marketplace Sales
                                    Chart</span>
                            </div>
                            <span class="symbol symbol-light-primary symbol-45">
                                <span
                                    class="symbol-label font-weight-bolder font-size-h6">+28</span>
                            </span>
                        </div>
                        <div id="kt_stats_widget_9_chart" class="card-rounded-bottom"
                            style="height: 150px"></div>
                    </div>
                    <!--end::Body-->
                </div>
