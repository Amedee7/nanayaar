...
<div id="kt_header" class="header  header-fixed ">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <!--begin::Label-->
            <span class=" btn btn-secondary btn btn-icon-mobilefs-7 text-gray-700 fw-bolder pe-3 d-none d-xxl-block" id="kt_quick_user_toggle">{{Auth::user()->lastname}} {{Auth::user()->firstname}}</span>
            <!--end::Label-->
            <!--begin::Actions-->
            <div class="d-flex">
                <!--begin::Action-->
