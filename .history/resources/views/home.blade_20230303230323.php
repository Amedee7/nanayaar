                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="{{ route('versements.client-retard') }}" class="text-danger font-weight-bold font-size-h2 mt-2 menu-link ">
                                            {{ $versementEnd }}<span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
