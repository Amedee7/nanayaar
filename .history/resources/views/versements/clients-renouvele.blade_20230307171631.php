@extends('layouts.app')
@section('title', 'Administration - Liste des clients renouvelés')
@section('content')
        ...
        <div class="container col-md-12">
            <div class="card card-custom">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="d-flex align-items-center mb-9 bg-light-su rounded p-5">
                        <!--begin::Icon-->
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="o2d-datatable">
                            ...
                            <tbody>
                                @foreach ($versements as $key => $versement)
                                    @if ($versement->status_news_versement == 'Renouvelé')
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                ...
                                                <div>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                class="text-dark font-weight-bolder text-hover-primary mb-1 fs-6">
                                                                {{ $versement->client->name }}
                                                            </a>
                                                            <span
                                                                class="text-muted font-weight-bolder text-muted d-block fs-7">
                                                                <div class="min-w-125px pe-2">N Client:
                                                                    <span
                                                                        class="fs-8 m-1">{{ $versement->client->numb_cli }}
                                                                    </span>
                                                                    <div class="min-w-125px pe-2">Tel
                                                                        <span
                                                                            class="label label-light-primary label-inline fs-8 m-1">{{ $versement->client->first_phone }}
                                                                        </span>
                                                                    </div>
                                                            </span>
                                                        </div>
