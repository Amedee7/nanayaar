...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::delete('/clients/{id}', [ClientController::class, 'destroy'])->name('posts.destroy');
    Route::get('/clients/restore/{id}', [ClientController::class, 'restore'])->name('posts.restore');
    Route::get('/clients/restore-all', [ClientController::class, 'restoreAll'])->name('posts.restoreAll');
