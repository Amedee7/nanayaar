                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="font-weight-bolder">
                                            <td><span class="badge badge-light-success">{{number_format($versement->reste_apaye,0, '.',' ')}}</td>
                                            <td><span class="badge badge-light-warning">{{number_format($versement->somme_verse,0, '.',' ')}}</td>
