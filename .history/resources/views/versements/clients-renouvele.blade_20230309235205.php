            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <div id="client-datatable" class="table-responsive">
                        <tableclass="table table-clients font-weight-bolder table-bordered table-head-custom table-head-bg table-vertical-center" id="o2d-datatable">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>CLIENT</th>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="ml-4">
                                                                        ...
                                                                        <a
                                                                            class="text-muted font-weight-bolder primary-color">N
                                                                            Client:
                                                                            <span
                                                                                class="font-weight-boldest text-success">{{ $item->numb_cli }}</span>
                                                                        </a> <br>
                                                                        <a
                                                                            class="text-muted font-weight-bolder primary-color">Tel:
                                                                            <span
