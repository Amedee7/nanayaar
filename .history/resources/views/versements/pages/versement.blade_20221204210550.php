    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
                ...
                <div class="d-flex flex-row">
                    ...
                    <!--begin::Aside-->
                    <div class="flex-row-fluid ml-lg-8"" id="kt_profile_aside">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body pt-4">
                                <!--begin::Form-->
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero est maxime omnis eveniet
                                    blanditiis corrupti, nulla laborum assumenda earum asperiores quam. Pariatur illum,
                                    praesentium cum iusto rerum facilis ex ipsam!</p>
                                <!--end::Form-->
                            </div>
                            <!--end::Body-->
                        </div>
