...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/configs', [App\Http\Controllers\ConfigurationController::class, 'index'])->name('c.index')->middleware('permission:paramètres-voir');
    Route::patch('/configs/{id}/update', [App\Http\Controllers\ConfigurationController::class, 'update'])->name('c.update')->middleware('permission:paramètres-voir');
});
