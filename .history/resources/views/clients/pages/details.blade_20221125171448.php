            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Détails sur l'étudiant
                        [<span class="font-weight-boldest text-primary">{{$client->matricule}}</span>]
                        [<span class="font-weight-bolder text-primary">{{$client->first_name}} {{$client->last_name}}</span>]
                    </h5>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="card card-custom gutter-b card-stretch">
                        <div class="card-body pt-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
                                        <div class="symbol symbol-circle symbol-lg-75">
                                            <img src="{{asset('custom/students/'.$client->photo.'')}}" alt="image">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <a class="text-dark font-weight-bolder font-size-h4 mb-0">[{{$client->matricule}}] - {{$client->first_name}}</a>
                            ...
                            <a href="{{route('students.edit', $client->uuid)}}" class="btn btn-block btn-sm btn-primary font-weight-bolder text-uppercase py-3">Modifier les infos</a>
                        </div>
                    </div>
                </div>
            </div>
