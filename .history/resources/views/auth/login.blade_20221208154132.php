        ...
        <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="form" id="kt_login_singin_form">
                            ...
                            <div class="pb-lg-0 pb-5">
                                <button type="submit" id="kt_login_singin_form_submit_button"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Co</button>
                                <button type="button"
            ...
            <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
                <div class="login-conteiner bgi-no-repeat bgi-position-x-right bgi-position-y-bottom"
                    ...
                    <!--begin::Aside title-->
                    <h3
                        class="pt-lg-40 pl-lg-20 pb-lg-0 pl-10 py-20 m-0 d-flex justify-content-lg-start font-weight-boldest display5 display1-lg text-red">
                        NANA YAAR
                    </h3>
                    <!--end::Aside title-->
                </div>
