...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    //STATUS CHANGEMENT
    Route::get('/clients/{id}/accepte', [ClientController::class, 'statusAccepte'])->middleware('permission:client-modifier')->name('clients.accepte');
    Route::get('/clients/{id}/rejete', [ClientController::class, 'statusRejete'])->middleware('permission:client-modifier')->name('clients.rejete');
