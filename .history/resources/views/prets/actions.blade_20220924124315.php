...
<button onclick="deleteRecordConfirm('{{route('client.destroy', $clients->id)}}')" title="Supprimer"  class="btn btn-outline-danger btn-sm"><span class="flaticon2-trash"></span></button>
