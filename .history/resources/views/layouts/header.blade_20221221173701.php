    <div class="content d-flex flex-column flex-column-fluid" id="kt_header">
        <div id="kt_header" style="" class="header align-items-stretch">
            <div class="header-brand">
                <a href="{{ route('home') }}">
                    <h3 style="color: white;" class="text-center">NANA</h3>
                </a>
                ...
                <div
                    ...
                    <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Label-->
                            <span
                                class="fs-7 text-gray-700 fw-bolder pe-3 d-none d-xxl-block">{{ Auth::user()->lastname }}
                                {{ Auth::user()->firstname }}</span>
                            <!--end::Label-->
                            <!--begin::Actions-->
                            <div class="d-flex">
                                <!--begin::Action-->
                                <a class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary"
