                                                ...
                                                <select class="form-control" name="numero_client" id="mySelect2">
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            ...
                                                            <span class="text-danger">No Client:</span> {{ $client->numb_cli }} {{ '--- Commission: '.$client->montant_demande * 14 /100 .' FCFA  '}} {{' --- sur => '. $client->montant_demande .' FCFA'}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="box-body col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Date limite de paiement<span
                                                            class="text-danger">*</span></label>
                                                    <input readonly type="text" class="form-control"
                                                        value="{{  Carbon\Carbon::now()->addDays(14)->toDateTimeString()}}" name="date_remboursement">
