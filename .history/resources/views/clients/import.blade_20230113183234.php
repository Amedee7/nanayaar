                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            ...
                            <div>
                                ...
                                <button id="reset_resr" class="btn btn-sm btn-outline-info">Reset Result</button>
...
@section('js')
    ...
    <script>
        ...
        $(document).on("click", "#reset_status", function(e) {
            ...
            $("#select_resr").html(`<option value="">Choose...</option>`);
            $('#records').DataTable().destroy();
            fetch();
            fetch_sts();
            fetch_res();
