...
class ClientController extends Controller
{
    ...
    [17:13:20] LOG.error: SQLSTATE[23000]: Integrity constraint violation: 1048 Column 'status' cannot be null (SQL: insert into `clients` (`numb_cli`, `nom`, `prenom`, `first_phone`, `second_phone`, `date_naiss`, `montant_demande`, `genre`, `status`, `photo`, `user_id`, `created_by`, `updated_by`, `updated_at`, `created_at`) values (2022-1, Officia modi anim qu, Consequatur eum plac, +1 (457) 462-4456, +1 (916) 837-2179, 2011-08-25, 31, Féminin, ?, ?, ?, 2, 2, 2022-09-23 17:13:20, 2022-09-23 17:13:20)) 
