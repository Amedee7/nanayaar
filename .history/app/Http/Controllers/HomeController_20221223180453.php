...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dueDate = '2022-12-27'; // remplacez cette valeur par la date limite souhaitée
        ...
        $clientEnRetard = Versement::where('limit', '=', DB::raw("DATE_ADD(CURDATE5, INTERVAL 2 DAY)"))->count();
        dd($clientEnRetard);
