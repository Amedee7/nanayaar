...
class VersementController extends Controller
{
    ...
    {
        $stocks = DB::table('versements')
            ->join('customers', 'customers.id', '=', 'versements.customer_id')
            ->join('users', 'users.id', '=', 'versements.created_by')
            ->select(
                'versements.id','versements.identifier','versements.comment',
                'versements.amount_total','amount_payed','amount_rule','state', 'versements.status',
