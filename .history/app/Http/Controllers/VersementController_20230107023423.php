...
class VersementController extends Controller
{
    public function datatables()
    {
        $versements = DB::table('versements')
            ...
            ->select(
                ...
                DB::raw('reste_apaye * 0.01 * joursApresDateLimite as penality'),
    ...
    public function index(Request $request)
    {
        ...
        ->select(DB::raw('SUM(reste_a_payer * 1/100 * DATEDIFF(now(), fin)) as penalite'))
        ->where('reste_a_payer', '>', 0) // Ne prend en compte que les versements ayant un reste à payer
