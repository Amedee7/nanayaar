                            ...
                            <div class="card card-custom" style="border: solid; border-color: black">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input class="input-xlg bgc-blue" id="input1" type="checkbox" {{ ($role->hasPermission('cl-changer statut') ? 'checked' : '') }} name="permissions[]" value="utilisateur-changer statut" >
                                                <span></span>
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input id="input3" type="checkbox" {{ ($role->hasPermission('sous-operation-effectuer') ? 'checked' : '') }} name="permissions[]" value="sous-operation-effectuer" >
                                                <span></span>
                                    ...
                                    <div class="col-md-3">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input id="input4" type="checkbox" {{ ($role->hasPermission('configuration-regler') ? 'checked' : '') }} name="permissions[]" value="configuration-regler" >
                                                <span></span>
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input id="input5" type="checkbox" {{ ($role->hasPermission('sauvegarde-creer') ? 'checked' : '') }} name="permissions[]" value="sauvegarde-creer" >
                                                <span></span>
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input id="input6" type="checkbox" {{ ($role->hasPermission('sauvegarde-lire') ? 'checked' : '') }} name="permissions[]" value="sauvegarde-lire" >
                                                <span></span>
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input id="input7" type="checkbox" {{ ($role->hasPermission('archive-lire') ? 'checked' : '') }} name="permissions[]" value="archive-lire" >
                                                <span></span>
                                                Voir les archives
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <div class="checkbox-inline">
                                            <label class="checkbox checkbox-lg">
                                                <input id="input8" type="checkbox" {{ ($role->hasPermission('log-lire') ? 'checked' : '') }} name="permissions[]" value="log-lire" >
                                                <span></span>
                                                Voir les logs
                                            </label>
                                        </div>
