...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/historiqueClientRembourse', [VersementController::class, 'historiqueClientRembourse'])->middleware('permission:versement-lire')->name('versements.historique-versements');
