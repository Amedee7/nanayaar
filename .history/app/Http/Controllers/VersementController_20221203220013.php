...
class VersementController extends Controller
{
    ...
    public function showVersement($id){
        $c = DB::table('out_stocks')->where('id', $id)->first();
        if ($c) {
            $customer = Client::where('id', $c->customer_id)->first();
            $listProducts = Product_out_stock::where('enter_stock_id', $c->id)
                ...
                ->get();
            $productsCount = Product_out_stock::where('enter_stock_id', $c->id)->count();
            $user = User::where('id', $c->created_by)->first();
            return view('outstock.modals.show', [
                'outStock' => $c, 'customer' => $customer, 'user' => $user,
