...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'numero_1'              => 'required|regex:/(0)[0-9]/|not_regex:/[a-z]/|min:8',
            'numero_2'              => 'required|regex:/(0)[0-9]/|not_regex:/[a-z]/|min:8',
    ...
    public function destroy($id){
        $cli = Permission::find($id);
        if($cli){
            $cli->delete();
            return response()->json(['type' => 'success', 'message' => "La cli a été supprimée avec succès !"]);
        }else{
