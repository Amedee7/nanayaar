                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        ...
                                        <ul class="navi navi-hover py-5">
                                            <li class="navi-item">
                                                <a onclick="requestAccountStatusRefresh('{{route('customers.status', $customer->id)}}')" title="Changer de statut" class="menu-link px-5">{{$customer->status=='Actif'?'Désactiver':'Activer'}}
                                                    <span class="navi-icon"><i class="flaticon2-drop"></i></span>
                                                    <span class="navi-text">Changer de status</span>
                                                </a>
                                            </li>
                                            <li class="navi-item">
