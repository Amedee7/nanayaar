...
class VersementController extends Controller
{
    ...
    public function showVersement($id){
        $cli = DB::table('out_stocks')->where('id', $id)->first();
        if ($cli) {
            $customer = Client::where('id', $cli->customer_id)->first();
            $listProducts = Product_out_stock::where('enter_stock_id', $cli->id)
                ...
                ->get();
            $productsCount = Product_out_stock::where('enter_stock_id', $cli->id)->count();
            $user = User::where('id', $cli->created_by)->first();
            return view('outstock.modals.show', [
                'outStock' => $cli, 'customer' => $customer, 'user' => $user,
