...
@section('content')
    ...
    <div class="container">
            ...
            <tbody>
                @foreach ($clients as $client)
                    <tr>
                        ...
                        <td>{{ Str::limit($client->user->firstname) }} {{ Str::limit($client->user->firstname) }}</td>
        ...
        <div class="float-end">
            ...
            @else
                <a href="{{ route('clients.clientAcceptes', ['trashed' => 'client']) }}" class="btn btn-primary">View Deleted
                    clients</a>
            @endif
        </div>
    </div>
