...
class VersementController extends Controller
{
    public function datatables()
    {
        $versements = DB::table('versements')
            ...
            )->orderBy('updated_at', 'DESC')->where('reste_apaye', '>', 0) // Ne prend en compte que les versements ayant un reste à payer
            ->where('fin', '<', now())->where('versements.deleted_at', null);
