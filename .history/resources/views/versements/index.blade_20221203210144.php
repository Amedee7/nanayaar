        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class="badge badge-light-success label-inline fs-8 fw-bolder">' + data +
                            '</span>' +
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        output = '<div class="d-flex align-items-center">' +
                            ...
                            '<span class="label label-light-primary font-weight-bolder fs-8 m-1">' + full.first_phone +
                            '</span>' +
                            '</div>' +
                            '</span>' +
                            '</div>' +
