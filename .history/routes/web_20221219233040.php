...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    //LOGS ROUTES
    Route::get('/admin/logs/datatable', [LogController::class, 'datatables'])->name('logs.datatable')->middleware('permission:log-consulter');
    Route::get('/admin/logs/', [LogController::class, 'index'])->name('logs.index')->middleware('permission:log-consulter');
    Route::get('/admin/logs/show/{id}/', [LogController::class, 'show'])->name('logs.show')->middleware('permission:log-consulter');

    //CONFIGURATIONS ROUTES
    Route::get('/admin/configuration', [ConfigurationController::class, 'index'])->name('configuration.index')->middleware('permission:paramètres-voir');
    Route::patch('/admin/configuration/{id}/update', [ConfigurationController::class, 'update'])->name('configuration.update')->middleware('permission:paramètres-voir');
});
