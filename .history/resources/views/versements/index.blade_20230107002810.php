            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        if (full.status != 'Remboursé' && full.testa <= 2) {
...

                {
                    ...
                    render: function render(data, type, full, meta) {
                            return '<span class=" label label-light-success label-inline fs-6">' +
                                full.joursApresDateLimite * 1 / 100 * full.reste_apaye
                                .toLocaleString('fr') + '<br>'+ full.joursApresDateLimite * 1 / 100 * full.reste_apaye+'</span>'
                    }
                },
