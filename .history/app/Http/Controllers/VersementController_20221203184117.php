...
class VersementController extends Controller
{
    ...
    {
        $stocks = DB::table('clients')
            ->join('customers', 'customers.id', '=', 'clients.customer_id')
            ->join('users', 'users.id', '=', 'clients.created_by')
            ->select(
                'clients.id','clients.identifier','clients.comment',
                'clients.amount_total','amount_payed','amount_rule','state', 'clients.status',
