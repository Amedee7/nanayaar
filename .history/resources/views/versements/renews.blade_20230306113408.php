    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Renouvelé un pret</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('versements.storeRenews') }}" method="post" id="o2d-record-form-datatable">
                    @csrf
                    <div class="row mb-5">
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            ...
                            <select name="client" id="roles" data-placeholder="--Veuillez choisir--"
                                ...
                                @foreach ($clients as $item)
                                    @if (($item->status_versement == 'Remboursé'))
