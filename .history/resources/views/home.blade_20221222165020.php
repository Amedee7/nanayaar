                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div id="kt_stats_widget_8_chart" class="card-rounded-bottom" style="height: 150px">
                                </div>
                            </div>
                            <!--end::Body-->
                        </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <div id="kt_stats_widget_9_chart" class="card-rounded-bottom" style="height: 150px">
                                </div>
                            </div>
                            <!--end::Body-->
                        </div>
