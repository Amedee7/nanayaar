...
class VersementController extends Controller
{
    ...
    public function index(Request $request)
    {
        $stocks = DB::table('versements')
            ...
            ->select(
                'versements.id','versements.identifier','versements.commentaire',
                'versements.montant_octroye','somme_verse','reste_apaye','state', 'versements.status',
                'clients.name','clients.first_phone','users.avatar',
