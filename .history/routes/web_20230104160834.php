...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-modifier')->name('versements.modify');
     ...
     //View Page
     Route::get('versements/viewReportVersement', [ClientController::class, 'viewReportVersement'])->name('versements.viewReportVersement');
     Route::post('versements/viewReportVersement', [ClientController::class, 'viewReportVersement'])->name('versements.viewReportVersement');
