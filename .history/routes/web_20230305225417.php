...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/historique-versements', [VersementController::class, 'clientRenouvele'])->middleware('permission:versement-lire')->name('versements.client-renouvel');
