                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                                    ...
                                    <thead>
                                        <tr class="fw-bolder text-muted">
                                            <th style="background-color:rgb(204, 25, 25);" class="min-w-140px">ID</th>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        var output;
                        if (full.testa <= 2) {
                                return '<div style="background-color:red;" class="p-2">' + 
                            ...
                            '</div>'
                                ...
                                return '<span class="text-success">' + 'test2' + '</span>';
                            }
                    }
                },
...

                {
                    ...
                    render: function render(data, type, full, meta) {
                            if (full.testa <= 2) {
                                return '<span class="text-danger">' + 'test' + '</span>';
                            } else {
                                return '<span class="text-success">' + 'test2' + '</span>';
                            }
                    }
