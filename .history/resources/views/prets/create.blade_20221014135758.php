                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="box-body col-md-8">
                                                <label class="font-weight-bold" for="exampleInputPassword1">Client</label>
                                                <select class="form-control" name="numero_client" id="mySelect2">
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            @if ($loop->first) selected @endif>
                                                            <p class="font-weight-bold"> No Client:</p> {{ $client->numb_cli }} {{ '--- Commission: '.$client->montant_demande * 14 /100 .' FCFA'}} {{' sur => '. $client->montant_demande .' FCFA'}}</option>
                                                    @endforeach
                                                </select>
