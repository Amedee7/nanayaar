                        ...
                        <div class="card-body pt-4">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6"
                                            ...
                                            {{-- <form action="">
                                                ...
                                                <select name="approve">
                                                    <label for=""> fffff</label>
                                                    <option value="0" @if ($client->status == 0)selected @endif>Pending</option>
                                                    <option value="1" @if ($client->status == 1)selected @endif>Approve</option>
                                                    <option value="2" @if ($client->status == 2)selected @endif>Reject</option>
                                                    <option value="3" @if ($client->status == 3)selected @endif>Postponed</option> 
                                                  </select>
                                            </div>
                                            </form>
                                             --}}
                                            ...
                                            <div class="menu-item px-5">
                                                <a href="{{route('clients.edit', $client->id)}}" class="btn btn-primary btn-sm"> <span class="far fa-edit"></span>Modifier</a>
                                                <form method="POST" action="{{ route('clients.destroy', $client->id) }}">
                                                    @csrf
                                                    <input name="_method" type="hidden" value="DELETE">
                                                    <button type="submit" class="btn btn-danger btn-sm delete"
                                                        title='Supprimer'><span class="far fa-trash-alt"></span>
                                                        Supprimer</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    {{-- <div class="mt-2">
                                        <button type="button" id="sender" class="btn btn-primary"
                                            onclick="updateRecord();">
                                            <span id="btn-load" class="spinner-border d-none spinner-border-sm"
                                                role="status" aria-hidden="true"> </span>
                                            <b id="text-load" class="text-hide">Veuillez patienter</b>
                                            <b id="text-fix">Mettre a jour</b>
                                        </button>
                                    </div> --}}
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div
                                                ...
                                                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover">
                                                    <a onclick="editRecord('{{route('clients.montant')}}')" class="btn btn-sm btn-primary" >
                                                        <span class="svg-icon svg-icon-3">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <rect opacity="0.5" x="11.364" y="20.364" width="16" height="2" rx="1" transform="rotate(-90 11.364 20.364)" fill="light"></rect>
                                                                <rect x="4.36396" y="11.364" width="16" height="2" rx="1" fill="light"></rect>
                                                            </svg>
                                                        </span>
                                                        Réinitialiser le montant demandé
                                                    </a>
                                                </div>
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <span
                                                            class="fs-2x font-weight-bold font-size-h2 text-success">{{ number_format($client->commission_averse, 0, '.', ' ') }}</span>
                                                        <span class="fs-7 fw-bold opacity-50">Fcfa</span>
                                                    </div>
                                                </div>
                                            </div>
