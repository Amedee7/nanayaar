...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::patch('/versements/{id}/modifier/versement', [VersementController::class, 'modifyVersementModifierMontantStore'])->middleware('permission:versement-supprimer')->name('versements.modify.versement');
