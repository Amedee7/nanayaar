...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/terminer', [VersementController::class, 'closeVersementPage'])->name('stocks.termine')->middleware('permission:versements-modifier');
    Route::patch('/versements/{id}/finish', [VersementController::class, 'closeVersementPageStore'])->name('stocks.finish')->middleware('permission:versements-modifier');
    Route::get('/versements/{id}/show', [VersementController::class, 'showVersement'])->name('stocks.show')->middleware('permission:versements-lire');
    Route::get('/versements/{id}/cancel', [VersementController::class, 'VersementCancel'])->name('stocks.cancel')->middleware('permission:versements-modifier');
    Route::get('/versements/{id}/rule', [VersementController::class, 'VersementAmountRule'])->name('stocks.rule')->middleware('permission:versements-règlement');
    Route::patch('/versements/{id}/rule/store', [VersementController::class, 'VersementAmountRuleStore'])->name('stocks.rule.store')->middleware('permission:versements-règlement');
    Route::delete('/versements/{id}/delete', [VersementController::class, 'VersementDelete'])->name('stocks.delete')->middleware('permission:versements-supprimer');
    Route::get('/stocks/sortie-stock/{id}/modifier', [App\Http\Controllers\StockController::class, 'modifyOutStock'])->name('stocks.outer.modify')->middleware('permission:commande-modifier');
