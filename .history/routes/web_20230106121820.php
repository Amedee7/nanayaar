...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
 ...
 Route::get('/logs/', [App\Http\Controllers\LogController::class, 'index'])->name('logs.index')->middleware('permission:log-consulter');
 Route::get('/logs/show/{id}/', [App\Http\Controllers\LogController::class, 'show'])->name('logs.show')->middleware('permission:log-consulter');
