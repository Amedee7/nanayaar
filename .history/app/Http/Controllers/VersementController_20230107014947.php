...
class VersementController extends Controller
{
    public function datatables()
    {
        ...
        ->addColumn('penalite', function($ver) {
            if (Carbon::parse($ver->date1) > Carbon::parse($ver->date2)) {
                $penalite = calculPenalite($result->montant, Carbon::parse($ver->date1)->diffInDays(Carbon::parse($ver->date2)));
                return $penalite;
            } else {
                return 0;
            }
