                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="width: 250px;">
                                            ...
                                            <span class="label label-light-success label-inline">{{ $item->status }}</span>
                                        @elseif($item->status == 'Remboursement partiel')
                                            <span class="label label-light-warning label-inline">{{ $item->status }}</span>
                                        @elseif($item->status == 'Non remboursé')
                                            <span class="label label-light-danger label-inline">{{ $item->status }}</span>
                                        @endif
                                                        </span>
                                                    </div>
                                                    <span
