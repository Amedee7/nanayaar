                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Status <span
                                                            class="text-danger">*</span></label>
    ...
    <script>
        function studentStoreRecord() {
            ...
            $.ajax({
                            ...
                            switch (type) {
                                ...
                                case 'success':
                                    Swal.fire(
                                        ...
                                        wwindow.location.href = "/clients/create";
                                    });
                                    // $.confirm({
                                    //     icon: 'fa fa-check',
                                    //     title: 'Succès',
                        ...
                        break;
                        case 'error': swal("Erreur", message, "error");
                        break;
                    }

                    $('#text-load').addClass('text-hide'); $('#text-fix').removeClass('text-hide'); $('#sender')
                    .removeClass('spinner spinner-white spinner-right').attr("disabled", false);
