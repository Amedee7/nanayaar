...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [App\Http\Controllers\VersementController::class, 'modifyVersement'])->name('versements.modify')->middleware('permission:versement-modifier');
