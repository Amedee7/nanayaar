...
class ClientController extends Controller
{
    ...
    public function datatables(Request $request)
    {
        ...
        ->join('users', 'users.id', '=', 'clients.users_id')
        ->select(
            'id',
            'name',
            'lastname',
            ...
            DB::raw("CONCAT(name,' ',lastname) as name_client"),
   ...
   public function export(Request $request){
    ...
    if ($request->input('exportexcel') != null ){
       return Excel::download(new ClientsExport, 'vlients.xlsx');
    }

    if ($request->input('exportcsv') != null ){
       return Excel::download(new ClientsExport, 'vlients.csv');
    }
