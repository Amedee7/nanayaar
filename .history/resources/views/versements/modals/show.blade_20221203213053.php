    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 650px;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Détails de la commande
                    <span class="badge badge-light-success">{{$outStock->identifier}}</span> |
                    Etat: <span class="badge badge-light-{{$outStock->state=="En cours"?"warning":"success"}}">{{$outStock->state}}</span>
                </h5>
            ...
            <div class="modal-body">
                <div class="mt-n1">
                    <div class="m-0">
                        <div class="fw-bolder fs-3 text-gray-800 mb-8">Commande <span class="text-success">{{$outStock->identifier}}</span> </div>
                        <div class="row g-5 mb-11">
                            <div class="col-sm-6">
                                <div class="fw-bold fs-7 text-gray-600 mb-1">Date de création :</div>
                                <div class="fw-bolder fs-6 text-gray-800">{{\Illuminate\Support\Carbon::make($outStock->created_at)->format('d/m/Y à H:i:s') }}</div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center flex-wrap">
                                    ...
                                    <span class="fs-7 text-primary d-flex align-items-center">
                                        <span class="bullet bullet-dot bg-primary me-2"></span>{{$customer->telephone}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="row g-5 mb-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="fw-bolder fs-6 text-gray-800">
                                    @if($outStock->status=="Payé")
                                    <span class="badge badge-light-success">{{$outStock->status}}</span>
                                    @elseif($outStock->status=="Paiement partiel")
                                    <span class="badge badge-light-warning">{{$outStock->status}}</span>
                                    @elseif($outStock->status=="Non payé")
                                    <span class="badge badge-light-danger">{{$outStock->status}}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="mw-300px">
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="text-end fw-bolder fs-6 text-gray-800">{{count($listProducts)}}</div>
                                    </div>
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">SOMME TOTALE:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-success">{{number_format($outStock->amount_total,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack mb-3">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">SOMME PAYEE:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-warning">{{number_format($outStock->amount_payed,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack">
                                        <div class="fw-bold pe-10 text-gray-600 fs-7">RESTE A PAYER:</div>
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-danger">{{number_format($outStock->amount_rule,0, '.',' ')}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
