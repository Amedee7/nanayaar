                        ...
                        <div class="card-body pt-4">
                            ...
                            <a href="#">
                                @if ($client->status == 'En attente')
                                    <span
                                        class="btn btn-light-primary font-weight-bold py-3 px-6 mb-2 text-center btn-block">{{ $client->status }}</span>
                                @elseif($client->status === 'Accepté')
                                    <span
                                        class="btn btn-light-success font-weight-bold py-3 px-6 mb-2 text-center btn-block">{{ $client->status }}</span>
                                @elseif($client->status === 'Rejeté')
                                    <span
                                        class="btn btn-light-danger font-weight-bold py-3 px-6 mb-2 text-center btn-block">{{ $client->status }}</span>
                                @endif
                            </a>
                        </div>
                        <!--end::Body-->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card card-custom bg-radial-gradient-primary card-stretch gutter-b">
                                ...
                                <div class="card-header border-0 py-5">
                                    <h3 class="card-title font-weight-bolder text-white">Sales Progress
                                    </h3>
                                    <div class="card-toolbar">
                                        <div class="dropdown dropdown-inline">
                                            <a href="#"
                                    ...
                                    <div class="card-spacer bg-white card-rounded flex-grow-1">
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">
                                                    Commission</div>
                                                <div class="font-size-h4 font-weight-bolder">$233,600
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                <div class="font-size-sm text-muted font-weight-bold">
                                                    Annual Taxes</div>
                                                <div class="font-size-h4 font-weight-bolder">$29,004
                                                </div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">
                                                    Annual Income</div>
                                                <div class="font-size-h4 font-weight-bolder">$1,480,00
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card card-custom  card-stretch gutter-b">
                                ...
                                <div class="card-header border-0">
                                    <h3 class="card-title font-weight-bolder text-dark">Notifications
                                    </h3>
                                    <div class="card-toolbar">
                                        <div class="dropdown dropdown-inline">
                                            <a href="#"
