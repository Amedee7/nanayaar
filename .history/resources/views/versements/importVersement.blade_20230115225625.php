                        ...
                        "columns": [{
                            ...
                            },
                            {
                                ...
                                "render": function(data, type, row, meta, display) {
                                    return `${row.commission_verse.toLocaleString('fr')} Fcfa`;
                                }
                            },
                            {
                                "data": "created_at",
                            ...
                            },
                            {
                                ...
                                "render": function(data, type, row, meta, display) {
                                    return `${row.montant_octroye.toLocaleString('fr')} Fcfa`;
                                }
                            },
                            {
                                "data": "commission_averse",
                                "render": function(data, type, row, meta, display) {
                                    return `${row.commission_averse.toLocaleString('fr')} Fcfa`;
                                }commission_averse
                            }
                        ]
                    });
