                        ...
                        <div class="card-spacer mt-n25">
                            ...
                            <div class="row m-0">
                                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                    ...
                                    <a href="#" class="text-danger font-weight-bold font-weight-bolder font-size-h2 mt-2">
                                        ...
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Urgent-mail.svg--><svg
                                            ...
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <path
                                                    ...
                                                    fill="#000000" />        $commissionDuJour = Versement::where('created_at', '>=', $today )->sum('commission_verse');
