                            ...
                            <ul class="navi flex-column navi-hover py-2">
                                ...
                                <li class="navi-item">
                                    <a href="#" class="navi-link">
                                        <span </span>
                                        {{-- <span class="navi-text" name="exportPDF">Export PDF</span> --}}
                        <button type="submit" class="navi-icon"><i class="la la-file-excel-o"></i>class="btn btn-secondary btn-sm" name="exportPDF2">Export PDF 2</button>
                                    </a>
                                </li>
                                <li class="navi-item">
                                    <a href="#" class="navi-link">
                                        <span class="navi-icon"><i class="la la-file-text-o"></i></span>
                                        <span class="navi-text" name="exportPDF2">CSV</span>
                                    </a>
                                </li>
                            </ul>
                            <!--end::Navigation-->
