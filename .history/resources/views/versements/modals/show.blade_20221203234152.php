                            ...
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                ...
                                <div class="d-flex flex-column align-items-md-end px-0">
                                    ...
                                    <span class=" d-flex flex-column align-items-md-end opacity-70">
                                        Etat: <span
                                            class="badge badge-light-{{ $versement->state == 'En cours' ? 'warning' : 'success' }}">{{ $versement->state }}</span>
                                    </span>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <div class="fw-bolder fs-6 text-gray-800">
                                        @if ($versement->status == 'Payé')
                                            <span class="label label-light-succes label-i">{{ $versement->status }}</span>
                                        @elseif($versement->status == 'Paiement partiel')
                                            <span class="label label-light-warning label-i">{{ $versement->status }}</span>
                                        @elseif($versement->status == 'Non payé')
                                            <span class="label label-light-danger label-i">{{ $versement->status }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
