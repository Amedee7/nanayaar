...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/clien/state/report', [App\Http\Controllers\HomeController::class, 'generateReport'])->name('customers.state.report')->middleware('permission:rapport-générer');
