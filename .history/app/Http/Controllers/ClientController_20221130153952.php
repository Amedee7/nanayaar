...
class ClientController extends Controller
{
    ...
    public function clientAcceptes(){
        $clients = Client::with('user')->select("*")
    ...
    public function destroy($id)
    {
        ...
        $client = Client::find($id); 
        //delete the client
        DB::table('clients')->where('id',$id)->delete(); //delete the client_project relations which field client_id is the same that the client i just deleted.
