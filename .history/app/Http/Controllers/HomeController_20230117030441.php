...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $clients =  Client::whereIn('status', ['Attente', 'Attente', 'Rejeté'])->get();
        $clientAccepté = $clients->where('status', '=', 'published');
        $clientAttente = $clients->where('status', '=', 'featured');
        $clientRejeté = $clients->where('status', '=', 'scheduled');
