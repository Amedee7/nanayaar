            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('clients.details', $item->uuid) }}" title="Détails"
                        ...
                        <button onclick="deleteRecordConfirm('{{route('roles.destroy', $item->id)}}')" title="Supprimer"  class="btn btn-outline-danger btn-sm"><span class="flaticon2-trash"></span></button>
