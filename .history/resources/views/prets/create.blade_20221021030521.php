                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <select class="form-control" name="numero_client" id="mySelect2">
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}"
                                                            ...
                                                            <span class="text-danger">No Client:</span>
                                                            {{ $client->numb_cli }}
                                                            {{ '--- Commission: ' . ($client->commission_averse).' FCFA  ' }}
                                                            {{ ' --- sur => ' . $client->montant_demande . ' FCFA' }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="box-body col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" class="form-control"
                                                        value="{{ $client->commission_averse }}" name="date_doctroi">
                                            ...
                                            <div class="box-body col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Date limite de paiement<span
                                                            class="text-danger">*</span></label>
                                                    <input readonly type="text" class="form-control"
                                                        value=" {{ App\Services\DateLimitpaiement::generateLimitdate() }}"
                                                        name="date_remboursement">
                                                    <span class="date_remboursement_err error text-danger"></span>
                                                </div>
                                            </div>

                                            <div class="box-body col-md-6" id="clients-container"></div>
...
@section('js')
    <script>
        ...
        $("#mySelect3").change(function() {
            ...
            var link = "{{ route('clients.load.commissions', ':id') }}";
