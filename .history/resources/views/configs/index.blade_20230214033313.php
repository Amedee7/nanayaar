@extends('layouts.app')
@section('title', 'O2D - Configuration')
@section('content')
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="card card-custom">
                        <div class="card-body pt-15">
                            <div class="text-center mb-3">
                                ...
                                <h4 class="font-weight-bold mt-4">{{ $configs->entreprise_name }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    <form action="{{ route('configs.update', $configs->id) }}" method="post" id="o2d-edit-record-form">
                        @csrf
                        @method('PATCH')
                        <div class="card card-custom">
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="entreprise" type="text" class="form-control" value="{{ $configs->entreprise_name }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="firstname">Numero de téléphone</label>
                                        <input name="telephone" type="text" class="form-control" value="{{ $configs->telephone }}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="email" type="email" class="form-control" value="{{ $configs->email }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="firstname">Adresse</label>
                                        <textarea name="adresse" class="form-control form-control-lg form-control-solid">{{ $configs->adress }}</textarea>
