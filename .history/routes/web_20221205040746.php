...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::patch('/stocks/sortie-stock/{id}/modifier/stock', [App\Http\Controllers\StockController::class, 'modifyOutStockAddStore'])->name('stocks.outer.modify.stock')->middleware('permission:commande-modifier');
