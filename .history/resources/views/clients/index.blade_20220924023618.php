                    ...
                    ajax: {
                        ...
                        data: {
                            ...
                            columnsDef: [
                                ...
                                'Date de naissance', 'Status', 'Montant', 'Actions',
                            ],
                        },
                    },
                    columns: [{
                        ...
                        {
                            data: '                                'RecordID', 'Numero client', 'Nom', 'Prenom', 'Telephone',
'
                        },
                        {
                            data: 'CompanyAgent'
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return '<span class="label label-' + status[data].state +
                                    ' label-dot mr-2"></span>' +
                                    '<span class="font-weight-bold text-' + status[data].state +
