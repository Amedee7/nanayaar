    ...
    <div class="modal-dialog  modal-dialog-centered" style="width: 1000px!important;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Effectuer un premier versement</h5>
            ...
            <div class="modal-body">
                <div class="d-flex align-items-center bg-light-info rounded p-5 mb-5 mb-xl-8">
                    ...
                    N Client:<span class="font-weight-bold text-info py-1"> {{ $client->numb_cli}}</span>
                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="px-9 pt-6 card-rounded h-225px w-100 bg-success">
                            <div class="d-flex text-center flex-column text-white pt-5">
                                <span class="font-weight-bold fs-8 mb-15">Total à remboursé</span>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                <span class="required">Somme à versée</span>
