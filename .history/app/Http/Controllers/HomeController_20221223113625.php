...
class HomeController extends Controller
{
    ...
    {
        $today = Carbon::today();
        $diff = DateLimitpaiement::generateLimitdate()->subDays(2);

        $jour = DateLimitpaiement::generateLimitdate(); // Notre Date par default
        ...
        $clientEnRetard = Versement::where('state', 'Terminé')->whereDate('limit', '>')->count('limit');
