...
class VersementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        activity("Audit")
        ->causedBy(Auth::user())
        ->performedOn($enterStock)
        ->withProperties([
            'Commentaire' => $enterStock->comment,
            'Caisse vide 24'  => $enterStock->empty_bottles_type_24,
            'Caisse vide 12'    => $enterStock->empty_bottles_type_14,
            'ID Fournisseur'  => $enterStock->supplier_id,
            'CRéer par' => $enterStock->created_by,
        ])
        ->log("Entrée de stock de produit");
