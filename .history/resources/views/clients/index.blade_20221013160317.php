                    ...
                    var datatable = $('#kt_datatable').KTDatatable({
                        ...
                        columns: [{
                            ...
                            template: function(row) {
                                ...
                                var index = KTUtil.getRandomInt(1, 2);

                                output += '<div class="font-weight-bolder text-primary mb-0">' + row
                                    .ShipDate + '</div>';
                                output += '<div class="text-muted">' + status[index].title +
                                    '</div>';
