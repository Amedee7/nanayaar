                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="font-weight-bold text-muted  text-uppercase text-right">MONTANT A REMBOUSE</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="font-weight-bolder">
                                            <td><span class="label label-light-success label-inline">{{number_format($versement->reste_apaye,0, '.',' ')}}</td>
                                            <td><span class="label label-light-warning label-inline">{{number_format($versement->somme_verse,0, '.',' ')}}</td>
                                        <td class="text-primary font-size-h3 font-weight-boldest text-right">{{number_format($versement->montant_octroye,0, '.',' ')}}</td>

                                            <td><span class="text-primary font-size-h3 font-weight-boldest text-right"><span class="label label-light-success label-inline">{{number_format($versement->montant_octroye,0, '.',' ')}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
