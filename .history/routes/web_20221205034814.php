...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/stocks/sortie-stock/{id}/modifier/ajouter', [VersementController::class, 'modifyModifierMontant'])->name('versements.modify.ModifierMontant')->middleware('permission:commande-modifier');
