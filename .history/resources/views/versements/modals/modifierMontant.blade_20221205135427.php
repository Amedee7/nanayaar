        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('versements.modify.versement', $id) }}" method="post"
                    ...
                    {{method_field('PATCH')}}
                        <div class="row mb-5">
                            <div class="col-md-3 fv-row fv-plugins-icon-container">
                                ...
                                <input type="number" name="montant_octroye" class="form-control">
                                <span class="montant_octroye_err error text-danger"></span>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button onclick="versementModifierMontant()" id="sender" class="btn btn-primary font-weight-bold">
                        <strong>
                            <b id="text-load" class="visually-hidden">Veuillez patienter... <div class="spinner-border" role="status"></div></b>
                            <b id="text-fix">Ajouter</b>
                        </strong>
                    </button>
                </div>
