                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Nom <span
                                                            class="text-danger">*</span></label>
                                                    <input value="{{$client->name}}" type="text" class="form-control" name="nom"
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Prenom <span
                                                            class="text-danger">*</span></label>
                                                    <input value="{{$client->lastname}}" type="text" class="form-control" name="prenom"
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Date de naissance <span
                                                            class="text-danger">*</span></label>
                                                    <input  value="{{$client->date_naiss}}" type="date" class="form-control" name="date_naissance">
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Montant demander <span
                                                            class="text-danger">*</span></label>
                                                    <input  value="{{$client->montant_demande}}" type="number" class="form-control" name="montant_demande"
                                            ...
                                            <div class="box-body col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Numero CNID <span
                                                            class="text-danger">*</span></label>
                                                    <input value="{{$client->numb_cnib}}" type="text" class="form-control" name="numero_cnib"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select  value="{{$client->user->lastname}}" class="form-control" name="utilisateur">
                                                    @foreach ($users as $item)
                                                    <option {{$item->id==$client->user_id?'selected':''}} value="{{$item->id}}"> {{ $item->firstname }} {{ $item->lastname }}</option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="card card-custom">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input value="{{$client->first_phone}}" type="text" id="o-telephone" class="form-control" name="numero_1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{$client->second_phone}}" type="text" id="o-telephone2" class="form-control" name="numero_2"
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="adresse" class="form-control"> {{$client->second_phone}}</textarea>
