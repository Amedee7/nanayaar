...
class VersementController extends Controller
{
    ...
    public function versementPageStore(Request $request, $id)
    {
     ...
     public function modifyVersementModifierMontant($id){
        $client = Product::join('stocks', 'stocks.product_id', '=', 'client.id')
            ->select(
                'client.id','client.name','client.volume','client.bottles','client.price',
                'stocks.objects'
            )->get();
        return view('outstock.modals.addProduct', ['client'=>$products, 'id'=>$id]);
    }
