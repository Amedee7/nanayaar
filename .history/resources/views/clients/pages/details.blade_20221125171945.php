                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        <div class="card-body pt-4">
                            <div class="d-flex align-items-end mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a class="text-dark font-weight-bolder font-size-h4 mb-0">[{{$client->numb_cli}}] - {{$client->name}}</a>
                            ...
                            <div class="text-center pt-2" style="border: black 1px solid; border-radius: 3px">
                                <div class="my-2">
                                    <a class="text-dark font-weight-bolder text-hover-primary font-size-h5">000</a>
                                </div>
                                <span class="label font-weight-bolder label-inline label-lg label-light-primary mb-2">000</span>
                            </div>
                            ...
                            <div class="mb-7">
                                <div class="d-flex justify-content-between align-items-cente my-1">
                                    ...
                                    <a class="text-muted font-weight-bolder">{{\Carbon\Carbon::parse($client->date_naiss)->format('d/m/Y')}}</a>
                                </div>
                                <div class="separator separator-dashed separator-border-2 mt-3 mb-3"></div>
                                <div class="d-flex justify-content-between align-items-cente my-1">
                                    <span class="text-dark-75 font-weight-bolder mr-2">Numero CNIB:</span>
                                    <a class="text-muted font-weight-bolder">{{$client->numb_cnib}}</a>
                                </div>
                                <div class="separator separator-dashed separator-border-2 mt-3 mb-3"></div>
                                <div class="d-flex justify-content-between align-items-cente my-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a class="label label-inline label-lg label-light-{{$client->status=='Accepté'?'success':'danger'}} font-weight-bold">
                                        {{$client->status}}
                                    </a>
                                </div>
                                <div class="separator separator-dashed separator-border-2 mt-3 mb-3"></div>
                                <div class="d-flex justify-content-between align-items-cente my-1">
                                    ...
                                    <a class="text-muted font-weight-bolder">{{$client->first_phone}}</a>
                                </div>
                                <div class="separator separator-dashed separator-border-2 mt-3 mb-3"></div>
                                ...
                                <div class="d-flex justify-content-between align-items-cente my-1">
                                    ...
                                    <a class="text-muted font-weight-bolder">{{$client->second_phone}}</a>
                                </div>
                                <div class="separator separator-dashed separator-border-2 mt-3 mb-3"></div>
                                <div class="d-flex justify-content-between align-items-center">
