...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $posts =  Versement::whereIn('status', ['published', 'featured', 'scheduled'])->get();
        $versementDuJour = $posts->where('status', '=', 'published');
        $commissionDuJour = $posts->where('status', '=', 'featured');
        $penaliteDuJour = $posts->where('status', '=', 'scheduled');
        // dd($versementDuJour);
