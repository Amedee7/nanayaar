    ...
    <div class="d-flex flex-column-fluid">
        <div class="container col-md-12">
            <div class="card card-custom">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="d-flex align-items-center mb-9 bg-light-success rounded p-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <h2 class="mb-1">Gestion des clients ayant soldés</h2>
                ...
                <table
                    class="table table-clients font-weight-bolder table-bordered table-head-custom table-head-bg table-vertical-center m-5"
                    id="o2d-datatable">
                    <thead>
                        <tr>
                                ...
                                <tr>
                                    <td>
                                        <span class="card-header ribbon ribbon-top ribbon-ver">
                                            <span class="ribbon-target bg-success" style="top: -5px; right: 20px;">OK!
                                            </span>
                                        </span>{{ $key + 1 }}
                                    </td>
                                    <td>
                                        ...
                                        <span style="width: 250px;">
                                            <div class="d-flex align-items-center">
                                                <div class="ml-0">
                                                    ...
                                                    <span class="label fs-7 m-1 label-light-info label-inline">
                                                        {{ $item->status_news_versement }}
                                                    </span>
                                                </div>
                                            </div>
                                        </span>
