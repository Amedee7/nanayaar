...
Route::post("simple-excel/export", "ClientController@export")->name('excel.export');
Route::post('clients/export-clientspdf', [ClientController::class, 'exportClientsPdf'])->middleware('permission:client-modifier')->name('clients.export-clientspdf');
