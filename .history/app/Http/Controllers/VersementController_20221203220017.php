...
class VersementController extends Controller
{
    ...
    public function showVersement($id){
        $ver = DB::table('out_stocks')->where('id', $id)->first();
        if ($ver) {
            $customer = Client::where('id', $ver->customer_id)->first();
            $listProducts = Product_out_stock::where('enter_stock_id', $ver->id)
                ...
                ->get();
            $productsCount = Product_out_stock::where('enter_stock_id', $ver->id)->count();
            $user = User::where('id', $ver->created_by)->first();
            return view('outstock.modals.show', [
                'outStock' => $ver, 'customer' => $customer, 'user' => $user,
