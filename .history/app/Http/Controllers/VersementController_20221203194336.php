...
class VersementController extends Controller
{
    ...
    {
        $versements = Versement::join('versements', 'versements.id', '=', 'versements.client_id')
            ->join('users', 'users.id', '=', 'vermements.created_at')
            ->where('client.deleted_at', null)
            ->select('versements.id', 'products.volume', 'products.bottles', 'users.name as category_name',
