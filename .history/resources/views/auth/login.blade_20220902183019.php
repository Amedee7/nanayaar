...
<head>
    <meta charset="utf-8" />
    <title>KANDA - GESTION SCOLAIRE</title>
    ...
    <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
        <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
            <div class="text-dark order-2 order-md-1">
                ...
                <a href="#" target="_blank" class="text-dark-75 font-weight-bolder text-hover-primary">UNIDEV-SOFT</a>
            </div>
            <div class="nav nav-dark order-1 order-md-2">
                <a href="http://unidevsofts.com" target="_blank" class="nav-link pr-3 pl-0 font-weight-bolder">A propos</a>
            </div>
        </div>
    </div>
</div>
