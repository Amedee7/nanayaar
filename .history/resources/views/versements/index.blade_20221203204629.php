        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
...

                {
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class=" label label-light-success font-weight-bolder fs-6">' + data
...

                {
                    ...
                    name: 'somme_verse',
                    render: function render(data, type, full, meta) {
                        return '<span class=" label label-light-warning font-weight-bolder fs-6">' + data
                            .toLocaleString('fr') + '</span>'
                    }
                },

                {
                    ...
                    name: 'reste_apaye',
                    render: function render(data, type, full, meta) {
                        return '<span class=" label label-light-danger font-weight-bolder fs-6">' + data
                            .toLocaleString('fr') + '</span>'
                    }
                },

                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        status = status + ' ' + '<span class="label fs-7 m-1 ' + label + ' ">' + value +
                            '</span>';
