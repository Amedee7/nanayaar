                                            ...
                                            <div class="card-footer p-6">
                                                ...
                                                <div class="card">
                                                    <div class="card-footer d-flex justify-content-end py-6">
                                                        <a onclick="cancelRecordConfirm('{{route('clients.cancel',$->id)}}')" class="btn btn-danger btn-active-light-danger me-2">Annuler</a>
                                                        <button id="senderX" onclick="outStockClose('{{route('clients.termine',$->id)}}')" class="btn btn-primary">
                                                            <strong>
