                        ...
                        {{ Request::routeIs('versements.finish') ? 'menu-item-open' : '' }} menu-item-submenu"
                            ...
                            <div class="menu-submenu "><i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    @endpermission
                                    @permission('versement-creer')
                                        <li class="menu-item {{ Request::routeIs('versements.hisoriqueclientRembourse') ? ' menu-item-active' : '' }}"
                                            aria-haspopup="true">
                                            <a href="{{ route('versements.hisoriqueclientRembourse') }}" class="menu-link "><i
                                                    class="menu-bullet menu-bullet-dot"><span></span></i><span
