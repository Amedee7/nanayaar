...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // $clientAttente = DB::table('clients')->where('status', 'Attente')->where('deleted_at', null)->count();
        ...
        $clients =  Client::whereIn('status', ['Accepté', 'Attente', 'Rejeté'])->where('deleted_at', null)->count();
        $clientAccepté = $clients->where('status', '=', 'Accepté');
        $clientAttente = $clients->where('status', '=', 'Attente');
        $clientRejeté = $clients->where('status', '=', 'Rejeté');
