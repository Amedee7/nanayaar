...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/users/profile', [UserController::class, 'profile'])->middleware('permission:profile-creer')->name('profile.index');
    Route::get('/user/profile/avatar', [UserController::class, 'avatar'])->middleware('permission:profile-creer')->name('profile.avatar');
    Route::get('/user/profile/pwd', [UserController::class, 'password'])->middleware('permission:profile-creer')->name('profile.password');
    Route::post('/user/profile/pwd/reset', [UserController::class, 'passwordReset'])->middleware('permission:profile-creer')->name('pwd.reset');
