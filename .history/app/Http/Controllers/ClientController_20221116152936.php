...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('clients.index', compact('users', 'clients', 'count'));
    }

    public function moderation_clients()
    {
        $count = Client::where('status','=','Accepter')->count();
        $users = User::all()->pluck('id', 'firstname', 'lastname')->toArray();
        ...
        return view('clients.moderation_clients', compact('users', 'clients', 'count'));
    }
