...
{{-- 
                                            <div class="menu-item px-5">
                                                <a href="{{ route('clients.edit', $client->id) }}"
                                                    class="btn btn-primary btn-sm"> <span
                                                        class="far fa-edit"></span>Supprimer</a>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="">
                                <a href="#">
                                    @if ($client->status == 'Rejeté')
                                        <span
                                            class="btn btn-danger btn-shadow-hover font-weight-bolder w-100 py-3">Rejeté</span>
                                    @elseif($client->status === 'Accepté')
                                        <span
                                            class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">Accepté</span>
                                    @endif
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-header border-0 py-5">
                            ...
                            <div class="card-toolbar">
                                <a onclick="createRecord('{{ route('versements.create') }}')" class="btn btn-success font-weight-bolder font-size-sm"><span
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <div id="kt_table_customers_payment_wrapper"
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-row-dashed gy-5 dataTable no-footer" id="o2d-datatable">
                                                <thead class="border-bottom border-gray-200 fs-7 fw-bolder">
                                                    <tr class="text-start text-muted text-uppercase gs-0">
                                                        <th class="min-w-100px sorting">N VERSEMENT</th>
                                                        <th class="sorting">STATUT</th>
                                                        <th class="sorting"><i class="el el-tag"></i></th>
