                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                <div class=" text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <span class="fs-2x fw-bolder font-size-h2 text-danger" >{{number_format($client->montant_demande,0, '.',' ')}}</span>
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                <div class=" text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <span class="fs-2x fw-bolder font-size-h2 text-warning">{{$client->commission_averse}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex h-70 align-items-center">
                                            <div class="w-100 d-flex flex-column flex-center border-dashed bg-light bg-opacity-75 py-6 px-10">
                                                <div class="text-center">
                                                    ...
                                                    <div class="text-center">
                                                        <span class="fs-2x fw-bolder font-size-h2 text-success">{{number_format($client->commission_averse),0, '.',' '}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
