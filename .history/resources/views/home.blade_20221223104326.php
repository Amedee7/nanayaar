                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="card card-custom bg-white gutter-b" style="height: 130px">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                <!--begin::Stats-->
                                <div class="flex-grow-1 card-spacer-x pt-6">
                                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-sussess">
                                        <span class="svg-icon svg-icon-sussess svg-icon-3x">
                                    ...
                                    <div class="text-inverse-white">
                                        <span
                                            class="text-inverse-white font-weight-bolder font-size-h1 text-sussess">{{ number_format($totalCommissions, 0, '.', ' ') }}</span>
                                        Fcfa
                                    </div>
                                </div>
                                <!--end::Stats-->
