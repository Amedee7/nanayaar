                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true" style="">
                                            <div class="menu-item px-5">
                                                <a onclick="showRecord('{{route('customers.consignation', $vlient->id)}}')" class="menu-link px-5">Consignations</a>
                                            </div>
                                            <div class="menu-item px-5">
                                                <a onclick="requestAccountStatusRefresh('{{route('customers.status', $vlient->id)}}')" title="Changer de statut" class="menu-link px-5">{{$vlient->status=='Actif'?'Désactiver':'Activer'}}</a>
                                            </div>
                                            <div class="menu-item px-5">
