                ...
                <div class="card-body p-0">
                    ...
                    <div class="row justify-content-center py-5 px-5 py-md-10 px-md-0">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <div class="d-flex flex-column align-items-md-end px-0">
                                   Enrollé par l'agent Com : <span class="label label-light-info label-inline">{{$user->firstname}} {{$user->lastname}}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span class=" label label-light-primary label-inline opacity-70 font-weight-bolder" >{{ $client->name }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2"> N CLIENT</span>
                                    <span class=" label label-light-primary label-inline opacity-70 font-weight-bolder" >{{ $client->numb_cli }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">DATE D'OCTROI</span>
                                    <span
                                        class="opacity-70">{{ \Illuminate\Support\Carbon::make($versement->created_at)->format('d/m/Y à H:i:s') }}</span><b>
                                </div>
