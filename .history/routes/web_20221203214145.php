...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/terminer', [Ver::class, 'closeOutStockPage'])->name('stocks.outer.termine')->middleware('permission:commande-modifier');
    Route::patch('/versements/{id}/finish', [Ver::class, 'closeOutStockPageStore'])->name('stocks.outer.finish')->middleware('permission:commande-modifier');
    Route::get('/versements/{id}/show', [Ver::class, 'showOutStock'])->name('stocks.outer.show')->middleware('permission:commande-lire');
    Route::get('/versements/{id}/cancel', [Ver::class, 'outStockCancel'])->name('stocks.outer.cancel')->middleware('permission:commande-modifier');
    Route::get('/versements/{id}/rule', [Ver::class, 'outStockAmountRule'])->name('stocks.outer.rule')->middleware('permission:commande-règlement');
    Route::patch('/versements/{id}/rule/store', [Ver::class, 'outStockAmountRuleStore'])->name('stocks.outer.rule.store')->middleware('permission:commande-règlement');
    Route::delete('/versements/{id}/delete', [Ver::class, 'outStockDelete'])->name('stocks.outer.delete')->middleware('permission:commande-supprimer');
