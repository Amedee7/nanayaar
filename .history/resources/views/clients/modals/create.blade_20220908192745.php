                        ...
                        <div class="col-md-6">
                            <div class="card card-custom" style="border: solid; border-color: black">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="mySelect2">STATUS</label>

                                        <select class="form-control select2" name="status" id="mySelect2">
                                            @foreach ($clients as $client)
                                                <option value="{{ $user->id }}" @if($loop->first) selected @endif>{{$client->status}}</option>
                                            @endforeach
                                        </select>
                                        <span class="role_err error text-danger"></span>
                                    </div>
...
{{-- 
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="user" id="mySelect2">
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}" @if($loop->first) selected @endif>{{$user->firstname}}</option>
                                            @endforeach
                                        </select>
                                        <span class="role_err error text-danger"></span>
                                    </div> --}}
