                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                ...
                                <div class="d-flex flex-column align-items-md-end px-0">
                                    <!--begin::numero-->
                                    <span
                                        class="label label-light-success label-inline">{{ $versement->identifier }}</span>
                                    <!--end::numero-->
                            ...
                            <div class="d-flex justify-content-between pb-10 pb-md-20 flex-column flex-md-row">
                                <div class="d-flex flex-column align-items-md-end px-0">
                                    Enrollé par l'agent Com : <span
                                        class="label label-light-info label-inline">{{ $versement->full_name_user }}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between pt-6">
                                <div class="d-flex flex-column flex-root">
                                    ...
                                    <span
                                        class="opacity-70 font-weight-bolder">{{ $versement->full_name_client }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2"> N CLIENT</span>
                                    <span class="opacity-70 font-weight-bolder">{{ $versement->numero_client }}</span>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">STATUT</span>
                                    <div class="fw-bolder fs-6 text-gray-800">
                                        <span
                                            class="label label-light-success label-inline">{{ $versement->status }}</span>
                                    </div>
                                </div>
                                <div class="d-flex flex-column flex-root">
                                    <span class="font-weight-bolder mb-2">DATE D'OCTROI</span>
                                    <span class="opacity-70">{{ $versement->created_at }}</span><b>
                                </div>
