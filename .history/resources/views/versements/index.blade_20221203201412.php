                        ...
                        <a href="#" class="card card-custom bg-success bg-hover-state-success card-stretch gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <div class="font-weight-bold text-inverse-success font-size-sm">
                                    <div class="symbol symbol-circle me-5">
                                        <div class="symbol-label bg-transparent border border-secondary border-dashed">
                                            <span class=" pulse pulse-white">
                                                <span class="position-relative pulse-ring font-size-h2">100</span>
                                                <span class=""></span>
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <a href="#" class="card card-custom bg-danger bg-hover-state-danger card-stretch gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <div class="font-weight-bold text-inverse-danger font-size-sm">
                                    <div class="symbol symbol-circle me-5">
                                        <div class="symbol-label bg-transparent border border-secondary border-dashed">
                                            <span class="font-weight-bold text-inverse-danger font-size-h2"></span>
                                            <span class="pulse-ring"></span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    <a onclick="createRecord('{{ route('versements.create') }}')"
                        class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder">Effectuer une versement</a>
                </div>
            </div>
        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class="badge badge-light-success fs-8 fw-bolder">' + data +
                            '</span>' +
                            '<span class="text-muted fw-bold text-muted d-block fs-9">Par: ' + full
                            .full_name + '</span>'
                    }
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        output = '<div class="d-flex align-items-center">' +
                            ...
                            '<a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">' + data +
                            '</a>' +
                            '<span class="text-muted fw-bold text-muted d-block fs-7">' +
                            '<div class="min-w-125px pe-2">Tel: ' +
                            '<span class="badge badge-light-primary fs-8 m-1">' + full.first_phone +
                            '</span>' +
                            '</div>' +
                            '</span>' +
                            '</div>' +
                ...
                },
                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        status = status + ' ' + '<span class="badge fs-7 ' + label + ' ">' + value +
                            '</span>' +
                            '<span class="text-muted fw-bold text-muted d-block fs-9">Date: ' + full
                            .created_at + '</span>';
...

                {
                    ...
                    render: function render(data, type, full, meta) {
                        return '<span class=" badge badge-light-success fw-bolder fs-6">' + data
...

                {
                    ...
                    name: 'somme_verse',
                    render: function render(data, type, full, meta) {
                        return '<span class=" badge badge-light-warning fw-bolder fs-6">' + data
                            .toLocaleString('fr') + '</span>'
                    }
                },

                {
                    ...
                    name: 'reste_apaye',
                    render: function render(data, type, full, meta) {
                        return '<span class=" badge badge-light-danger fw-bolder fs-6">' + data
                            .toLocaleString('fr') + '</span>'
                    }
                },

                {
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        status = status + ' ' + '<span class="badge fs-7 m-1 ' + label + ' ">' + value +
                            '</span>';
