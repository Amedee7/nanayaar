...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    Route::get('/versements/{id}/modifier', [VersementController::class, 'modifyVersement'])->middleware('permission:versement-modifier')->name('versements.modify');
     ...
     //View Page
     Route::get('versements/PageReportVersement', [ClientController::class, 'viewReportVersement'])->name('versements.PageReportVersement');
     Route::post('versements/PageReportVersement', [ClientController::class, 'viewReportVersement'])->name('versements.PageReportVersement');
