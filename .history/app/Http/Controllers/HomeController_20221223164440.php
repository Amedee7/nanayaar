...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dueDate = '2022-12-23'; // remplacez cette valeur par la date limite souhaitée
        ...
        $clientEnRetard = Versement::where('limit', '=', DB::raw("DATE_ADD('$dueDate', INTERVAL 16 DAY)"))->count();
        dd($clientEnRetard);
