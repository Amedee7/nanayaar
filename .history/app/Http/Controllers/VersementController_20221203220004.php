...
class VersementController extends Controller
{
    ...
    public function showVersement($id){
         = DB::table('out_stocks')->where('id', $id)->first();
        if () {
            $customer = Client::where('id', ->customer_id)->first();
            $listProducts = Product_out_stock::where('enter_stock_id', ->id)
                ...
                ->get();
            $productsCount = Product_out_stock::where('enter_stock_id', ->id)->count();
            $user = User::where('id', ->created_by)->first();
            return view('outstock.modals.show', [
                'outStock' => , 'customer' => $customer, 'user' => $user,
