...
Route::group(['middleware' => ['auth'], 'prefix' => 'administration'], function () {
    ...
    //PRETS ROUTE
    Route::get('/prets/datatable', [PretController::class, 'datatables'])->middleware('permission:client-lire')->name('prets.datatables');
    Route::get('/prets', [PrettController::class, 'index'])->middleware('permission:client-lire')->name('prets.index');
    Route::get('/prets/create', [PretController::class, 'create'])->middleware('permission:client-creer')->name('prets.create');
    Route::post('/prets/store', [PretController::class, 'store'])->middleware('permission:client-creer')->name('prets.store');
    Route::get('/prets/{id}/view', [PretController::class, 'show'])->middleware('permission:client-lire')->name('prets.show');
    Route::get('/prets/{id}/edit', [PretController::class, 'edit'])->middleware('permission:client-modifier')->name('prets.edit');
    Route::patch('/prets/{id}/update', [PretController::class, 'update'])->middleware('permission:client-modifier')->name('prets.update');
    Route::delete('/prets/{id}/destroy', [PretController::class, 'destroy'])->middleware('permission:client-supprimer')->name('prets.destroy');
});
