...
class ClientController extends Controller
{
    ...
    {
        $outStocksEncours = DB::table('cli')->where('state', 'En cours')->where('cli.deleted_at', null)->count();
        $outStocksTermine = DB::table('cli')->where('state', 'Terminé')->where('cli.deleted_at', null)->count();
        $outStocksAnnule = DB::table('cli')->where('state', 'Annulé')->where('cli.deleted_at', null)->count();
