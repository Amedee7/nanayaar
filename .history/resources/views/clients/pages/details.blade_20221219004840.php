                            ...
                            <div class="">
                                <a href="#">
                                    @if ($client->status == 'Attente')
                                        <span
                                            class="btn btn-primary btn-shadow-hover font-weight-bolder w-100 py-3">En attente</span>
                                    @elseif($client->status === 'Accepté')
                                        <span
                                            class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">Accepté</span>
                                            @else ($client->status === 'Accepté')
                                            <span
                                            class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">Rejeté</span>
                                    @endif
                                </a>
                            </div>
                        </div>
