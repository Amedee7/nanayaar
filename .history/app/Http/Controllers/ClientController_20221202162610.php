...
class ClientController extends Controller
{
    ...
    {
        $outStocksEncours = DB::table('clients')->where('state', 'En cours')->where('clients.deleted_at', null)->count();
        $outStocksTermine = DB::table('clients')->where('state', 'Terminé')->where('clients.deleted_at', null)->count();
        $outStocksAnnule = DB::table('clients')->where('state', 'Annulé')->where('clients.deleted_at', null)->count();
