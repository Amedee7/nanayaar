        ...
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                    ...
                    render: function render(data, type, full, meta) {
                        ...
                        return '<div class="card-header ribbon ribbon-top ribbon-ver">'+'<div class="card-header ribbon ribbon-top ribbon-ver">' +
                            '<div class="ribbon-target bg-danger" style="top: -2px; right: 20px;">OK!' +
                            '<span class="label label-light-success label-inline fs-8 font-weight-bolder">' +
                            data +
                            '</span>' +
                            '<span class="text-muted font-weight-bolder text-muted d-block fs-9">Par: ' +
                            full
                            .full_name + '</span>' + '</div>' + '</div>'
                    }
                },
                {
                    data: 'name',
