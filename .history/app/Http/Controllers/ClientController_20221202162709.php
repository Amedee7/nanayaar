...
class ClientController extends Controller
{
    ...
    {
        $clientEncours = DB::table('clients')->where('sta', 'En cours')->where('clients.deleted_at', null)->count();
        $clientTermine = DB::table('clients')->where('sta', 'Terminé')->where('clients.deleted_at', null)->count();
        $clientAnnule = DB::table('clients')->where('sta', 'Annulé')->where('clients.deleted_at', null)->count();
