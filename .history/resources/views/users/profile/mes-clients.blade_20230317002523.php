                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                                    ...
                                    <thead>
                                        <tr class="fw-bolder text-muted">
                                            ...
                                            <th class="min-w-140px">AGENT COMM</th>
    ...
    <script>
        $('#o2d-datatable').DataTable({
            ...
            columns: [{
                    ...
                    {
                        data: 'use.clientr.firstname',
                        name: 'user.client.firstname',
                        render: function render(data, type, full, meta) {
                            return '<span style="width: 250px;">' +
                                '<div class="ml-4">' +
                                '<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + full.user.client
                                .firstname + '</div>' +
                                '<a class="text-muted font-weight-bold text-hover-primary">' + full.user.client
                                .lastname + '</a>' +
                                '</div>' +
                                '</div>' +
                                '</span>';
