                        ...
                        <div class="row g-5 mb-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="fw-bolder fs-6 text-gray-800">
                                    ...
                                    <span class="label label-light-success label">{{$versement->status}}</span>
                                    @elseif($versement->status=="Paiement partiel")
                                    <span class="label label-light-warning">{{$versement->status}}</span>
                                    @elseif($versement->status=="Non payé")
                                    <span class="label label-light-danger">{{$versement->status}}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="mw-300px">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-success">{{number_format($versement->montant_octroye,0, '.',' ')}}</span></div>
                                    </div>
                                    <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="text-end fw-bolder fs-6 text-gray-800"><span class="badge badge-light-danger">{{number_format($versement->reste_apaye,0, '.',' ')}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
